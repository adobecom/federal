...
if __name__ == "__main__":
  if os.environ['PR_STATE'] == 'open':
    ...
    data = {
      ...
      "coordinator": "asdeshmu@adobe.com",
      ...
      "testResults": "Changes are tested and validated successfully in staging environment. Please see the link of the PR in the description for the test results."
    }
