var ke=async e=>{let{placeholders:n}=e,{locale:a}=E(),t=`${Q()}${a.prefix}/federal/globalnav/placeholders.json`,[i,o]=await Promise.all([n,un(t)]);return new Map([...o,...i])},un=async e=>{try{let n=await fetch(e);if(!n.ok)throw new g(`Federal placeholders not found at ${e}`);let a=mn(await n.json());if(a instanceof g)throw a;return new Map(a.data.map(({key:r,value:t})=>[r,t]))}catch(n){if(n instanceof g)console.error(n.message);else{let a=new g(n.message);console.error(a.message)}return T(`Failed to fetch placeholders from ${e}`),new Map([])}},mn=e=>{try{let{data:n}=e;if(!n.every(({key:r,value:t})=>typeof r=="string"&&typeof t=="string"))throw new Error("data is not valid");return e}catch(n){return new g(n.message)}};function Le(e,n){let a=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return a.test(e)?e.replace(a,(t,i,o)=>{let s=i??o??"";return n.get(s)??s}):e}var[Ce,q]=(()=>{let e;return[n=>{e||(e=n)},()=>{if(!e)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return e}]})();var C=window.matchMedia("(min-width: 1024px)"),U={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},vn=["/tools/ost?","/miniplans"],Ee=e=>vn.some(n=>e.includes(n));var Te=e=>{let n=[],a=e.nextElementSibling??null;for(;a!==null;)n.push(a),a=a.nextElementSibling??null;return n},W=e=>({eval:e,or:n=>W(a=>{try{return e(a)}catch{return n(a)}})}),z=(e,n)=>e.reduce(([a,r],t)=>{try{let[i,o]=n(t);return[[...a,i],[...r,...o]]}catch(i){return i instanceof c?[a,[i,...r]]:[a,r]}},[[],[]]),[Se,hn]=(()=>{let e,n=!1;return[a=>{n||(e=a,n=!0)},()=>{if(!e)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return e}]})(),[Me,_e]=(()=>{let e=n=>n;return[n=>{e=n},()=>e]})(),M=e=>{try{return _e()(e)}catch{return e}},B=async e=>{try{if(e===null)return new c("URL is null");let n=`${e.origin}${e.pathname.replace(/(\.html$|$)/,".plain.html")}${e.hash}`,a=_e()(n),r=_(a),t=await fetch(r);if(!t.ok)return T(`Request for ${r} failed`),new c(`Request for ${r} failed`);let i=await t.text(),o=await q(),s=Le(i,o),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:d,commands:u}=hn();d(u,l)}catch(d){T(`Personalization not applied: ${d?.message}`)}return l}catch(n){return new c(n?.message)}},N,Q=()=>{if(N)return N;let e=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(N)return N;let n=window.location.origin;N=e.some(t=>{let i=n.replace(".stage","");return t.startsWith("https://")?i===t:i.endsWith(t)})?n:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(n.includes("localhost")||n.includes(`.${r}.`))&&(N=`https://main--federal--adobecom.aem.${n.endsWith(".live")?"live":"page"}`),N},_=(e="")=>{if(e.includes("stage.adobe.com"))return e.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(e.includes("c2-poc-feds-gnav--milo--adobecom"))return e.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(e.includes("localhost:3000"))return e.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof e!="string"||!e.includes("/federal/"))return e;if(e.startsWith("/"))return`${Q()}${e}`;try{let{pathname:n,search:a,hash:r}=new URL(e);return`${Q()}${n}${a}${r}`}catch(n){let a=n instanceof Error?n.message:String(n);console.warn(`getFederatedUrl errored parsing the URL: ${e}: ${a}`)}return e},Ae=(e,n)=>{let a=(r,t)=>{let i=`${r}[${t}^="./media_"]`;n.querySelectorAll(i).forEach(s=>{let l=s.getAttribute(t);if(!(l===null||l===""))try{let d=_(new URL(l,new URL(e,window.location.href)).href);s.setAttribute(t,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${r}`,d)}})};a("img","src"),a("source","srcset")},Pe=async e=>{let n=async(a,r)=>{if(a instanceof c)return a;try{let i=[...a.querySelectorAll('a[href*="#_inline"]')].map(async o=>{try{if(r.has(o.href))return;let s=_(o.href),l=new URL(s),d=await B(l);if(r.add(o.href),d instanceof c)throw d;await n(d,r),o.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),a}catch(t){return new c(JSON.stringify(t))}};return n(e,new Set)},ze=(e,n)=>e.map((a,r)=>`<li>${n(a,r)}</li>`).join(""),S=e=>{let n=e.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return n===""?"id":/^\p{N}/u.test(n)?`id-${n}`:n},L=(e,n)=>{let a=e!==null&&e!==""?` daa-lh="${e}"`:"",r=n!==null&&n!==""?` daa-ll="${n}"`:"";return`${a}${r}`},Z=(e,n)=>{if(!e&&!n)return"";let a=[];return n!=null&&n!==""?a.push(`aria-label="${n}"`):e?.["aria-label"]&&a.push(`aria-label="${e["aria-label"]}"`),e&&Object.entries(e).forEach(([r,t])=>{r!=="aria-label"&&t&&a.push(`${r}="${t}"`)}),a.length>0?` ${a.join(" ")}`:""};function bn(e,{id:n,as:a,callback:r,crossorigin:t,rel:i,fetchpriority:o}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${e}"]`);if(s)return r?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",i),n!==void 0&&l.setAttribute("id",n),a!==void 0&&l.setAttribute("as",a),t!==void 0&&l.setAttribute("crossorigin",t),o!==void 0&&l.setAttribute("fetchpriority",o),l.setAttribute("href",e),r&&(l.onload=d=>r(d.type),l.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(l),l}function yn(e,n){return bn(e,{rel:"stylesheet",callback:n})}function de(e,n=!1){n&&yn(e)}var pe=(e,n,{mode:a,id:r}={})=>new Promise((t,i)=>{let o=document.querySelector(`head > script[src="${e}"]`);if(!o){let{head:d}=document;o=document.createElement("script"),o.setAttribute("src",e),r!=null&&o.setAttribute("id",r),n!=null&&o.setAttribute("type",n),a&&["async","defer"].includes(a)&&o.setAttribute(a,""),d.append(o)}let s=o.dataset.loaded;if(s!=null){t(o);return}let l=d=>{o.removeEventListener("load",l),o.removeEventListener("error",l),d.type==="error"?i(new Error(`error loading script: ${o.src}`)):d.type==="load"&&(o.dataset.loaded="true",t(o))};o.addEventListener("load",l),o.addEventListener("error",l)});function G(e,n=document){let a=e&&e.includes(":")?"property":"name";return n.head.querySelector(`meta[${a}="${e}"]`)?.content??null}var xn=e=>{let n=e,a=i=>i==null||typeof i!="object";if(a(n)||a(n.locale)||typeof n.locale.prefix!="string"||a(n.env)||typeof n.env.name!="string")return!1;if(n.unav!==void 0){if(typeof n.unav!="object"||n.unav===null)return!1;let i=n.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let o=i.profile;if(o.signInCtaStyle!==void 0&&o.signInCtaStyle!=="primary"&&o.signInCtaStyle!=="secondary"||o.messageEventListener!==void 0&&typeof o.messageEventListener!="function")return!1}}return!(n.jarvis!==void 0&&(typeof n.jarvis!="object"||n.jarvis===null||typeof n.jarvis.id!="string"))},[ce,E]=(()=>{let e,n=!1;return[a=>{if(!n){if(!xn(a))throw new Error("MiloConfig validation failed: Invalid structure");e=a,n=!0}},()=>{if(!e)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return e}]})(),wn={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},Ie={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function kn(e){let n=wn[e];return!n&&Ie[e]&&(n=e),!n&&e.includes("-")&&([n]=e.split("-")),n||"US"}var le="langstore/";function $e(e){let a=(e?.prefix||"US_en").replace("/","")??"",[r="US",t="en"]=(Ie[a]??a).split("_",2);if(a.startsWith(le)||window.location.pathname.startsWith(`/${le}`)){let i=a.replace(le,"").toLowerCase();r=kn(i),t=i}return r=r.toUpperCase(),t=t.toLowerCase(),{language:t,country:r,locale:`${t}_${r}`}}var K=e=>{let n=e.querySelector("#feds-menu-wrapper");n?.classList.remove("feds-menu-active"),n?.hidePopover?.(),e.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function Re(){let e=G("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(e!==void 0&&e!==""&&e!=="gnav")return e;let n=window.adobeid?.client_id;return typeof n=="string"&&n!==""?n:""}var He=e=>{let n=()=>{let i=document.querySelector(".adbMsgClientWrapper");return i?(i.getAttribute("popover")!=="manual"&&(i.setAttribute("popover","manual"),i.style.padding="0"),i?.hidePopover(),i?.showPopover(),!0):!1},a=i=>{!i.target.closest('[href*="#open-jarvis-chat"]')&&i.newState!=="open"||n()},r=e.querySelectorAll("[popover]");document.addEventListener("click",a),r.forEach(i=>i.addEventListener("toggle",a));let t=setInterval(()=>{n()&&clearInterval(t)},150)};var ee={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},A=e=>{if(e===null)throw new c(ee.elementNull);if(e.tagName!=="A")throw new c(ee.notAnchor);let[n,a]=e?.textContent?.split("|").map(i=>i.trim())??["",""];if(n==="")throw new c(ee.textContentNotFound);let r=e?.getAttribute("href")??"";if(r==="")throw new c(ee.hrefNotFound);let t=e.getAttribute("daa-ll");return[{type:"Link",text:n,href:r,daaLl:t,ariaLabel:a},[]]};var ge=e=>{if(!e)throw new c(I.elementNull);if(!e.classList.contains("product-card"))throw new c(I.notAProductCard);return W(Cn).or(Ln).or(En).eval(e)},I={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},Ln=e=>{let n=new Set;if(!e)throw new c(I.elementNull);let a=e.querySelector("p a")??e.querySelector("div ~ div > a");if(!a)throw new c(I.noTitleAnchor);let r=a.textContent??"";r===""&&n.add(new g(I.noTitle));let t=a.getAttribute("href")??"";t===""&&n.add(new g(I.noHref));let i=a.getAttribute("daa-ll"),o=a.getAttribute("daa-lh"),s=a?.closest("p")?.nextElementSibling;s||n.add(new g(I.noSubtitleP));let l=s?.textContent??"";l===""&&n.add(new g(I.noSubtitle));let d=e.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],u=Array.from(d).map(h=>{let p=h.querySelector("strong")!==null;return{text:h?.textContent?.trim()??"",isFilled:p}}),[y,w=null]=(e.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(h=>h.trim());return[{type:"ProductCardLink",iconHref:y,iconAlt:w,title:r,href:t,subtitle:l,badges:u,daaLl:i,daaLh:o},[...n]]},Cn=e=>{if(!e)throw new c(I.elementNull);let n=[...e.classList];if(!n.includes("header"))throw new c(I.notAHeader);let a=e.querySelector("a")?.textContent??"",r=e.querySelector("a")?.getAttribute("daa-ll")??null,t=e.querySelector("a")?.getAttribute("daa-lh")??null;if(a==="")throw new c(I.noTitle);return[{type:"ProductCardHeader",title:a,classes:n,daaLl:r,daaLh:t},[]]},En=e=>{if(!e)throw new c(I.elementNull);if(!e.classList.contains("blue"))throw new Error("Not a Blue Product Card");let n=e.querySelector("a"),[a,r]=A(n),t=n?.getAttribute("daa-ll")??null,i=n?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:a,daaLl:t,daaLh:i},r]};var fe=e=>{switch(e.type){case"ProductCardHeader":return Tn(e);case"ProductCardLink":return Sn(e);case"ProductCardBlue":return Mn(e);default:return console.error(e),""}},Tn=({title:e,classes:n,daaLl:a,daaLh:r})=>{let t=n.slice(1).map(o=>`feds-product-card--${o}`).join(" "),i=L(r,a??e);return`
  ...
  `},Sn=({iconHref:e,iconAlt:n,title:a,href:r,subtitle:t,badges:i=[],daaLl:o,daaLh:s})=>{let l=e!==null,d=L(s,o??a),u=l?`
    ...
    <a class="feds-product-card" href="${M(r)}"${d}>
  ...
  `},Mn=({link:e,daaLl:n,daaLh:a})=>{let r=L(a,n??e.text);return`
  <a href="${M(e.href)}" class="feds-product-card feds-product-card--blue"${r}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${e.text}</div>
      </div>
  </a>
`};var O={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},ue=e=>{let n=new Set;if(e===null)throw new c(O.elementNull);let a=!!e.classList.contains("dark-bg"),[r,t]=e.querySelectorAll(":scope > div");if(r===void 0)throw new c(O.noLinkSection);let i=r.querySelector("a");if(i===null)throw new c(O.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";t===void 0&&n.add(new g(O.noImageSection));let[l,d]=t?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&n.add(new g(O.missingImageSections));let u=l?.querySelectorAll('a[href$=".svg"]'),y=d?.querySelectorAll('a[href$=".svg"]'),w=u?.[0]?.getAttribute("href")??"",h=u?.[0]?.textContent?.split("|")[1]?.trim()??"",p=u?.[1]?.getAttribute("href")??"",v=u?.[1]?.textContent?.split("|")[1]?.trim()??"",m=y?.[0]?.getAttribute("href")??"",f=y?.[0]?.textContent?.split("|")[1]?.trim()??"",b=y?.[1]?.getAttribute("href")??"",x=y?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!w||!m||!p||!b)&&n.add(new g(O.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:a,imageData:{type:"svg",lightThemeImageSrc:m,lightThemeImageAlt:f,darkThemeImageSrc:b,darkThemeImageAlt:x,mobileLightThemeImageSrc:w,mobileLightThemeImageAlt:h,mobileDarkThemeImageSrc:p,mobileDarkThemeImageAlt:v}}},[...n]]};var _n=`
<?xml
...
`.trim(),Pn=e=>{let{href:n,label:a,isDarkBg:r,imageData:t}=e,i=t.lightThemeImageSrc?.trim()||t.darkThemeImageSrc?.trim()||"",o=t.darkThemeImageSrc?.trim()||t.lightThemeImageSrc?.trim()||"",s=t.mobileLightThemeImageSrc?.trim()||t.mobileDarkThemeImageSrc?.trim()||"",l=t.mobileDarkThemeImageSrc?.trim()||t.mobileLightThemeImageSrc?.trim()||"",d=t.lightThemeImageAlt||t.darkThemeImageAlt||"",u=t.darkThemeImageAlt||t.lightThemeImageAlt||"",y=t.mobileLightThemeImageAlt||t.mobileDarkThemeImageAlt||"",w=t.mobileDarkThemeImageAlt||t.mobileLightThemeImageAlt||"",h=!!i,p=!!o,v=!!s,m=!!l,f=h?`<img src="${_(i)}" alt="${d}" />`:"",b=p?`<img src="${_(o)}" alt="${u}" />`:"",x=v?`<img src="${_(s)}" alt="${y}" />`:"",k=m?`<img src="${_(l)}" alt="${w}" />`:"";return`<div class="feds-brand-container${r?" feds-dark-bg":""}">
  ...
  </div>`.trim()},me=e=>{let{data:n}=e;return Pn(n)};var ve=["appswitcher","help"],ne={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[V,De]=(()=>{let e,n,a,r=new Promise(t=>{n=t,a=setTimeout(()=>{e={},t(e)},5e3)});return[t=>{t&&!e&&(e=t,clearTimeout(a),n?.(e))},()=>r]})();function ae(e,n=!1){let s=(/uc_carts=/.test(document.cookie)?e:e?.filter(d=>d!=="cart"))??[],l=s.length??3;if(n){let d=s.filter(y=>ve.includes(y)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var re=e=>{if(!e.prefix||e.prefix==="/")return"en_US";let n=e.prefix.replace("/","");if(n.includes("_")){let[r,t]=n.split("_").reverse();return`${r.toLowerCase()}_${t.toUpperCase()}`}if(n==="uk")return"en_GB";let a=Object.keys(ne).find(r=>ne[r].includes(n));return a?`${a.toLowerCase()}_${n.toUpperCase()}`:`${n.toLowerCase()}_${n.toUpperCase()}`},zn={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},te=()=>{let e=navigator.userAgent;for(let[n,a]of Object.entries(zn))if(e.includes(n))return a;return"linux"},oe=async()=>{let e=window;return e.alloy?await e.alloy("getIdentity").then(n=>n?.identity?.ECID).catch(()=>{}):void 0};var Ue=()=>{try{return E().signInContext||{}}catch{return{}}},In=()=>{let e=E();return G("signin-cta-style")==="primary"||e?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},$n=()=>{let n=E()?.unav?.profile?.messageEventListener;return n||(a=>{let{name:r,payload:t,executeDefaultAction:i}=a.detail;if(!(!r||r!=="System"||!t||typeof i!="function"))switch(t.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{V(o)}).catch(()=>{V({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function Rn(){let{unav:e}=E();return e?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var Y=()=>{let e=E();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:e?.unav?.profile?.complexConfig||null,...e?.unav?.profile?.config},messageEventListener:$n()},signInCtaStyle:In(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Ue())},onSignUp:()=>{window.adobeIMS?.signIn(Ue())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:e?.unav?.uncAppId||"adobecom",...e?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:Rn()}},jarvis:{name:"jarvis",attributes:{appid:e?.jarvis?.id,callbacks:e?.jarvis?.callbacks}},cart:{name:"cart"}}};var Ne=(e,n)=>{e[0]&&"attributes"in e[0]&&e[0].attributes&&typeof e[0].attributes=="object"&&"isSignUpRequired"in e[0].attributes&&(e[0].attributes.isSignUpRequired=n)},ie=async(e,n)=>{try{let a=e.querySelector(".feds-utilities");if(!(a instanceof HTMLElement))return new g('missing ".feds-utilities" container');let r=new Set,t=document.head.querySelector('meta[name="universal-nav"]'),i=t instanceof HTMLMetaElement?t.content??"":"";t instanceof HTMLMetaElement||r.add(new g('metadata "universal-nav" is missing'));let o=i.trim();t instanceof HTMLMetaElement&&o.length===0&&r.add(new g('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(f=>f.trim()).filter(f=>Object.keys(Y()).includes(f)||f==="signup");if(s){let f=ae(l,s);a.style.setProperty("min-width",f)}let d;try{d=E()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let u=re(d.locale),y=d.env.name==="prod"?"prod":"stage",w=await oe(),h=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(h??"")||(h="1.5"),await Promise.all([pe(`https://${y}.adobeccstatic.com/unav/${h}/UniversalNav.js`),de(`https://${y}.adobeccstatic.com/unav/${h}/UniversalNav.css`,!0)]);let p=()=>{let f=Y(),b=[f.profile];return Ne(b,!1),l?.forEach(x=>{if(x==="profile")return;if(x==="signup"){Ne(b,!0);return}let k=f[x];k&&b.push(k)}),b},v=()=>({target:a,env:y,locale:u,countryCode:$e(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:te(),os_version:navigator.platform},event:{visitor_guid:w}},children:p(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!C.matches});await window?.UniversalNav?.(v()),s||a?.style.removeProperty("min-width");let m=f=>{window?.UniversalNav?.reload(v())};return C.addEventListener("change",()=>{m()}),{reloadUnav:m,errors:r}}catch(a){let r=a instanceof Error?a.message:"failed to load universal nav";return new g(r)}};function j(e,n){return[...e.querySelectorAll(n)]}function J(e,n,a){j(e,n).forEach(r=>a?r.removeAttribute("tabindex"):r.setAttribute("tabindex","-1"))}var se={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},je=new Set(["ArrowLeft","ArrowRight"]),Hn=new Set(["ArrowUp","ArrowDown"]),Dn='.tabs [role="tab"][aria-selected="true"]';function he(e,n,a){return(e+n+a)%a}function Un(e,n,a,r){let t=se[a];if(je.has(a)){let h=n+t;return h>=0&&h<e.length?h:null}let i=getComputedStyle(r).gridTemplateColumns.split(" ").length,o=[...r.children],s=h=>{let p=e[h].parentElement;return p?o.indexOf(p):-1},l=s(n)%i,d=Math.floor(s(n)/i)+(a==="ArrowDown"?1:-1),u=Math.floor((o.length-1)/i);if(d<0||d>u)return null;let y=null,w=1/0;for(let h=0;h<e.length;h++){let p=Math.abs(s(h)%i-l);Math.floor(s(h)/i)===d&&p<w&&(w=p,y=h)}return y}function be(e){J(e,'.tab-content [role="tabpanel"] a',!1);let n=[];j(e,".feds-popup[popover]").forEach(p=>{let v=()=>{p.matches(":popover-open")||J(p,'[role="tabpanel"] a',!1)};p.addEventListener("toggle",v),n.push(()=>p.removeEventListener("toggle",v));let m=!1,f=x=>{x.key==="Tab"&&!x.shiftKey&&(m=!0)};p.addEventListener("keydown",f),n.push(()=>p.removeEventListener("keydown",f));let b=x=>{if(m&&!p.contains(x.relatedTarget)){if(p.hidePopover?.(),!C.matches){let k=p.closest(".feds-gnav-items");k?.classList.remove("subscreen-opening"),k?.classList.add("subscreen-closing")}m=!1}};p.addEventListener("focusout",b),n.push(()=>p.removeEventListener("focusout",b))});let a=(p,v)=>{p.focus(),v.preventDefault()},r=()=>e.querySelector(".feds-popup:popover-open"),t=p=>p.querySelector(Dn),i=p=>p.querySelector('[role="tabpanel"]:not([hidden])');function o(p){let v=r(),m=e.querySelector("#feds-menu-wrapper");if(!m)return!1;let f=m.querySelector(".feds-gnav-items"),b=v?v.querySelector(".feds-popup-back-button"):null,x=f?.classList.contains("subscreen-opening")===!0;if(v!==null&&x&&b!==null)return b.click(),p.preventDefault(),!0;let k=v??(m?.matches(":popover-open")?m:null);if(!k)return!1;k.hidePopover?.();let P=v?`[popovertarget="${k.id}"]`:".feds-nav-toggle";return e.querySelector(P)?.focus(),p.preventDefault(),!0}function s(p,v,m){if(!je.has(v))return!1;let f=j(e,".feds-gnav-items > li > .feds-link"),b=f.indexOf(p);return b<0?!1:(a(f[he(b,se[v],f.length)],m),!0)}function l(p,v,m,f){let b=j(v,'.tabs :is([role="tab"], .product-links a)'),x=b[0]?.offsetLeft??0,k=b.indexOf(p);if(k<0)return!1;let P=C.matches?{ArrowLeft:0,ArrowRight:0,ArrowUp:-1,ArrowDown:1}:{ArrowLeft:-1,ArrowRight:1,ArrowUp:0,ArrowDown:0};if(P[m]){let R=b[he(k,P[m],b.length)];return R.matches('[role="tab"]')&&(R.click(),C.matches||requestAnimationFrame(()=>{let X=R.closest(".tabs");X&&(X.scrollLeft=R.offsetLeft-x)})),a(R,f),!0}if(m in P)return f.preventDefault(),!0;if(m==="Tab"&&!f.shiftKey&&p.matches('[aria-selected="true"]')){let R=i(v);if(!R)return!1;J(R,"a",!0);let X=R.querySelector("a");return X&&a(X,f),!0}return!1}function d(p,v,m,f){let b=i(v);if(!b)return!1;let x=j(b,"a"),k=x.indexOf(p);if(k<0)return!1;if(se[m]){let P=Un(x,k,m,b);return P!==null?(a(x[P],f),!0):m==="ArrowUp"?(J(b,"a",!1),a(t(v)??x[0],f),!0):!1}if(m==="Tab"&&!f.shiftKey){if(k+1<x.length)a(x[k+1],f);else return!1;return!0}if(m==="Tab"&&f.shiftKey){if(k>0)a(x[k-1],f);else{J(b,"a",!1);let P=t(v)??j(v,'.tabs :is([role="tab"], .product-links a)')[0];P&&a(P,f)}return!0}return!1}function u(p,v,m,f){if(!Hn.has(m))return!1;let b=j(v,".feds-gnav-cards a"),x=b.indexOf(p);return x<0?!1:(a(b[he(x,se[m],b.length)],f),!0)}function y(p){let v=document.activeElement??p.target;if(p.key==="Escape"){o(p);return}let m=r();m&&(m.matches(":has(.product-list)")&&(l(v,m,p.key,p)||d(v,m,p.key,p))||m.matches(":has(.feds-gnav-cards)")&&u(v,m,p.key,p))||s(v,p.key,p)}let w=e.querySelector(".trap-focus-gnav"),h=p=>{e.querySelector(".feds-menu-active")&&(p.preventDefault(),e.querySelector(".feds-nav-toggle")?.focus())};return w?.addEventListener("focus",h),n.push(()=>w?.removeEventListener("focus",h)),e.addEventListener("keydown",y),n.push(()=>e.removeEventListener("keydown",y)),()=>n.forEach(p=>p())}var Nn="feds-milo",T=(e,n="default",a="e")=>{let{locale:r}=E(),t=G("gnav-source")??`${r.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${e} | gnav-source: ${t} | href: ${window.location.href}`,{clientId:Nn,sampleRate:1,tags:n,errorType:a})};var c=class e extends Error{constructor(n){super(n),Object.setPrototypeOf(this,e.prototype)}},g=class e extends Error{constructor(n,a="Minor"){super(n),Object.setPrototypeOf(this,e.prototype),a==="Critical"&&T(n)}};var qe=e=>n=>{if(n===null)throw new Error("");let a=n.querySelector(jn(e));if(!a)throw new Error("");let r=a.textContent??"",[t="",i=""]=r.split("|").map(y=>y.trim());if(t==="")throw new Error("");let o=a.getAttribute("href")??"";if(o==="")throw new Error("");let s=a.getAttribute("daa-ll"),l=a.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,u=[];return[{type:e.type,text:t,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:t},u]},ye=qe({type:"PrimaryCTA"}),H=qe({type:"SecondaryCTA"}),Be=e=>W(ye).or(H).eval(e),jn=({type:e})=>{switch(e){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var xe=({text:e,href:n,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${M(n)}"
...
`,Ge=e=>e.type==="PrimaryCTA"?xe(e):D(e);var F=({text:e,href:n,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${M(n)}"${Z(t,r)}${L(null,a??e)}>${e}${i}</a>`;var Oe=e=>{let[n,a]=qn(e);return[{type:"LinksCard",card:n},a]},qn=e=>{let n=e.querySelector("h2, h3, h4")||null;if(!n)throw new c("Expected links card title");let a=e.querySelector("em > a"),r=[...e.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=z(r,A),[o,s]=(()=>{try{return H(e)}catch{return[null,[]]}})();return o&&(o.daaLl=`${n.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:n.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Fe=(e,n="",a=new Map)=>{let r=[...e.querySelectorAll("li > div")],t=[...e.querySelectorAll("li > a")],[i,o]=z(r,Bn),[s,l]=z(t,A);return[{type:"ProductList",megaMenuTitle:n,categories:i,links:s,placeholders:a},[...o,...l]]},Bn=e=>{let n=e.firstElementChild;if(n?.nodeName!=="H2")throw new c("Expected H2");let a=n.textContent??"",r=n.textContent??"",t=Te(n),[i,o]=z(t,ge);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Xe=e=>{let[n,a]=Gn(e);return[{type:"FeaturedCard",card:n},a]},Gn=e=>{let n=e.querySelector("h5")||null;if(!n)throw new g("Eye brow element not found");let a=e.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=A(t),[s,l]=H(e);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:n.textContent??""},[...l,...o]]};var $={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},We=e=>{let[n,a]=e.querySelectorAll(":scope > div"),r=new Set;if(n===void 0)throw new c($.MissingBackgroundImageSection);let t=n.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g($.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g($.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g($.MissingBackgroundImageSrc)),a===void 0)throw new c($.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g($.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g($.MissingIconSrc)),d===""&&r.add(new g($.MissingIconAlt));let u=a.querySelector('p > a:not([href$=".svg"])')??null,y=u?.textContent?.trim()??"",w=u?.getAttribute("href")??"",h=w?Ee(w):!1;u===null&&r.add(new g($.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c($.MissingTitleElement);let v=p?.textContent??"";v===""&&r.add(new g($.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g($.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return H(e)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${v} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:v,cta:f,priceText:y,priceHref:w,isPriceMerchLink:h}},[...r]]};var Ke=e=>{let n=new Set;if(e===null)throw new c(Ze.elementNull);let a=e.querySelector("h2")?.textContent??"";a===""&&n.add(new g(Ze.noTitle));let r=(async()=>{try{let t=e.querySelector("a"),i=new URL(t?.href??""),o=await B(i);if(o instanceof c)throw new Error(o.message);let s=await Pe(o);if(s instanceof c)throw new Error(s.message);if(Ae(i.href,s),e.classList.contains("product-list")){let l=await q();return Fe(s,a,l)}return On(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...n]]},Ze={elementNull:"Element is null",noTitle:"Large Menu has no Title"},On=(e,n)=>{let a=[...e.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=z(a,i=>Fn(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:n,sections:r},t]},Fn=e=>{let n=[...e.querySelectorAll(".featured-card, .links-card, .promo-card")];if(n.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=z(n,t=>Xn(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Xn=e=>{if(e.classList.contains("featured-card"))return Xe(e);if(e.classList.contains("links-card"))return Oe(e);if(e.classList.contains("promo-card"))return We(e);throw new c("Unsupported gnav cards section")};var Ve=({card:e},n)=>Wn(e,n),Wn=({title:e,subtitle:n,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${S(a)}`;return`
  <article class="featured-card" ${L(a,"")}>
    <div>
...
`.trim();var Je=({card:e})=>Kn(e),Kn=({bgImageAlt:e,bgImageSrc:n,iconAlt:a,iconSrc:r,title:t,cta:i,priceText:o,priceHref:s,isPriceMerchLink:l})=>`
    ...
    <div class="promo-card__content">
      ...
      <div class="promo-card__text-content">
        ...
        ${i===null?"":`<div class="promo-card__cta">
                 ${D({...i,ariaAttrs:{"aria-describedby":`title-${S(t)}${l?` price-${S(t)}`:""}`}})}
               </div>`}
      </div>
    </div>
  </article>
...
`;var en=({categories:e,links:n,placeholders:a})=>{let r=`
    <ul class="tabs" role="tablist">
      ${e.map(Yn).join("")}
      ${n.length?`<li class="product-links"><a class="feds-link" href="${M(n[n.length-1].href)}"${L(null,n[n.length-1].daaLl??n[n.length-1].text)}>${n[n.length-1].text}${U.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
    <ul class="tab-content">
      ${e.map(({links:i},o)=>{let s=a.get("product-list-includes")??"includes",l=a.get("product-list-product")??"product",d=a.get("product-list-products")??"products",u=i.length===1?l:d;return`
      <li>
        <span id="product-hint-${o}" class="product-hint">${s} ${i.length} ${u}</span>
        <ul
          id="${o}"
          role="tabpanel"
          ${o===0?"":"hidden"}
        >
          ${i.map(y=>`<li>${fe(y)}</li>`).join("")}
        </ul>
      </li>
      `.trim()}).join("")}
    </ul>
...
`,an=(e,n)=>{let{megaMenuTitle:a}=e,r=`
  ...
  `,t=e.type==="ProductList"&&e.links.length>0?e.links[e.links.length-1]:null,i=`
    <div class="feds-popup-header">
      ...
      ${t?`<div class="product-links"><a class="feds-link" href="${M(t.href)}"${L(null,t.daaLl??t.text)}>${t.text}${U.chevronRight}</a></div>`:""}
    </div>
  `.trim(),o="";switch(e.type){case"ProductList":o=en(e);break;case"GnavCards":o=Qe(e);break;default:}return`${i}${o}`};var rn={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},tn=e=>{if(e===null)return[{type:"Text",content:""},[new g(rn.elementNull,"Minor")]];let n=e.textContent;return n===null?[{type:"Text",content:""},[new g(rn.textContentNull,"Minor")]]:[{type:"Text",content:n},[]]};var on=({content:e})=>e;var sn=e=>{if(e===null)throw new c(Jn.elementNull);let n=e.querySelector(".gnav-brand");if(n!==null)return ue(n);let a=e.querySelector(".large-menu");return a!==null?Ke(a):e.querySelector("strong")!==null?ye(e):e.querySelector("em")!==null?H(e):e.querySelector("a")===null?tn(e):A(e.querySelector("a"))},we=(e,n)=>{switch(e.type){case"Text":return on(e);case"Link":return F(e);case"SecondaryCTA":return D(e);case"PrimaryCTA":return xe(e);case"Brand":return me(e);case"MegaMenu":return nn(e,n);default:return console.error(`Failed to recognize component: ${e}`),""}},Jn={elementNull:"Element is null"};var ln=(e,n,a=new Map)=>{let[r,t]=z([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],A),[i,o]=z([...e.children],sn),s=e.querySelector(".product-entry-cta"),[l,d]=(()=>{try{return Be(s)}catch{return[null,[]]}})(),u=!1,y=[t,o,d].flat();return{breadcrumbs:r,components:i,productCTA:l,localnav:u,errors:y,unavEnabled:n,placeholders:a}};var dn=e=>{let n=e.querySelector(".feds-skip-link"),a=l=>{let d=document.querySelector("#main-content");d instanceof HTMLElement&&(l.preventDefault(),d.hasAttribute("tabindex")||d.setAttribute("tabindex","-1"),setTimeout(()=>{d.focus(),d.scrollIntoView({behavior:"smooth",block:"start"})},100))};n?.addEventListener("click",a);let r=[...e.querySelectorAll('.tabs button[role="tab"]')],t=[...e.querySelectorAll(".tab-content ul")],i=r.map((l,d)=>()=>{let u=t[d].closest(":popover-open");if(r.forEach(h=>{h.setAttribute("aria-selected","false")}),t.forEach(h=>{h.setAttribute("hidden","true")}),t[d]?.removeAttribute("hidden"),l.setAttribute("aria-selected","true"),!u||!C.matches)return;let y=pn();if(!y)return;let w=u?.clientHeight??0;y.style.height=`${w+72}px`});r.forEach((l,d)=>{l.addEventListener("click",i[d])});let o=e.querySelector('.tabs[role="tablist"]'),s=()=>{o&&(C.matches?o.setAttribute("aria-orientation","vertical"):o.removeAttribute("aria-orientation"))};return s(),C.addEventListener("change",s),Qn(e),()=>{n?.removeEventListener("click",a),r.forEach((l,d)=>{l.removeEventListener("click",i[d])}),C.removeEventListener("change",s)}},pn=()=>[...document.adoptedStyleSheets.flatMap(e=>[...e.cssRules])].find(e=>e?.selectorText==="header.global-navigation nav::after"),Qn=e=>{let n=[...e.querySelectorAll(".feds-gnav-items > li > button")],a=e.querySelector(".feds-gnav-items"),r=pn(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=e.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});n.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!e.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",C.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else if(r.style.height=`${o.clientHeight+72}px`,!C.matches){let l=o.querySelector(".tabs"),d=o.querySelector('button[role="tab"][aria-selected="true"]'),u=l?.querySelector('button[role="tab"]');l&&d&&u&&(l.scrollLeft=d.offsetLeft-l.offsetLeft-u.offsetLeft)}}))}),n.forEach(i=>{i.addEventListener("click",()=>{if(C.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),C.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),e.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var cn=async e=>{let n=new Set,a=e.querySelectorAll("a.merch");if(a.length===0)return n;try{let r=E(),{base:t}=r;if(!t)return n.add(new g("base not found in config, cannot initialize merch links")),n;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return n.add(new g("decorateMerchLink not found in merch module")),n;a.forEach(s=>{o(s)})}catch(r){n.add(new g(`Error initializing merch links: ${r}`))}return n};var gn=async({gnavSource:e,asideSource:n})=>{let a=await B(e);if(a instanceof c)return a;let r=await B(n);return{mainNav:a,aside:r}};var fn=new CSSStyleSheet;fn.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,fn];var Co=async e=>{let{gnavSource:n,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=e;if(!(n instanceof URL))throw T(`gnavSource is invalid: ${n}`),new c("gnavSource needs to be a URL object");try{ce(t)}catch(u){throw T(`Failed to initialize MiloConfig: ${u}`),new c(`Failed to initialize MiloConfig: ${u}`)}Se(i),Me(e.localizeLink??(u=>u)),Ce(ke(e));let o=await gn(e);if(o instanceof c)throw T(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw T(s.message),s;let d=ln(s,r,await q());if(d instanceof c)throw T(d.message),d;return await ea(d)(a),aa(e)},ea=e=>async n=>{let a=na(e);document.querySelector("main")?.setAttribute("id","main-content"),n.innerHTML=a,n.classList.add("site-pivot"),n.querySelector("nav")?.showPopover();let r=[...n.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let i=e.components.filter(s=>s.type==="MegaMenu").map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,u]=await s;return r[l].innerHTML=an(d,r[l].id),u}catch(d){return[d]}}).flat());return n},na=({components:e,productCTA:n,unavEnabled:a,placeholders:r})=>`
<nav popover="manual" data-lenis-prevent>
  ...
  <ul role="presentation">
    ${(()=>{let t=e.find(d=>d.type==="Brand")??null,i=e.filter(d=>d.type!=="Brand"),o=`
      ...
      `.trim(),s=t?we(t):"",l=ze(i,we);return`
