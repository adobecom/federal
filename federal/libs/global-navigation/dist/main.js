...
`,Gn=n=>n.type==="PrimaryCTA"?xn(n):H(n);var O=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${_(e)}"${X(t,r)}${C(null,a??n)}>${n}${i}</a>`;var On=n=>{let[e,a]=je(n);return[{type:"LinksCard",card:e},a]},je=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=z(r,P),[o,s]=(()=>{try{return R(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Fn=(n,e="",a=new Map)=>{let r=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[i,o]=z(r,qe),[s,l]=z(t,P);return[{type:"ProductList",megaMenuTitle:e,categories:i,links:s,placeholders:a},[...o,...l]]},qe=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=Sn(e),[i,o]=z(t,gn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Xn=n=>{let[e,a]=Be(n);return[{type:"FeaturedCard",card:e},a]},Be=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=P(t),[s,l]=R(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var I={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Wn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c(I.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g(I.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g(I.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g(I.MissingBackgroundImageSrc)),a===void 0)throw new c(I.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g(I.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g(I.MissingIconSrc)),d===""&&r.add(new g(I.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",w=v?.getAttribute("href")??"",h=w?En(w):!1;v===null&&r.add(new g(I.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c(I.MissingTitleElement);let m=p?.textContent??"";m===""&&r.add(new g(I.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g(I.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return R(n)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${m} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:m,cta:f,priceText:y,priceHref:w,isPriceMerchLink:h}},[...r]]};var Kn=n=>{let e=new Set;if(n===null)throw new c(Zn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Zn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await q(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);if(An(i.href,s),n.classList.contains("product-list")){let l=await j();return Fn(s,a,l)}return Ge(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Zn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ge=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=z(a,i=>Oe(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Oe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=z(e,t=>Fe(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Fe=n=>{if(n.classList.contains("featured-card"))return Xn(n);if(n.classList.contains("links-card"))return On(n);if(n.classList.contains("promo-card"))return Wn(n);throw new c("Unsupported gnav cards section")};var Vn=({card:n},e)=>Xe(n,e),Xe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${M(a)}`;return`
...
`.trim()};var Yn=({card:n})=>We(n),We=({title:n,links:e,footerCTA:a})=>`
...
`.trim();var Jn=({card:n})=>Ze(n),Ze=({bgImageAlt:n,bgImageSrc:e,iconAlt:a,iconSrc:r,title:t,cta:i,priceText:o,priceHref:s,isPriceMerchLink:l})=>`
...
`.trim();var Ke=(n,e)=>{switch(n.type){case"FeaturedCard":return Vn(n,e);case"LinksCard":return Yn(n);case"PromoCard":return Jn(n);default:}return""},Qn=({sections:n,megaMenuTitle:e})=>`
  <div class="feds-gnav-cards">
    ${n.map(a=>`<li>${a.cards.map(r=>Ke(r,e)).join("")}</li>`).join("")}
  </div>
`;var ne=({categories:n,links:e,placeholders:a})=>{let r=`
...
`,ae=(n,e)=>{let{megaMenuTitle:a}=n,r=`
        <button
          type="button"
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=ne(n);break;case"GnavCards":o=Qn(n);break;default:}return`${i}${o}`};var re={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},te=n=>{if(n===null)return[{type:"Text",content:""},[new g(re.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new g(re.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var oe=({content:n})=>n;var ie=n=>{if(n===null)throw new c(Ye.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return un(e);let a=n.querySelector(".large-menu");return a!==null?Kn(a):n.querySelector("strong")!==null?yn(n):n.querySelector("em")!==null?R(n):n.querySelector("a")===null?te(n):P(n.querySelector("a"))},wn=(n,e)=>{switch(n.type){case"Text":return oe(n);case"Link":return O(n);case"SecondaryCTA":return H(n);case"PrimaryCTA":return xn(n);case"Brand":return mn(n);case"MegaMenu":return ee(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ye={elementNull:"Element is null"};var se=(n,e,a=new Map)=>{let[r,t]=z([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],P),[i,o]=z([...n.children],ie),s=n.querySelector(".product-entry-cta"),[l,d]=(()=>{try{return Bn(s)}catch{return[null,[]]}})(),v=!1,y=[t,o,d].flat();return{breadcrumbs:r,components:i,productCTA:l,localnav:v,errors:y,unavEnabled:e,placeholders:a}};var le=n=>{let e=n.querySelector(".feds-skip-link"),a=l=>{let d=document.querySelector("#main-content");d instanceof HTMLElement&&(l.preventDefault(),d.hasAttribute("tabindex")||d.setAttribute("tabindex","-1"),setTimeout(()=>{d.focus(),d.scrollIntoView({behavior:"smooth",block:"start"})},100))};e?.addEventListener("click",a);let r=[...n.querySelectorAll('.tabs button[role="tab"]')],t=[...n.querySelectorAll(".tab-content ul")],i=r.map((l,d)=>()=>{let v=t[d].closest(":popover-open");if(r.forEach(h=>{h.setAttribute("aria-selected","false")}),t.forEach(h=>{h.setAttribute("hidden","true")}),t[d]?.removeAttribute("hidden"),l.setAttribute("aria-selected","true"),!v||!E.matches)return;let y=de();if(!y)return;let w=v?.clientHeight??0;y.style.height=`${w+72}px`});r.forEach((l,d)=>{l.addEventListener("click",i[d])});let o=n.querySelector('.tabs[role="tablist"]'),s=()=>{o&&(E.matches?o.setAttribute("aria-orientation","vertical"):o.removeAttribute("aria-orientation"))};return s(),E.addEventListener("change",s),Je(n),()=>{e?.removeEventListener("click",a),r.forEach((l,d)=>{l.removeEventListener("click",i[d])}),E.removeEventListener("change",s)}},de=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Je=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=de(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",E.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(E.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),E.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var pe=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=S(),{base:t}=r;if(!t)return e.add(new g("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new g("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new g(`Error initializing merch links: ${r}`))}return e};var ce=async({gnavSource:n,asideSource:e})=>{let a=await q(n);if(a instanceof c)return a;let r=await q(e);return{mainNav:a,aside:r}};var ge=new CSSStyleSheet;ge.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,ge];var Co=async n=>{let{gnavSource:e,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=n;if(!(e instanceof URL))throw T(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{cn(t)}catch(v){throw T(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}Tn(i),Mn(n.localizeLink??(v=>v)),Ln(kn(n));let o=await ce(n);if(o instanceof c)throw T(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw T(s.message),s;let d=se(s,r,await j());if(d instanceof c)throw T(d.message),d;return await Qe(d)(a),ea(n)},Qe=n=>async e=>{let a=na(n);document.querySelector("main")?.setAttribute("id","main-content"),e.innerHTML=a,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let i=n.components.filter(s=>s.type==="MegaMenu").map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,v]=await s;return r[l].innerHTML=ae(d,r[l].id),v}catch(d){return[d]}}).flat());return e},na=({components:n,productCTA:e,unavEnabled:a,placeholders:r})=>`
...
`,ea=async n=>{let e=new Set,a=await tn(n.mountpoint);a instanceof g?(e.add(a),T(a.message)):a.errors.forEach(o=>e.add(o)),le(n.mountpoint),bn(n.mountpoint),aa(n.mountpoint),ra(n.mountpoint),ta(n.mountpoint),ia(n.mountpoint),sa(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),W(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),Hn(n.mountpoint),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await pe(n.mountpoint)).forEach(o=>{e.add(o),T(o.message)});let i=a instanceof g?()=>{}:a.reloadUnav;return{closeEverything:oa,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},aa=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},ra=n=>{E.addEventListener("change",()=>{W(n)})},ta=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>W(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&W(n)})})};var oa=()=>{},ia=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},sa=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${Rn()}${e}`)};export{Co as main,ea as postRenderingTasks,Qe as renderGnav,na as renderGnavString};
