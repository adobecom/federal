...
`,Gn=n=>n.type==="PrimaryCTA"?yn(n):R(n);var O=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${T(e)}"${X(t,r)}${C(null,a??n)}>${n}${i}</a>`;var On=n=>{let[e,a]=je(n);return[{type:"LinksCard",card:e},a]},je=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=P(r,M),[o,s]=(()=>{try{return I(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Fn=(n,e="")=>{let a=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,i]=P(a,qe),[o,s]=P(r,M);return[{type:"ProductList",megaMenuTitle:e,categories:t,links:o},[...i,...s]]},qe=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=Sn(e),[i,o]=P(t,cn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Xn=n=>{let[e,a]=Be(n);return[{type:"FeaturedCard",card:e},a]},Be=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=M(t),[s,l]=I(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var z={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Wn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c(z.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g(z.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g(z.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g(z.MissingBackgroundImageSrc)),a===void 0)throw new c(z.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g(z.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g(z.MissingIconSrc)),d===""&&r.add(new g(z.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,b=v?.textContent?.trim()??"",k=v?.getAttribute("href")??"",y=k?En(k):!1;v===null&&r.add(new g(z.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c(z.MissingTitleElement);let u=p?.textContent??"";u===""&&r.add(new g(z.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g(z.MissingSecondaryCtaAnchor));let[f,h]=(()=>{try{return I(n)}catch{return[null,[]]}})();return h.forEach(x=>r.add(x)),f&&(f.daaLl=`${u} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:u,cta:f,priceText:b,priceHref:k,isPriceMerchLink:y}},[...r]]};var Kn=n=>{let e=new Set;if(n===null)throw new c(Zn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Zn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await j(i);if(o instanceof c)throw new Error(o.message);let s=await An(o);if(s instanceof c)throw new Error(s.message);return Pn(i.href,s),n.classList.contains("product-list")?Fn(s,a):Ge(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Zn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ge=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=P(a,i=>Oe(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Oe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=P(e,t=>Fe(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Fe=n=>{if(n.classList.contains("featured-card"))return Xn(n);if(n.classList.contains("links-card"))return On(n);if(n.classList.contains("promo-card"))return Wn(n);throw new c("Unsupported gnav cards section")};var Vn=({card:n},e)=>Xe(n,e),Xe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${S(a)}`;return`
...
`;var ne=({categories:n,links:e})=>{let a=Y(),r=`
...
`,ae=(n,e)=>{let{megaMenuTitle:a}=n,r=`
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=ne(n);break;case"GnavCards":o=Qn(n);break;default:}return`${i}${o}`};var re={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},te=n=>{if(n===null)return[{type:"Text",content:""},[new g(re.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new g(re.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var oe=({content:n})=>n;var ie=n=>{if(n===null)throw new c(Ye.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return fn(e);let a=n.querySelector(".large-menu");return a!==null?Kn(a):n.querySelector("strong")!==null?bn(n):n.querySelector("em")!==null?I(n):n.querySelector("a")===null?te(n):M(n.querySelector("a"))},xn=(n,e)=>{switch(n.type){case"Text":return oe(n);case"Link":return O(n);case"SecondaryCTA":return R(n);case"PrimaryCTA":return yn(n);case"Brand":return un(n);case"MegaMenu":return ee(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ye={elementNull:"Element is null"};var se=(n,e)=>{let[a,r]=P([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],M),[t,i]=P([...n.children],ie),o=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Bn(o)}catch{return[null,[]]}})(),d=!1,v=[r,i,l].flat();return{breadcrumbs:a,components:t,productCTA:s,localnav:d,errors:v,unavEnabled:e}};var le=n=>{let e=n.querySelector(".feds-skip-link"),a=o=>{let s=document.querySelector("#main-content");s instanceof HTMLElement&&(o.preventDefault(),s.hasAttribute("tabindex")||s.setAttribute("tabindex","-1"),setTimeout(()=>{s.focus(),s.scrollIntoView({behavior:"smooth",block:"start"})},100))};e?.addEventListener("click",a);let r=[...n.querySelectorAll('.tabs button[role="tab"]')],t=[...n.querySelectorAll(".tab-content ul")],i=r.map((o,s)=>()=>{let l=t[s].closest(":popover-open");if(r.forEach(b=>{b.setAttribute("aria-selected","false")}),t.forEach(b=>{b.setAttribute("hidden","true")}),t[s]?.removeAttribute("hidden"),o.setAttribute("aria-selected","true"),!l||!_.matches)return;let d=de();if(!d)return;let v=l?.clientHeight??0;d.style.height=`${v+72}px`});return r.forEach((o,s)=>{o.addEventListener("click",i[s])}),Je(n),()=>{e?.removeEventListener("click",a),r.forEach((o,s)=>{o.removeEventListener("click",i[s])})}},de=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Je=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=de(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",_.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(_.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),_.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var pe=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=L(),{base:t}=r;if(!t)return e.add(new g("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new g("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new g(`Error initializing merch links: ${r}`))}return e};var ce=async({gnavSource:n,asideSource:e})=>{let a=await j(n);if(a instanceof c)return a;let r=await j(e);return{mainNav:a,aside:r}};var ge=new CSSStyleSheet;ge.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,ge];var Lo=async n=>{let{gnavSource:e,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=n;if(!(e instanceof URL))throw E(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{pn(t)}catch(v){throw E(`Failed to initialize MiloConfig: ${v}`),new c(`Failed to initialize MiloConfig: ${v}`)}Tn(i),Mn(n.localizeLink??(v=>v)),Cn(wn(n));let o=await ce(n);if(o instanceof c)throw E(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof c)throw E(s.message),s;let d=se(s,r);if(d instanceof c)throw E(d.message),d;return await Qe(d)(a),ea(n)},Qe=n=>async e=>{let a=na(n);document.querySelector("main")?.setAttribute("id","main-content"),e.innerHTML=a,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let i=n.components.filter(s=>s.type==="MegaMenu").map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,v]=await s;return r[l].innerHTML=ae(d,r[l].id),v}catch(d){return[d]}}).flat());return e},na=({components:n,productCTA:e,unavEnabled:a})=>`
...
`,ea=async n=>{let e=new Set,a=await on(n.mountpoint);a instanceof g?(e.add(a),E(a.message)):a.errors.forEach(o=>e.add(o)),le(n.mountpoint),hn(n.mountpoint),aa(n.mountpoint),ra(n.mountpoint),ta(n.mountpoint),ia(n.mountpoint),sa(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),W(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),Hn(n.mountpoint),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await pe(n.mountpoint)).forEach(o=>{e.add(o),E(o.message)});let i=a instanceof g?()=>{}:a.reloadUnav;return{closeEverything:oa,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},aa=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},ra=n=>{_.addEventListener("change",()=>{W(n)})},ta=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>W(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&W(n)})})};var oa=()=>{},ia=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},sa=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${Rn()}${e}`)};export{Lo as main,ea as postRenderingTasks,Qe as renderGnav,na as renderGnavString};
