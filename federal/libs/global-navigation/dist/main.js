...
`,Bn=n=>n.type==="PrimaryCTA"?bn(n):$(n);var q=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${E(e)}"${O(t,r)}${k(null,a??n)}>${n}${i}</a>`;var qn=n=>{let[e,a]=Ue(n);return[{type:"LinksCard",card:e},a]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new p("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new p("Expected at least one link");let[t,i]=_(r,T),[o,s]=(()=>{try{return z(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Gn=n=>{let e=[...n.querySelectorAll("li > div")],a=[...n.querySelectorAll("li > a")],[r,t]=_(e,Ne),[i,o]=_(a,T);return[{type:"ProductList",categories:r,links:i},[...t,...o]]},Ne=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new p("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=En(e),[i,o]=_(t,pn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var On=n=>{let[e,a]=je(n);return[{type:"FeaturedCard",card:e},a]},je=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new p("Expected title");if(!r)throw new p("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new p("Expected card link after subtitle");let[i,o]=T(t),[s,l]=z(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var P={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Fn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new p(P.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new u(P.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new u(P.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new u(P.MissingBackgroundImageSrc)),a===void 0)throw new p(P.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new u(P.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&r.add(new u(P.MissingIconSrc)),d===""&&r.add(new u(P.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,x=v?.textContent?.trim()??"",c=v?.getAttribute("href")??"",g=c?Ln(c):!1;v===null&&r.add(new u(P.MissingPriceLink));let f=a.querySelector("p > strong")??null;if(f===null)throw new p(P.MissingTitleElement);let h=f?.textContent??"";h===""&&r.add(new u(P.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new u(P.MissingSecondaryCtaAnchor));let[m,b]=(()=>{try{return z(n)}catch{return[null,[]]}})();return b.forEach(w=>r.add(w)),m&&(m.daaLl=`${h} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:h,cta:m,priceText:x,priceHref:c,isPriceMerchLink:g}},[...r]]};var Wn=n=>{let e=new Set;if(n===null)throw new p(Xn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new u(Xn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await U(i);if(o instanceof p)throw new Error(o.message);let s=await Pn(o);if(s instanceof p)throw new Error(s.message);return Mn(i.href,s),n.classList.contains("product-list")?Gn(s):Be(s)}catch(t){throw new p(t?.message)}})();if(r instanceof p)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Xn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=n=>{let e=[...n.children];if(e.length===0)throw new p("No mega menu items found (did you forget to add them correctly?)");let[a,r]=_(e,t=>qe(t));if(a.length===0)throw new p("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:a},r]},qe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new p("Column contains no cards (did you forget to label them correctly?)");let[a,r]=_(e,t=>Ge(t));if(a.length===0)throw new p("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Ge=n=>{if(n.classList.contains("featured-card"))return On(n);if(n.classList.contains("links-card"))return qn(n);if(n.classList.contains("promo-card"))return Fn(n);throw new p("Unsupported gnav cards section")};var Zn=({card:n},e)=>Oe(n,e),Oe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${S(a)}`;return`
...
`.trim()};var Kn=({card:n})=>Fe(n),Fe=({title:n,links:e,footerCTA:a})=>`
  <article class="links-card" ${k(n,"")}>
    ...
    <div class="links-card-footer">
      ${$({...a,ariaAttrs:{"aria-describedby":`links-card-${S(n)}`}})}
    </div>`}
  </article>
    ...
    <div class="promo-card__content">
      ...
      <div class="promo-card__text-content">
        ...
        ${i===null?"":`<div class="promo-card__cta">
                 ${$({...i,ariaAttrs:{"aria-describedby":`title-${S(t)}${l?` price-${S(t)}`:""}`}})}
               </div>`}
      </div>
    </div>
  </article>
