...
`,Bn=n=>n.type==="PrimaryCTA"?xn(n):R(n);var O=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${_(e)}"${X(t,r)}${C(null,a??n)}>${n}${i}</a>`;var Gn=n=>{let[e,a]=Ne(n);return[{type:"LinksCard",card:e},a]},Ne=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new c("Expected at least one link");let[t,i]=P(r,A),[o,s]=(()=>{try{return I(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var On=(n,e="",a=new Map)=>{let r=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[i,o]=P(r,je),[s,l]=P(t,A);return[{type:"ProductList",megaMenuTitle:e,categories:i,links:s,placeholders:a},[...o,...l]]},je=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=Sn(e),[i,o]=P(t,gn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var Fn=n=>{let[e,a]=qe(n);return[{type:"FeaturedCard",card:e},a]},qe=n=>{let e=n.querySelector("h5")||null;if(!e)throw new g("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new c("Expected title");if(!r)throw new c("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new c("Expected card link after subtitle");let[i,o]=A(t),[s,l]=I(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var $={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Xn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new c($.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new g($.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new g($.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new g($.MissingBackgroundImageSrc)),a===void 0)throw new c($.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new g($.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&r.add(new g($.MissingIconSrc)),d===""&&r.add(new g($.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,y=v?.textContent?.trim()??"",w=v?.getAttribute("href")??"",h=w?En(w):!1;v===null&&r.add(new g($.MissingPriceLink));let p=a.querySelector("p > strong")??null;if(p===null)throw new c($.MissingTitleElement);let m=p?.textContent??"";m===""&&r.add(new g($.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new g($.MissingSecondaryCtaAnchor));let[f,b]=(()=>{try{return I(n)}catch{return[null,[]]}})();return b.forEach(x=>r.add(x)),f&&(f.daaLl=`${m} - ${f?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:m,cta:f,priceText:y,priceHref:w,isPriceMerchLink:h}},[...r]]};var Zn=n=>{let e=new Set;if(n===null)throw new c(Wn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new g(Wn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await q(i);if(o instanceof c)throw new Error(o.message);let s=await Pn(o);if(s instanceof c)throw new Error(s.message);if(An(i.href,s),n.classList.contains("product-list")){let l=await j();return On(s,a,l)}return Be(s,a)}catch(t){throw new c(t?.message)}})();if(r instanceof c)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Wn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=(n,e)=>{let a=[...n.children];if(a.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=P(a,i=>Ge(i));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",megaMenuTitle:e,sections:r},t]},Ge=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[a,r]=P(e,t=>Oe(t));if(a.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Oe=n=>{if(n.classList.contains("featured-card"))return Fn(n);if(n.classList.contains("links-card"))return Gn(n);if(n.classList.contains("promo-card"))return Xn(n);throw new c("Unsupported gnav cards section")};var Kn=({card:n},e)=>Fe(n,e),Fe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${M(a)}`;return`
...
`.trim()};var Vn=({card:n})=>Xe(n),Xe=({title:n,links:e,footerCTA:a})=>`
  <article class="links-card" ${C(n,"")}>
    ...
    <div class="links-card-footer">
      ${R({...a,ariaAttrs:{"aria-describedby":`links-card-${M(n)}`}})}
    </div>`}
  </article>
    ...
    <div class="promo-card__content">
      ...
      <div class="promo-card__text-content">
        ...
        ${i===null?"":`<div class="promo-card__cta">
                 ${R({...i,ariaAttrs:{"aria-describedby":`title-${M(t)}${l?` price-${M(t)}`:""}`}})}
               </div>`}
      </div>
    </div>
  </article>
...
`;var Qn=({categories:n,links:e,placeholders:a})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Ke).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${_(e[e.length-1].href)}"${C(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${H.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
