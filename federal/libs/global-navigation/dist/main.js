var xn=async n=>{let{placeholders:e}=n,{locale:a}=C(),t=`${Y()}${a.prefix}/federal/globalnav/placeholders.json`,[i,o]=await Promise.all([e,ce(t)]);return new Map([...o,...i])},ce=async n=>{try{let e=await fetch(n);if(!e.ok)throw new u(`Federal placeholders not found at ${n}`);let a=ge(await e.json());if(a instanceof u)throw a;return new Map(a.data.map(({key:r,value:t})=>[r,t]))}catch(e){if(e instanceof u)console.error(e.message);else{let a=new u(e.message);console.error(a.message)}return L(`Failed to fetch placeholders from ${n}`),new Map([])}},ge=n=>{try{let{data:e}=n;if(!e.every(({key:r,value:t})=>typeof r=="string"&&typeof t=="string"))throw new Error("data is not valid");return n}catch(e){return new u(e.message)}};function wn(n,e){let a=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return a.test(n)?n.replace(a,(t,i,o)=>{let s=i??o??"";return e.get(s)??s}):n}var[kn,Cn,V]=(()=>{let n,e;return[a=>{n||(n=a.then(r=>(e=r,r)))},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n},()=>{if(!e)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return e}]})();var _=window.matchMedia("(min-width: 1024px)"),I={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},fe=["/tools/ost?","/miniplans"],Ln=n=>fe.some(e=>n.includes(e));var En=n=>{let e=[],a=n.nextElementSibling??null;for(;a!==null;)e.push(a),a=a.nextElementSibling??null;return e},G=n=>({eval:n,or:e=>G(a=>{try{return n(a)}catch{return e(a)}})}),M=(n,e)=>n.reduce(([a,r],t)=>{try{let[i,o]=e(t);return[[...a,i],[...r,...o]]}catch(i){return i instanceof p?[a,[i,...r]]:[a,r]}},[[],[]]),[Sn,ue]=(()=>{let n,e=!1;return[a=>{e||(n=a,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),[Tn,_n]=(()=>{let n=e=>e;return[e=>{n=e},()=>n]})(),S=n=>{try{return _n()(n)}catch{return n}},U=async n=>{try{if(n===null)return new p("URL is null");let e=`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`,a=_n()(e),r=R(a),t=await fetch(r);if(!t.ok)return L(`Request for ${r} failed`),new p(`Request for ${r} failed`);let i=await t.text(),o=await Cn(),s=wn(i,o),{body:l}=new DOMParser().parseFromString(s,"text/html");try{let{handleCommands:d,commands:v}=ue();d(v,l)}catch(d){L(`Personalization not applied: ${d?.message}`)}return l}catch(e){return new p(e?.message)}},H,Y=()=>{if(H)return H;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(H)return H;let e=window.location.origin;H=n.some(t=>{let i=e.replace(".stage","");return t.startsWith("https://")?i===t:i.endsWith(t)})?e:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${r}.`))&&(H=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),H},R=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${Y()}${n}`;try{let{pathname:e,search:a,hash:r}=new URL(n);return`${Y()}${e}${a}${r}`}catch(e){let a=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${a}`)}return n},Mn=(n,e)=>{let a=(r,t)=>{let i=`${r}[${t}^="./media_"]`;e.querySelectorAll(i).forEach(s=>{let l=s.getAttribute(t);if(!(l===null||l===""))try{let d=R(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(t,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${r}`,d)}})};a("img","src"),a("source","srcset")},Pn=async n=>{let e=async(a,r)=>{if(a instanceof p)return a;try{let i=[...a.querySelectorAll('a[href*="#_inline"]')].map(async o=>{try{if(r.has(o.href))return;let s=R(o.href),l=new URL(s),d=await U(l);if(r.add(o.href),d instanceof p)throw d;await e(d,r),o.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),a}catch(t){return new p(JSON.stringify(t))}};return e(n,new Set)},An=(n,e)=>n.map((a,r)=>`<li>${e(a,r)}</li>`).join(""),E=n=>{let e=n.normalize("NFKC").toLocaleLowerCase().trim().replace(/[^\p{L}\p{N}\p{M}]+/gu,"-").replace(/^-+|-+$/g,"");return e===""?"id":/^\p{N}/u.test(e)?`id-${e}`:e},k=(n,e)=>{let a=n!==null&&n!==""?` daa-lh="${n}"`:"",r=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${a}${r}`},O=(n,e)=>{if(!n&&!e)return"";let a=[];return e!=null&&e!==""?a.push(`aria-label="${e}"`):n?.["aria-label"]&&a.push(`aria-label="${n["aria-label"]}"`),n&&Object.entries(n).forEach(([r,t])=>{r!=="aria-label"&&t&&a.push(`${r}="${t}"`)}),a.length>0?` ${a.join(" ")}`:""};function me(n,{id:e,as:a,callback:r,crossorigin:t,rel:i,fetchpriority:o}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return r?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",i),e!==void 0&&l.setAttribute("id",e),a!==void 0&&l.setAttribute("as",a),t!==void 0&&l.setAttribute("crossorigin",t),o!==void 0&&l.setAttribute("fetchpriority",o),l.setAttribute("href",n),r&&(l.onload=d=>r(d.type),l.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(l),l}function ve(n,e){return me(n,{rel:"stylesheet",callback:e})}function sn(n,e=!1){e&&ve(n)}var ln=(n,e,{mode:a,id:r}={})=>new Promise((t,i)=>{let o=document.querySelector(`head > script[src="${n}"]`);if(!o){let{head:d}=document;o=document.createElement("script"),o.setAttribute("src",n),r!=null&&o.setAttribute("id",r),e!=null&&o.setAttribute("type",e),a&&["async","defer"].includes(a)&&o.setAttribute(a,""),d.append(o)}let s=o.dataset.loaded;if(s!=null){t(o);return}let l=d=>{o.removeEventListener("load",l),o.removeEventListener("error",l),d.type==="error"?i(new Error(`error loading script: ${o.src}`)):d.type==="load"&&(o.dataset.loaded="true",t(o))};o.addEventListener("load",l),o.addEventListener("error",l)});function N(n,e=document){let a=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${a}="${n}"]`)?.content??null}var he=n=>{let e=n,a=i=>i==null||typeof i!="object";if(a(e)||a(e.locale)||typeof e.locale.prefix!="string"||a(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let i=e.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let o=i.profile;if(o.signInCtaStyle!==void 0&&o.signInCtaStyle!=="primary"&&o.signInCtaStyle!=="secondary"||o.messageEventListener!==void 0&&typeof o.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[dn,C]=(()=>{let n,e=!1;return[a=>{if(!e){if(!he(a))throw new Error("MiloConfig validation failed: Invalid structure");n=a,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),be={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},zn={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function ye(n){let e=be[n];return!e&&zn[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var on="langstore/";function $n(n){let a=(n?.prefix||"US_en").replace("/","")??"",[r="US",t="en"]=(zn[a]??a).split("_",2);if(a.startsWith(on)||window.location.pathname.startsWith(`/${on}`)){let i=a.replace(on,"").toLowerCase();r=ye(i),t=i}return r=r.toUpperCase(),t=t.toLowerCase(),{language:t,country:r,locale:`${t}_${r}`}}var F=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function In(){let n=N("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var J={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},T=n=>{if(n===null)throw new p(J.elementNull);if(n.tagName!=="A")throw new p(J.notAnchor);let[e,a]=n?.textContent?.split("|").map(i=>i.trim())??["",""];if(e==="")throw new p(J.textContentNotFound);let r=n?.getAttribute("href")??"";if(r==="")throw new p(J.hrefNotFound);let t=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:r,daaLl:t,ariaLabel:a},[]]};var pn=n=>{if(!n)throw new p(P.elementNull);if(!n.classList.contains("product-card"))throw new p(P.notAProductCard);return G(we).or(xe).or(ke).eval(n)},P={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},xe=n=>{let e=new Set;if(!n)throw new p(P.elementNull);let a=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!a)throw new p(P.noTitleAnchor);let r=a.textContent??"";r===""&&e.add(new u(P.noTitle));let t=a.getAttribute("href")??"";t===""&&e.add(new u(P.noHref));let i=a.getAttribute("daa-ll"),o=a.getAttribute("daa-lh"),s=a?.closest("p")?.nextElementSibling;s||e.add(new u(P.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new u(P.noSubtitle));let d=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],v=Array.from(d).map(g=>{let f=g.querySelector("strong")!==null;return{text:g?.textContent?.trim()??"",isFilled:f}}),[x,c=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(g=>g.trim());return[{type:"ProductCardLink",iconHref:x,iconAlt:c,title:r,href:t,subtitle:l,badges:v,daaLl:i,daaLh:o},[...e]]},we=n=>{if(!n)throw new p(P.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new p(P.notAHeader);let a=n.querySelector("a")?.textContent??"",r=n.querySelector("a")?.getAttribute("daa-ll")??null,t=n.querySelector("a")?.getAttribute("daa-lh")??null;if(a==="")throw new p(P.noTitle);return[{type:"ProductCardHeader",title:a,classes:e,daaLl:r,daaLh:t},[]]},ke=n=>{if(!n)throw new p(P.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[a,r]=T(e),t=e?.getAttribute("daa-ll")??null,i=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:a,daaLl:t,daaLh:i},r]};var cn=n=>{switch(n.type){case"ProductCardHeader":return Ce(n);case"ProductCardLink":return Le(n);case"ProductCardBlue":return Ee(n);default:return console.error(n),""}},Ce=({title:n,classes:e,daaLl:a,daaLh:r})=>{let t=e.slice(1).map(o=>`feds-product-card--${o}`).join(" "),i=k(r,a??n);return`
    <div role="heading" class="feds-product-card ${t}"${i}>
      <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n}</div>
      </div>
    </div>
  `},Le=({iconHref:n,iconAlt:e,title:a,href:r,subtitle:t,badges:i=[],daaLl:o,daaLh:s})=>{let l=e!==null&&n!==null,d=k(s,o??a),v=l?`
    ...
    `:"",x=i.length===0?"":`
      <div class="feds-product-card__badges">
        ${i.map(({text:g,isFilled:f})=>`
          <span class="feds-product-card__badge${f?" feds-product-card__badge--filled":""}">
            ${g}
          </span>
        `).join("")}
      </div>
    `,c=t===""?"":`<div class="feds-product-card__subtitle">${t}</div>`;return`
    <a class="feds-product-card" href="${S(r)}"${d}>
  ...
  `},Ee=({link:n,daaLl:e,daaLh:a})=>{let r=k(a,e??n.text);return`
  <a href="${S(n.href)}" class="feds-product-card feds-product-card--blue"${r}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var j={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},gn=n=>{let e=new Set;if(n===null)throw new p(j.elementNull);let a=!!n.classList.contains("dark-bg"),[r,t]=n.querySelectorAll(":scope > div");if(r===void 0)throw new p(j.noLinkSection);let i=r.querySelector("a");if(i===null)throw new p(j.noLink);let o=i.getAttribute("href")??"",s=i.textContent?.trim()??"";t===void 0&&e.add(new u(j.noImageSection));let[l,d]=t?.querySelectorAll(":scope > div")??[];(l===void 0||d===void 0)&&e.add(new u(j.missingImageSections));let v=l?.querySelectorAll('a[href$=".svg"]'),x=d?.querySelectorAll('a[href$=".svg"]'),c=v?.[0]?.getAttribute("href")??"",g=v?.[0]?.textContent?.split("|")[1]?.trim()??"",f=v?.[1]?.getAttribute("href")??"",h=v?.[1]?.textContent?.split("|")[1]?.trim()??"",y=x?.[0]?.getAttribute("href")??"",m=x?.[0]?.textContent?.split("|")[1]?.trim()??"",b=x?.[1]?.getAttribute("href")??"",w=x?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!c||!y||!f||!b)&&e.add(new u(j.missingThemeImages)),[{type:"Brand",data:{href:o,label:s,isDarkBg:a,imageData:{type:"svg",lightThemeImageSrc:y,lightThemeImageAlt:m,darkThemeImageSrc:b,darkThemeImageAlt:w,mobileLightThemeImageSrc:c,mobileLightThemeImageAlt:g,mobileDarkThemeImageSrc:f,mobileDarkThemeImageAlt:h}}},[...e]]};var Se=`
<?xml
...
`.trim(),_e=n=>{let{href:e,label:a,isDarkBg:r,imageData:t}=n,i=t.lightThemeImageSrc?.trim()||t.darkThemeImageSrc?.trim()||"",o=t.darkThemeImageSrc?.trim()||t.lightThemeImageSrc?.trim()||"",s=t.mobileLightThemeImageSrc?.trim()||t.mobileDarkThemeImageSrc?.trim()||"",l=t.mobileDarkThemeImageSrc?.trim()||t.mobileLightThemeImageSrc?.trim()||"",d=t.lightThemeImageAlt||t.darkThemeImageAlt||"",v=t.darkThemeImageAlt||t.lightThemeImageAlt||"",x=t.mobileLightThemeImageAlt||t.mobileDarkThemeImageAlt||"",c=t.mobileDarkThemeImageAlt||t.mobileLightThemeImageAlt||"",g=!!i,f=!!o,h=!!s,y=!!l,m=g?`<img src="${R(i)}" alt="${d}" />`:"",b=f?`<img src="${R(o)}" alt="${v}" />`:"",w=h?`<img src="${R(s)}" alt="${x}" />`:"",K=y?`<img src="${R(l)}" alt="${c}" />`:"";return`<div class="feds-brand-container${r?" feds-dark-bg":""}">
  ...
  </div>`.trim()},fn=n=>{let{data:e}=n;return _e(e)};var un=["appswitcher","help"],Q={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[X,Rn]=(()=>{let n,e,a,r=new Promise(t=>{e=t,a=setTimeout(()=>{n={},t(n)},5e3)});return[t=>{t&&!n&&(n=t,clearTimeout(a),e?.(n))},()=>r]})();function nn(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(d=>d!=="cart"))??[],l=s.length??3;if(e){let d=s.filter(x=>un.includes(x)).length;return`calc(92px + ${d*32}px + ${d*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var en=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[r,t]=e.split("_").reverse();return`${r.toLowerCase()}_${t.toUpperCase()}`}if(e==="uk")return"en_GB";let a=Object.keys(Q).find(r=>Q[r].includes(e));return a?`${a.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},Me={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},an=()=>{let n=navigator.userAgent;for(let[e,a]of Object.entries(Me))if(n.includes(e))return a;return"linux"},rn=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Hn=()=>{try{return C().signInContext||{}}catch{return{}}},Pe=()=>{let n=C();return N("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Ae=()=>{let e=C()?.unav?.profile?.messageEventListener;return e||(a=>{let{name:r,payload:t,executeDefaultAction:i}=a.detail;if(!(!r||r!=="System"||!t||typeof i!="function"))switch(t.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(o=>{X(o)}).catch(()=>{X({})});break;case"SignOut":i();break;case"ProfileSwitch":Promise.resolve(i()).then(o=>{o&&window.location.reload()});break;default:break}})};function ze(){let{unav:n}=C();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var W=()=>{let n=C();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Ae()},signInCtaStyle:Pe(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Hn())},onSignUp:()=>{window.adobeIMS?.signIn(Hn())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:ze()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Dn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},tn=async(n,e)=>{try{let a=n.querySelector(".feds-utilities");if(!(a instanceof HTMLElement))return new u('missing ".feds-utilities" container');let r=new Set,t=document.head.querySelector('meta[name="universal-nav"]'),i=t instanceof HTMLMetaElement?t.content??"":"";t instanceof HTMLMetaElement||r.add(new u('metadata "universal-nav" is missing'));let o=i.trim();t instanceof HTMLMetaElement&&o.length===0&&r.add(new u('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=o.split(",").map(m=>m.trim()).filter(m=>Object.keys(W()).includes(m)||m==="signup");if(s){let m=nn(l,s);a.style.setProperty("min-width",m)}let d;try{d=C()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let v=en(d.locale),x=d.env.name==="prod"?"prod":"stage",c=await rn(),g=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(g??"")||(g="1.5"),await Promise.all([ln(`https://${x}.adobeccstatic.com/unav/${g}/UniversalNav.js`),sn(`https://${x}.adobeccstatic.com/unav/${g}/UniversalNav.css`,!0)]);let f=()=>{let m=W(),b=[m.profile];return Dn(b,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){Dn(b,!0);return}let K=m[w];K&&b.push(K)}),b},h=()=>({target:a,env:x,locale:v,countryCode:$n(d?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:an(),os_version:navigator.platform},event:{visitor_guid:c}},children:f(),isSectionDividerRequired:!!d?.unav?.showSectionDivider,showTrayExperience:!_.matches});await window?.UniversalNav?.(h()),s||a?.style.removeProperty("min-width");let y=m=>{window?.UniversalNav?.reload(h())};return _.addEventListener("change",()=>{y()}),{reloadUnav:y,errors:r}}catch(a){let r=a instanceof Error?a.message:"failed to load universal nav";return new u(r)}};function D(n,e){return[...n.querySelectorAll(e)]}function Z(n,e,a){D(n,e).forEach(r=>a?r.removeAttribute("tabindex"):r.setAttribute("tabindex","-1"))}var B={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Un=new Set(["ArrowLeft","ArrowRight"]),$e=new Set(["ArrowUp","ArrowDown"]),Ie='.tabs [role="tab"][aria-selected="true"]';function mn(n,e,a){return(n+e+a)%a}function Re(n,e,a,r){let t=B[a];if(Un.has(a)){let g=e+t;return g>=0&&g<n.length?g:null}let i=getComputedStyle(r).gridTemplateColumns.split(" ").length,o=[...r.children],s=g=>{let f=n[g].parentElement;return f?o.indexOf(f):-1},l=s(e)%i,d=Math.floor(s(e)/i)+(a==="ArrowDown"?1:-1),v=Math.floor((o.length-1)/i);if(d<0||d>v)return null;let x=null,c=1/0;for(let g=0;g<n.length;g++){let f=Math.abs(s(g)%i-l);Math.floor(s(g)/i)===d&&f<c&&(c=f,x=g)}return x}function vn(n){Z(n,'.tab-content [role="tabpanel"] a',!1);let e=[];D(n,".feds-popup[popover]").forEach(c=>{let g=()=>{c.matches(":popover-open")||Z(c,'[role="tabpanel"] a',!1)};c.addEventListener("toggle",g),e.push(()=>c.removeEventListener("toggle",g));let f=!1,h=m=>{m.key==="Tab"&&!m.shiftKey&&(f=!0)};c.addEventListener("keydown",h),e.push(()=>c.removeEventListener("keydown",h));let y=m=>{if(f&&!c.contains(m.relatedTarget)){if(c.hidePopover?.(),!_.matches){let b=c.closest(".feds-gnav-items");b?.classList.remove("subscreen-opening"),b?.classList.add("subscreen-closing")}f=!1}};c.addEventListener("focusout",y),e.push(()=>c.removeEventListener("focusout",y))});let a=(c,g)=>{c.focus(),g.preventDefault()},r=()=>n.querySelector(".feds-popup:popover-open"),t=c=>c.querySelector(Ie),i=c=>c.querySelector('[role="tabpanel"]:not([hidden])');function o(c){let g=r(),f=n.querySelector("#feds-menu-wrapper");if(!f)return!1;let h=f.querySelector(".feds-gnav-items"),y=g?g.querySelector(".feds-popup-back-button"):null,m=h?.classList.contains("subscreen-opening")===!0;if(g!==null&&m&&y!==null)return y.click(),c.preventDefault(),!0;let b=g??(f?.matches(":popover-open")?f:null);if(!b)return!1;b.hidePopover?.();let w=g?`[popovertarget="${b.id}"]`:".feds-nav-toggle";return n.querySelector(w)?.focus(),c.preventDefault(),!0}function s(c,g,f){if(!Un.has(g))return!1;let h=D(n,".feds-gnav-items > li > .feds-link"),y=h.indexOf(c);return y<0?!1:(a(h[mn(y,B[g],h.length)],f),!0)}function l(c,g,f,h){let y=D(g,'.tabs :is([role="tab"], .product-links a)'),m=y.indexOf(c);if(m<0)return!1;if(B[f]){let b=y[mn(m,B[f],y.length)];return b.matches('[role="tab"]')&&b.click(),a(b,h),!0}if(f==="Tab"&&!h.shiftKey&&c.matches('[aria-selected="true"]')){let b=i(g);if(!b)return!1;Z(b,"a",!0);let w=b.querySelector("a");return w&&a(w,h),!0}return!1}function d(c,g,f,h){let y=i(g);if(!y)return!1;let m=D(y,"a"),b=m.indexOf(c);if(b<0)return!1;if(B[f]){let w=Re(m,b,f,y);return w!==null?(a(m[w],h),!0):f==="ArrowUp"?(Z(y,"a",!1),a(t(g)??m[0],h),!0):!1}if(f==="Tab"&&!h.shiftKey){if(b+1<m.length)a(m[b+1],h);else return!1;return!0}if(f==="Tab"&&h.shiftKey){if(b>0)a(m[b-1],h);else{Z(y,"a",!1);let w=t(g)??D(g,'.tabs :is([role="tab"], .product-links a)')[0];w&&a(w,h)}return!0}return!1}function v(c,g,f,h){if(!$e.has(f))return!1;let y=D(g,".feds-gnav-cards a"),m=y.indexOf(c);return m<0?!1:(a(y[mn(m,B[f],y.length)],h),!0)}function x(c){let g=document.activeElement??c.target;if(c.key==="Escape"){o(c);return}let f=r();f&&(f.matches(":has(.product-list)")&&(l(g,f,c.key,c)||d(g,f,c.key,c))||f.matches(":has(.feds-gnav-cards)")&&v(g,f,c.key,c))||s(g,c.key,c)}return n.addEventListener("keydown",x),e.push(()=>n.removeEventListener("keydown",x)),()=>e.forEach(c=>c())}var He="feds-milo",L=(n,e="default",a="e")=>{let{locale:r}=C(),t=N("gnav-source")??`${r.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${t} | href: ${window.location.href}`,{clientId:He,sampleRate:1,tags:e,errorType:a})};var p=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},u=class n extends Error{constructor(e,a="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),a==="Critical"&&L(e)}};var Nn=n=>e=>{if(e===null)throw new Error("");let a=e.querySelector(De(n));if(!a)throw new Error("");let r=a.textContent??"",[t="",i=""]=r.split("|").map(x=>x.trim());if(t==="")throw new Error("");let o=a.getAttribute("href")??"";if(o==="")throw new Error("");let s=a.getAttribute("daa-ll"),l=a.getAttribute("aria-label")?.trim()??"",d=l!==""?l:i!==""?i:void 0,v=[];return[{type:n.type,text:t,href:o,ariaLabel:d,daaLl:typeof s=="string"&&s.trim()!==""?s:t},v]},hn=Nn({type:"PrimaryCTA"}),z=Nn({type:"SecondaryCTA"}),jn=n=>G(hn).or(z).eval(n),De=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var bn=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${S(e)}"
  class="feds-primary-cta"${O(t,r)}
  ${k(null,a??n)}
>
  ${n}
</a>
`,$=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t})=>`
<a href="${S(e)}" 
  class="feds-secondary-cta"${O(t,r)}
  ${k(null,a??n)}
>
  ${n}
</a>
`,Bn=n=>n.type==="PrimaryCTA"?bn(n):$(n);var q=({text:n,href:e,daaLl:a,ariaLabel:r,ariaAttrs:t,svgIcon:i=""})=>`<a class="feds-link" href="${S(e)}"${O(t,r)}${k(null,a??n)}>${n}${i}</a>`;var qn=n=>{let[e,a]=Ue(n);return[{type:"LinksCard",card:e},a]},Ue=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new p("Expected links card title");let a=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(l=>l!==a);if(r.length===0)throw new p("Expected at least one link");let[t,i]=M(r,T),[o,s]=(()=>{try{return z(n)}catch{return[null,[]]}})();return o&&(o.daaLl=`${e.textContent??""} - ${o?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:t,footerCTA:o},[...i,...s]]};var Gn=n=>{let e=[...n.querySelectorAll("li > div")],a=[...n.querySelectorAll("li > a")],[r,t]=M(e,Ne),[i,o]=M(a,T);return[{type:"ProductList",categories:r,links:i},[...t,...o]]},Ne=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new p("Expected H2");let a=e.textContent??"",r=e.textContent??"",t=En(e),[i,o]=M(t,pn);return[{type:"ProductCategory",name:a,daaLl:r,links:i},o]};var On=n=>{let[e,a]=je(n);return[{type:"FeaturedCard",card:e},a]},je=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let a=n.querySelector("h4")||null,r=a?.nextElementSibling||null;if(!a)throw new p("Expected title");if(!r)throw new p("Expected subtitle");let t=r.nextElementSibling?.firstElementChild||null;if(!t)throw new p("Expected card link after subtitle");let[i,o]=T(t),[s,l]=z(n);return[{type:"Card",title:a.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...l,...o]]};var A={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Fn=n=>{let[e,a]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new p(A.MissingBackgroundImageSection);let t=e.querySelector(":scope picture:not(:scope p picture) img")??null;t===null&&r.add(new u(A.MissingBackgroundImage));let i=t?.getAttribute("alt")??"";i===""&&r.add(new u(A.MissingBackgroundImageAlt));let o=t?.getAttribute("src")??"";if(o===""&&r.add(new u(A.MissingBackgroundImageSrc)),a===void 0)throw new p(A.MissingContentSection);let s=a.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new u(A.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&r.add(new u(A.MissingIconSrc)),d===""&&r.add(new u(A.MissingIconAlt));let v=a.querySelector('p > a:not([href$=".svg"])')??null,x=v?.textContent?.trim()??"",c=v?.getAttribute("href")??"",g=c?Ln(c):!1;v===null&&r.add(new u(A.MissingPriceLink));let f=a.querySelector("p > strong")??null;if(f===null)throw new p(A.MissingTitleElement);let h=f?.textContent??"";h===""&&r.add(new u(A.MissingTitleText)),a.querySelector("em > a")===null&&r.add(new u(A.MissingSecondaryCtaAnchor));let[m,b]=(()=>{try{return z(n)}catch{return[null,[]]}})();return b.forEach(w=>r.add(w)),m&&(m.daaLl=`${h} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:o,iconAlt:d,iconSrc:l,title:h,cta:m,priceText:x,priceHref:c,isPriceMerchLink:g}},[...r]]};var Wn=n=>{let e=new Set;if(n===null)throw new p(Xn.elementNull);let a=n.querySelector("h2")?.textContent??"";a===""&&e.add(new u(Xn.noTitle));let r=(async()=>{try{let t=n.querySelector("a"),i=new URL(t?.href??""),o=await U(i);if(o instanceof p)throw new Error(o.message);let s=await Pn(o);if(s instanceof p)throw new Error(s.message);return Mn(i.href,s),n.classList.contains("product-list")?Gn(s):Be(s)}catch(t){throw new p(t?.message)}})();if(r instanceof p)throw r;return[{type:"MegaMenu",title:a,content:r},[...e]]},Xn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=n=>{let e=[...n.children];if(e.length===0)throw new p("No mega menu items found (did you forget to add them correctly?)");let[a,r]=M(e,t=>qe(t));if(a.length===0)throw new p("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:a},r]},qe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new p("Column contains no cards (did you forget to label them correctly?)");let[a,r]=M(e,t=>Ge(t));if(a.length===0)throw new p("Failed to parse cards in column");return[{type:"GnavColumn",cards:a},r]},Ge=n=>{if(n.classList.contains("featured-card"))return On(n);if(n.classList.contains("links-card"))return qn(n);if(n.classList.contains("promo-card"))return Fn(n);throw new p("Unsupported gnav cards section")};var Zn=({card:n},e)=>Oe(n,e),Oe=({title:n,subtitle:e,eyeBrow:a,footerCTA:r,bodyLink:t},i)=>{let o=`featured-eyebrow-${E(a)}`;return`
  <div class="featured-card" tabindex="0" aria-label="${a} ${i}" ${k(a,"")} role="group">
    <div>
      <div id="${o}" class="featured-eyebrow">${a}</div>
      <h4>${n}</h4>
      <div class="featured-subtitle">${e}</div>
      <span>${q({...t,ariaAttrs:{"aria-describedby":o},svgIcon:I.chevronRight})}</span>
    </div>
    <div class="footer-container">
      ${$({...r,ariaAttrs:{"aria-describedby":o}})}
    </div>
  </div>
`.trim()};var Kn=({card:n})=>Fe(n),Fe=({title:n,links:e,footerCTA:a})=>`
  <article class="links-card" ${k(n,"")}>
    <div>
      <p id="links-card-${E(n)}" class="links-card-title" role="heading" aria-level="2">${n}</p>
      <ul class="links-card-links" aria-labelledby="links-card-${E(n)}">
        ${e.map(r=>`<li>${q(r)}</li>`).join("")}
      </ul>
    </div>
    ${a===null?"":`
    <div class="links-card-footer">
      ${$({...a,ariaAttrs:{"aria-describedby":`links-card-${E(n)}`}})}
    </div>`}
  </article>
  ...
  <article class="promo-card" daa-lh="promo-card">
    ...
    <div class="promo-card__content">
      ...
      <div class="promo-card__text-content">
        ${s&&l?`<p id="price-${E(t)}" class="promo-card__price">
          <a href="${S(s)}" class="merch">${o}</a>
        </p>`:""}
        <p id="title-${E(t)}" class="promo-card__title" role="heading" aria-level="2">
          ${t}
        </p>
        ${i===null?"":`<div class="promo-card__cta">
                 ${$({...i,ariaAttrs:{"aria-describedby":`title-${E(t)}${l?` price-${E(t)}`:""}`}})}
               </div>`}
      </div>
    </div>
  </article>
`.trim();var We=(n,e)=>{switch(n.type){case"FeaturedCard":return Zn(n,e);case"LinksCard":return Kn(n);case"PromoCard":return Vn(n);default:}return""},Yn=({sections:n},e)=>`
  <div class="feds-gnav-cards">
    ${n.map(a=>`<li>${a.cards.map(r=>We(r,e)).join("")}</li>`).join("")}
  </div>
`;var Jn=({categories:n,links:e})=>{let a=V(),r=`
    <ul class="tabs" role="tablist" aria-orientation="vertical">
      ${n.map(Ze).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${S(e[e.length-1].href)}"${k(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${I.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
  ...
  <div id="${E(n)}" popover class="feds-popup">
  </div>
`,ne=(n,e,a)=>{let r=`
        <button
          type="button"
  ...
  `,t=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,i=`
    <div class="feds-popup-header">
      ...
      ${t?`<div class="product-links"><a class="feds-link" href="${S(t.href)}"${k(null,t.daaLl??t.text)}>${t.text}${I.chevronRight}</a></div>`:""}
    </div>
  `.trim(),o="";switch(n.type){case"ProductList":o=Jn(n);break;case"GnavCards":o=Yn(n,a);break;default:}return`${i}${o}`};var ee={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ae=n=>{if(n===null)return[{type:"Text",content:""},[new u(ee.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new u(ee.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var re=({content:n})=>n;var te=n=>{if(n===null)throw new p(Ke.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return gn(e);let a=n.querySelector(".large-menu");return a!==null?Wn(a):n.querySelector("strong")!==null?hn(n):n.querySelector("em")!==null?z(n):n.querySelector("a")===null?ae(n):T(n.querySelector("a"))},yn=(n,e)=>{switch(n.type){case"Text":return re(n);case"Link":return q(n);case"SecondaryCTA":return $(n);case"PrimaryCTA":return bn(n);case"Brand":return fn(n);case"MegaMenu":return Qn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ke={elementNull:"Element is null"};var oe=(n,e)=>{let[a,r]=M([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],T),[t,i]=M([...n.children],te),o=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return jn(o)}catch{return[null,[]]}})(),d=!1,v=[r,i,l].flat();return{breadcrumbs:a,components:t,productCTA:s,localnav:d,errors:v,unavEnabled:e}};var ie=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],a=[...n.querySelectorAll(".tab-content ul")],r=e.map((t,i)=>()=>{let o=a[i].closest(":popover-open");if(e.forEach(d=>{d.setAttribute("aria-selected","false")}),a.forEach(d=>{d.setAttribute("hidden","true")}),a[i]?.removeAttribute("hidden"),t.setAttribute("aria-selected","true"),!o||!_.matches)return;let s=se();if(!s)return;let l=o?.clientHeight??0;s.style.height=`${l+72}px`});return e.forEach((t,i)=>{t.addEventListener("click",r[i])}),Ve(n),()=>{e.forEach((t,i)=>{t.removeEventListener("click",r[i])})}},se=()=>[...document.adoptedStyleSheets.flatMap(n=>[...n.cssRules])].find(n=>n?.selectorText==="header.global-navigation nav::after"),Ve=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],a=n.querySelector(".feds-gnav-items"),r=se(),t=new ResizeObserver(i=>{if(i.length<1)return;let o=n.querySelector(".feds-popup:popover-open");if(!o){r.style.height="100%";return}let l=o.clientHeight<1?"100%":`${o.clientHeight+72}px`;r.style.height=l});e.forEach(i=>{if(!r)return;let o=i.nextElementSibling;o&&(t.observe(o),o.addEventListener("toggle",s=>{if(s.newState!=="open"&&!n.querySelector(".feds-popup:popover-open")){if(r.style.height="100%",_.matches)return;a?.classList.remove("subscreen-opening"),a?.classList.add("subscreen-closing")}else r.style.height=`${o.clientHeight+72}px`}))}),e.forEach(i=>{i.addEventListener("click",()=>{if(_.matches||!a)return;let o=i.nextElementSibling;o&&(a.classList.remove("subscreen-closing"),a.classList.add("subscreen-opening"),o.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{a.classList.remove("subscreen-opening"),a.classList.add("subscreen-closing"),setTimeout(()=>o.hidePopover(),240)}))})}),_.addEventListener("change",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{a?.classList.remove("subscreen-opening"),a?.classList.remove("subscreen-closing")})};var le=async n=>{let e=new Set,a=n.querySelectorAll("a.merch");if(a.length===0)return e;try{let r=C(),{base:t}=r;if(!t)return e.add(new u("base not found in config, cannot initialize merch links")),e;let i=await import(`${t}/blocks/merch/merch.js`),{default:o}=i;if(!o)return e.add(new u("decorateMerchLink not found in merch module")),e;a.forEach(s=>{o(s)})}catch(r){e.add(new u(`Error initializing merch links: ${r}`))}return e};var de=async({gnavSource:n,asideSource:e})=>{let a=await U(n);if(a instanceof p)return a;let r=await U(e);return{mainNav:a,aside:r}};var pe=new CSSStyleSheet;pe.replaceSync(String.raw`/**
...
`);document.adoptedStyleSheets=[...document.adoptedStyleSheets,pe];var Lo=async n=>{let{gnavSource:e,mountpoint:a,unavEnabled:r,miloConfig:t,personalization:i}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new p("gnavSource needs to be a URL object");try{dn(t)}catch(v){throw L(`Failed to initialize MiloConfig: ${v}`),new p(`Failed to initialize MiloConfig: ${v}`)}Sn(i),Tn(n.localizeLink??(v=>v)),kn(xn(n));let o=await de(n);if(o instanceof p)throw L(o.message),o;let{mainNav:s,aside:l}=o;if(s instanceof p)throw L(s.message),s;let d=oe(s,r);if(d instanceof p)throw L(d.message),d;return await Ye(d)(a),Qe(n)},Ye=n=>async e=>{let a=Je(n);document.querySelector("main")?.setAttribute("id","main-content"),e.innerHTML=a,e.classList.add("site-pivot"),e.querySelector("nav")?.showPopover();let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let t=n.components.filter(s=>s.type==="MegaMenu"),i=t.map(s=>s.content),o=await Promise.all(i.map(async(s,l)=>{try{let[d,v]=await s,x=t[l].title;return r[l].innerHTML=ne(d,r[l].id,x),v}catch(d){return[d]}}).flat());return e},Je=({components:n,productCTA:e,unavEnabled:a})=>`
<nav popover="manual" data-lenis-prevent>
  <a href="#main-content" class="feds-skip-link">${V().get("skip-to-main")??"Skip to main content"}</a>
  <ul>
    ${(()=>{let t=n.find(d=>d.type==="Brand")??null,i=n.filter(d=>d.type!=="Brand"),o=`
      ...
      `.trim(),s=t?yn(t):"",l=An(i,yn);return`
...
`,Qe=async n=>{let e=new Set,a=await tn(n.mountpoint);a instanceof u?(e.add(a),L(a.message)):a.errors.forEach(o=>e.add(o)),ie(n.mountpoint),vn(n.mountpoint),na(n.mountpoint),ea(n.mountpoint),aa(n.mountpoint),ta(n.mountpoint),ia(n.mountpoint),oa(n.mountpoint,n.mepMartech??"");let r=()=>{document.querySelector("nav[popover]")?.removeAttribute("popover"),F(n.mountpoint)};document.querySelector(".dialog-modal")&&r(),document.addEventListener("click",o=>{o.target instanceof Element&&o.target.closest('a[href*="#openPrivacy"]')&&r()}),window.addEventListener("milo:modal:loaded",r),window.addEventListener("milo:modal:closed",()=>{let o=document.querySelector("nav");o?.setAttribute("popover","manual"),o?.showPopover?.()}),(await le(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let i=a instanceof u?()=>{}:a.reloadUnav;return{closeEverything:ra,reloadUnav:i,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},na=n=>{let e=n.querySelector("#feds-menu-wrapper"),a=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let t=e.matches(":popover-open");a?.setAttribute("aria-expanded",String(t)),a?.setAttribute("daa-ll",t?"hamburgermenu|close":"hamburgermenu|open"),t&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(t=>{t.addEventListener("toggle",()=>{let i=n.querySelector(`[popovertarget="${t.id}"]`),o=t.matches(":popover-open");i?.setAttribute("aria-expanded",String(o)),i?.setAttribute("daa-ll",o?"header|Close":"header|Open")})})},ea=n=>{_.addEventListener("change",()=>{F(n)})},aa=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>F(n)),e.addEventListener("keydown",a=>{a.key==="Enter"&&F(n)})})};var ra=()=>{},ta=n=>{let e=n.closest("header");if(!e)return;let a=n.querySelector("#feds-menu-wrapper"),r=()=>a?.matches(":popover-open")??!1,t=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(t()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),a?.addEventListener("toggle",i)},oa=(n,e)=>{let a=n.closest("header");a!==null&&a.setAttribute("daa-lh",`gnav|${In()}${e}`)},ia=n=>{n.querySelector(".feds-skip-link")?.addEventListener("click",a=>{let r=document.querySelector("#main-content");r instanceof HTMLElement&&(a.preventDefault(),r.hasAttribute("tabindex")||r.setAttribute("tabindex","-1"),setTimeout(()=>{r.focus(),r.scrollIntoView({behavior:"smooth",block:"start"})},100))})};export{Lo as main,Qe as postRenderingTasks,Ye as renderGnav,Je as renderGnavString};
