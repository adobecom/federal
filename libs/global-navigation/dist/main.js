...
`};var X={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},z=/(\.png|\.jpg|\.jpeg|\.svg)/i,Me=n=>{let e=n.querySelector("picture img")?.getAttribute("src")??null;if(e!==null&&e!=="")return e;let r=n.textContent?.trim();if(r!==void 0&&r!==""&&z.test(r)){let a=r.split("|")[0]?.trim();if(a!==void 0&&a!=="")return a}let t=n.getAttribute("href");return t!==null&&t!==""&&z.test(t)?t:null},Pe=n=>{let e=n.textContent?.trim();if(e?.includes("|")===!0){let t=e.split("|")[1]?.trim();if(t)return t}return n.querySelector("img")?.getAttribute("alt")??""},fn=n=>{if(n===null)throw new l(X.elementNull);let e=n.querySelector(".gnav-brand");if(e===null)throw new l(X.elementNull);let r=[...e.querySelectorAll("a")];if(r.length===0)throw new l(X.noLinks);let t=r.find(m=>{let h=m.textContent??"";return!z.test(m.href)&&!z.test(h)});if(!t)throw new l(X.noPrimaryLink);let a=e.matches(".brand-image-only"),o=e.matches(".no-logo"),i=e.matches(".image-only"),s=!o,d=!a&&!i,p=r.filter(m=>{let h=m.textContent??"";return z.test(m.href)||z.test(h)}),[y,w,g]=(()=>{let m=a?S.brand:S.company,[h=null,x=null]=[...e.querySelectorAll('picture img[src$=".svg"]')].map(an=>an?.src).filter(an=>an?.length>0),[I=null,W=null]=p.map(Me),ce=p[0]instanceof Element?Pe(p[0]):t.textContent?.trim()??"";return[I??h??m,W??x,ce]})(),c=t.textContent?.trim()??"",f=t.href;if(!s&&!d)return[{type:"Brand",data:{type:"NoRender"}},[]];let v=(m,h)=>{let x=h!=null&&h!=="";return $n()&&x?h:m},b=y.startsWith("<svg")?{type:"inline-svg",svgContent:v(y,w),alt:g}:{type:"image",src:v(y,w),alt:g};return s&&d?[{type:"Brand",data:{type:"LabelledBrand",href:f,label:c,image:b}},[]]:s&&a?[{type:"Brand",data:{type:"BrandImageOnly",href:f,image:b,alt:g}},[]]:s&&i?[{type:"Brand",data:{type:"ImageOnlyBrand",href:f,image:b,alt:g}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:f,label:c}},[]]};var un=(n,e)=>{let r=`feds-brand-image${e?" brand-image-only":""}`;if(n.type==="inline-svg")return`<span class="${r}">${n.svgContent}</span>`;let t=n.alt?` alt="${n.alt}"`:"";return`<span class="${r}"><img src="${n.src}"${t} /></span>`},Te=`
<?xml
...
`,On=n=>n.type==="PrimaryCTA"?xn(n):A(n);var N=({text:n,href:e,daaLl:r})=>`<a class="feds-link" href="${e}"${L(null,r??n)}>${n}</a>`;var jn=n=>{let[e,r]=De(n);return[{type:"LinksCard",card:e},r]},De=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new l("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(d=>d!==r);if(t.length===0)throw new l("Expected at least one link");let[a,o]=M(t,E),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var Gn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=M(e,Be),[o,i]=M(r,E);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},Be=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new l("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Pn(e),[o,i]=M(a,pn);return[{type:"ProductCategory",name:r,daaLh:t,links:o},i]};var qn=n=>{let[e,r]=Oe(n);return[{type:"FeaturedCard",card:e},r]},Oe=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new l("Expected title");if(!t)throw new l("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new l("Expected card link after subtitle");let[o,i]=E(a),[s,d]=_(n);return s.daaLl=`${r.textContent??""} - ${s?.daaLl}`,[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...d,...i]]};var T={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Fn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new l(T.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new u(T.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new u(T.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new u(T.MissingBackgroundImageSrc)),r===void 0)throw new l(T.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new u(T.MissingIcon));let[d,p]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());d===""&&t.add(new u(T.MissingIconSrc)),p===""&&t.add(new u(T.MissingIconAlt));let y=r.querySelector('p > a:not([href$=".svg"])')??null,w=y?.textContent?.trim()??"",g=y?.getAttribute("href")??"",c=g?Mn(g):!1;y===null&&t.add(new u(T.MissingPriceLink));let f=r.querySelector("p > strong")??null;if(f===null)throw new l(T.MissingTitleElement);let v=f?.textContent??"";v===""&&t.add(new u(T.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new u(T.MissingSecondaryCtaAnchor));let[m,h]=(()=>{try{return _(n)}catch{return[null,[]]}})();return h.forEach(x=>t.add(x)),m&&(m.daaLl=`${v} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:p,iconSrc:d,title:v,cta:m,priceText:w,priceHref:g,isPriceMerchLink:c}},[...t]]};var Zn=n=>{let e=new Set;if(n===null)throw new l(Wn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new u(Wn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await H(o);if(i instanceof l)throw new Error(i.message);let s=await _n(i);if(s instanceof l)throw new Error(s.message);return Sn(o.href,s),n.classList.contains("product-list")?Gn(s):je(s)}catch(a){throw new l(a?.message)}})();if(t instanceof l)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Wn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},je=n=>{let e=[...n.children];if(e.length===0)throw new l("No mega menu items found (did you forget to add them correctly?)");let[r,t]=M(e,a=>Ge(a));if(r.length===0)throw new l("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Ge=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new l("Column contains no cards (did you forget to label them correctly?)");let[r,t]=M(e,a=>qe(a));if(r.length===0)throw new l("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},qe=n=>{if(n.classList.contains("featured-card"))return qn(n);if(n.classList.contains("links-card"))return jn(n);if(n.classList.contains("promo-card"))return Fn(n);throw new l("Unsupported gnav cards section")};var Kn=({card:n})=>Fe(n),Fe=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
...
`.trim();var Xn=({card:n})=>Ze(n),Ze=({bgImageAlt:n,bgImageSrc:e,iconAlt:r,iconSrc:t,title:a,cta:o,priceText:i,priceHref:s,isPriceMerchLink:d})=>`
