...
`};var V={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},z=/(\.png|\.jpg|\.jpeg|\.svg)/i,Ee=n=>{let e=n.querySelector("picture img")?.getAttribute("src")??null;if(e!==null&&e!=="")return e;let r=n.textContent?.trim();if(r!==void 0&&r!==""&&z.test(r)){let a=r.split("|")[0]?.trim();if(a!==void 0&&a!=="")return a}let t=n.getAttribute("href");return t!==null&&t!==""&&z.test(t)?t:null},Me=n=>{let e=n.textContent?.trim();if(e?.includes("|")===!0){let t=e.split("|")[1]?.trim();if(t)return t}return n.querySelector("img")?.getAttribute("alt")??""},gn=n=>{if(n===null)throw new c(V.elementNull);let e=n.querySelector(".gnav-brand");if(e===null)throw new c(V.elementNull);let r=[...e.querySelectorAll("a")];if(r.length===0)throw new c(V.noLinks);let t=r.find(m=>{let h=m.textContent??"";return!z.test(m.href)&&!z.test(h)});if(!t)throw new c(V.noPrimaryLink);let a=e.matches(".brand-image-only"),o=e.matches(".no-logo"),i=e.matches(".image-only"),s=!o,l=!a&&!i,d=r.filter(m=>{let h=m.textContent??"";return z.test(m.href)||z.test(h)}),[y,w,p]=(()=>{let m=a?S.brand:S.company,[h=null,x=null]=[...e.querySelectorAll('picture img[src$=".svg"]')].map(tn=>tn?.src).filter(tn=>tn?.length>0),[I=null,W=null]=d.map(Ee),ce=d[0]instanceof Element?Me(d[0]):t.textContent?.trim()??"";return[I??h??m,W??x,ce]})(),g=t.textContent?.trim()??"",f=t.href;if(!s&&!l)return[{type:"Brand",data:{type:"NoRender"}},[]];let v=(m,h)=>{let x=h!=null&&h!=="";return An()&&x?h:m},b=y.startsWith("<svg")?{type:"inline-svg",svgContent:v(y,w),alt:p}:{type:"image",src:v(y,w),alt:p};return s&&l?[{type:"Brand",data:{type:"LabelledBrand",href:f,label:g,image:b}},[]]:s&&a?[{type:"Brand",data:{type:"BrandImageOnly",href:f,image:b,alt:p}},[]]:s&&i?[{type:"Brand",data:{type:"ImageOnlyBrand",href:f,image:b,alt:p}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:f,label:g}},[]]};var fn=(n,e)=>{let r=`feds-brand-image${e?" brand-image-only":""}`;if(n.type==="inline-svg")return`<span class="${r}">${n.svgContent}</span>`;let t=n.alt?` alt="${n.alt}"`:"";return`<span class="${r}"><img src="${n.src}"${t} /></span>`},Te=`
<?xml
...
`,Dn=n=>n.type==="PrimaryCTA"?yn(n):A(n);var G=({text:n,href:e,daaLl:r})=>`<a class="feds-link" href="${e}"${C(null,r??n)}>${n}</a>`;var Bn=n=>{let[e,r]=Ge(n);return[{type:"LinksCard",card:e},r]},Ge=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new c("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new c("Expected at least one link");let[a,o]=M(t,E),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var On=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=M(e,Ne),[o,i]=M(r,E);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},Ne=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new c("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Mn(e),[o,i]=M(a,dn);return[{type:"ProductCategory",name:r,daaLh:t,links:o},i]};var jn=n=>{let[e,r]=De(n);return[{type:"FeaturedCard",card:e},r]},De=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new c("Expected title");if(!t)throw new c("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new c("Expected card link after subtitle");let[o,i]=E(a),[s,l]=_(n);return s.daaLl=`${r.textContent??""} - ${s?.daaLl}`,[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var T={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},qn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new c(T.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new u(T.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new u(T.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new u(T.MissingBackgroundImageSrc)),r===void 0)throw new c(T.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new u(T.MissingIcon));let[l,d]=(s?.textContent?.split("|")??["",""]).map(x=>x.trim());l===""&&t.add(new u(T.MissingIconSrc)),d===""&&t.add(new u(T.MissingIconAlt));let y=r.querySelector('p > a:not([href$=".svg"])')??null,w=y?.textContent?.trim()??"",p=y?.getAttribute("href")??"",g=p?En(p):!1;y===null&&t.add(new u(T.MissingPriceLink));let f=r.querySelector("p > strong")??null;if(f===null)throw new c(T.MissingTitleElement);let v=f?.textContent??"";v===""&&t.add(new u(T.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new u(T.MissingSecondaryCtaAnchor));let[m,h]=(()=>{try{return _(n)}catch{return[null,[]]}})();return h.forEach(x=>t.add(x)),m&&(m.daaLl=`${v} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:d,iconSrc:l,title:v,cta:m,priceText:w,priceHref:p,isPriceMerchLink:g}},[...t]]};var Wn=n=>{let e=new Set;if(n===null)throw new c(Fn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new u(Fn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await H(o);if(i instanceof c)throw new Error(i.message);let s=await Pn(i);if(s instanceof c)throw new Error(s.message);return Sn(o.href,s),n.classList.contains("product-list")?On(s):Be(s)}catch(a){throw new c(a?.message)}})();if(t instanceof c)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Fn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Be=n=>{let e=[...n.children];if(e.length===0)throw new c("No mega menu items found (did you forget to add them correctly?)");let[r,t]=M(e,a=>Oe(a));if(r.length===0)throw new c("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Oe=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new c("Column contains no cards (did you forget to label them correctly?)");let[r,t]=M(e,a=>je(a));if(r.length===0)throw new c("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},je=n=>{if(n.classList.contains("featured-card"))return jn(n);if(n.classList.contains("links-card"))return Bn(n);if(n.classList.contains("promo-card"))return qn(n);throw new c("Unsupported gnav cards section")};var Zn=({card:n})=>qe(n),qe=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
...
`,le=document.createElement("style");le.textContent=Xe;document.head.appendChild(le);var uo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new c("gnavSource needs to be a URL object");try{cn(a)}catch(y){throw L(`Failed to initialize MiloConfig: ${y}`),new c(`Failed to initialize MiloConfig: ${y}`)}Tn(o),Ln(wn(n));let i=await se(n);if(i instanceof c)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof c)throw L(s.message),s;let d=ae(s,t);if(d instanceof c)throw L(d.message),d;return await Je(d)(r),Qe(n)},Je=n=>async e=>{let r=Ye(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[d,y]=await s,w=a[l].title;return t[l].innerHTML=Qn(d,t[l].id,w),y}).flat());return e},Ye=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
