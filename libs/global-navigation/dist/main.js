var Cn=async n=>{let{placeholders:e}=n,{locale:r}=k(),a=`${W()}${r.prefix}/federal/globalnav/placeholders.json`,[o,i]=await Promise.all([e,ge(a)]);return new Map([...i,...o])},ge=async n=>{try{let e=await fetch(n);if(!e.ok)throw new f(`Federal placeholders not found at ${n}`);let r=ue(await e.json());if(r instanceof f)throw r;return new Map(r.data.map(({key:t,value:a})=>[t,a]))}catch(e){if(e instanceof f)console.error(e.message);else{let r=new f(e.message);console.error(r.message)}return L(`Failed to fetch placeholders from ${n}`),new Map([])}},ue=n=>{try{let{data:e}=n;if(!e.every(({key:t,value:a})=>typeof t=="string"&&typeof a=="string"))throw new Error("data is not valid");return n}catch(e){return new f(e.message)}};function kn(n,e){let r=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return r.test(n)?n.replace(r,(a,o,i)=>{let s=o??i??"";return e.get(s)??s}):n}var[Ln,En]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var A=window.matchMedia("(min-width: 1024px)"),S={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},fe=["/tools/ost?","/miniplans"],Mn=n=>fe.some(e=>n.includes(e));var Pn=n=>{let e=[],r=n.nextElementSibling??null;for(;r!==null;)e.push(r),r=r.nextElementSibling??null;return e},q=n=>({eval:n,or:e=>q(r=>{try{return n(r)}catch{return e(r)}})}),M=(n,e)=>n.reduce(([r,t],a)=>{try{let[o,i]=e(a);return[[...r,o],[...t,...i]]}catch(o){return o instanceof d?[r,[o,...t]]:[r,t]}},[[],[]]),[Tn,me]=(()=>{let n,e=!1;return[r=>{e||(n=r,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),z=async n=>{try{if(n===null)return new d("URL is null");let e=sn(`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`),r=await fetch(e);if(!r.ok)return L(`Request for ${e} failed`),new d(`Request for ${e} failed`);let t=await r.text(),a=await En(),o=kn(t,a),{body:i}=new DOMParser().parseFromString(o,"text/html");try{let{handleCommands:s,commands:l}=me();s(l,i)}catch(s){L(`Personalization not applied: ${s?.message}`)}return i}catch(e){return new d(e?.message)}},H,W=()=>{if(H)return H;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(H)return H;let e=window.location.origin;H=n.some(a=>{let o=e.replace(".stage","");return a.startsWith("https://")?o===a:o.endsWith(a)})?e:"https://www.adobe.com";let t=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${t}.`))&&(H=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),H},sn=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${W()}${n}`;try{let{pathname:e,search:r,hash:t}=new URL(n);return`${W()}${e}${r}${t}`}catch(e){let r=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${r}`)}return n},Sn=(n,e)=>{let r=(t,a)=>{let o=`${t}[${a}^="./media_"]`;e.querySelectorAll(o).forEach(s=>{let l=s.getAttribute(a);if(!(l===null||l===""))try{let c=sn(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(a,c)}catch(c){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${t}`,c)}})};r("img","src"),r("source","srcset")},An=async n=>{let e=async(r,t)=>{if(r instanceof d)return r;try{let o=[...r.querySelectorAll('a[href*="#_inline"]')].map(async i=>{try{if(t.has(i.href))return;let s=sn(i.href),l=new URL(s),c=await z(l);if(t.add(i.href),c instanceof d)throw c;await e(c,t),i.replaceWith(...c.children);return}catch{return}},[]);return await Promise.all(o),r}catch(a){return new d(JSON.stringify(a))}};return e(n,new Set)},_n=(n,e)=>n.map((r,t)=>`<li>${e(r,t)}</li>`).join(""),Z=n=>n.toLowerCase().trim().replace(/[^a-z0-9]/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").replace(/^(\d)/,"id-$1"),C=(n,e)=>{let r=n!==null&&n!==""?` daa-lh="${n}"`:"",t=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${r}${t}`},$n=()=>!0;function ve(n,{id:e,as:r,callback:t,crossorigin:a,rel:o,fetchpriority:i}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return t?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",o),e!==void 0&&l.setAttribute("id",e),r!==void 0&&l.setAttribute("as",r),a!==void 0&&l.setAttribute("crossorigin",a),i!==void 0&&l.setAttribute("fetchpriority",i),l.setAttribute("href",n),t&&(l.onload=c=>t(c.type),l.onerror=c=>t(typeof c=="string"?"error":c.type)),document.head.appendChild(l),l}function he(n,e){return ve(n,{rel:"stylesheet",callback:e})}function ln(n,e=!1){e&&he(n)}var dn=(n,e,{mode:r,id:t}={})=>new Promise((a,o)=>{let i=document.querySelector(`head > script[src="${n}"]`);if(!i){let{head:c}=document;i=document.createElement("script"),i.setAttribute("src",n),t!=null&&i.setAttribute("id",t),e!=null&&i.setAttribute("type",e),r&&["async","defer"].includes(r)&&i.setAttribute(r,""),c.append(i)}let s=i.dataset.loaded;if(s!=null){a(i);return}let l=c=>{i.removeEventListener("load",l),i.removeEventListener("error",l),c.type==="error"?o(new Error(`error loading script: ${i.src}`)):c.type==="load"&&(i.dataset.loaded="true",a(i))};i.addEventListener("load",l),i.addEventListener("error",l)});function U(n,e=document){let r=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${r}="${n}"]`)?.content??null}var be=n=>{let e=n,r=o=>o==null||typeof o!="object";if(r(e)||r(e.locale)||typeof e.locale.prefix!="string"||r(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let o=e.unav;if(o.profile!==void 0){if(typeof o.profile!="object"||o.profile===null)return!1;let i=o.profile;if(i.signInCtaStyle!==void 0&&i.signInCtaStyle!=="primary"&&i.signInCtaStyle!=="secondary"||i.messageEventListener!==void 0&&typeof i.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[cn,k]=(()=>{let n,e=!1;return[r=>{if(!e){if(!be(r))throw new Error("MiloConfig validation failed: Invalid structure");n=r,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),ye={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},Rn={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function xe(n){let e=ye[n];return!e&&Rn[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var on="langstore/";function Hn(n){let r=(n?.prefix||"US_en").replace("/","")??"",[t="US",a="en"]=(Rn[r]??r).split("_",2);if(r.startsWith(on)||window.location.pathname.startsWith(`/${on}`)){let o=r.replace(on,"").toLowerCase();t=xe(o),a=o}return t=t.toUpperCase(),a=a.toLowerCase(),{language:a,country:t,locale:`${a}_${t}`}}var X=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()};function In(){let n=U("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var K={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},E=n=>{if(n===null)throw new d(K.elementNull);if(n.tagName!=="A")throw new d(K.notAnchor);let[e,r]=n?.textContent?.split("|").map(o=>o.trim())??["",""];if(e==="")throw new d(K.textContentNotFound);let t=n?.getAttribute("href")??"";if(t==="")throw new d(K.hrefNotFound);let a=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:t,daaLl:a,ariaLabel:r},[]]};var pn=n=>{if(!n)throw new d(P.elementNull);if(!n.classList.contains("product-card"))throw new d(P.notAProductCard);return q(Ce).or(we).or(ke).eval(n)},P={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},we=n=>{let e=new Set;if(!n)throw new d(P.elementNull);let r=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!r)throw new d(P.noTitleAnchor);let t=r.textContent??"";t===""&&e.add(new f(P.noTitle));let a=r.getAttribute("href")??"";a===""&&e.add(new f(P.noHref));let o=r.getAttribute("daa-ll"),i=r.getAttribute("daa-lh"),s=r?.closest("p")?.nextElementSibling;s||e.add(new f(P.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new f(P.noSubtitle));let c=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],b=Array.from(c).map(p=>{let u=p.querySelector("strong")!==null;return{text:p?.textContent?.trim()??"",isFilled:u}}),[x,g=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(p=>p.trim());return[{type:"ProductCardLink",iconHref:x,iconAlt:g,title:t,href:a,subtitle:l,badges:b,daaLl:o,daaLh:i},[...e]]},Ce=n=>{if(!n)throw new d(P.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new d(P.notAHeader);let r=n.querySelector("a")?.textContent??"",t=n.querySelector("a")?.getAttribute("daa-ll")??null,a=n.querySelector("a")?.getAttribute("daa-lh")??null;if(r==="")throw new d(P.noTitle);return[{type:"ProductCardHeader",title:r,classes:e,daaLl:t,daaLh:a},[]]},ke=n=>{if(!n)throw new d(P.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[r,t]=E(e),a=e?.getAttribute("daa-ll")??null,o=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:r,daaLl:a,daaLh:o},t]};var gn=n=>{switch(n.type){case"ProductCardHeader":return Le(n);case"ProductCardLink":return Ee(n);case"ProductCardBlue":return Me(n);default:return console.error(n),""}},Le=({title:n,classes:e,daaLl:r,daaLh:t})=>{let a=e.slice(1).map(i=>`feds-product-card--${i}`).join(" "),o=C(t,r??n);return`
    <div role="heading" class="feds-product-card ${a}"${o}>
      <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n}</div>
      </div>
    </div>
  `},Ee=({iconHref:n,iconAlt:e,title:r,href:t,subtitle:a,badges:o=[],daaLl:i,daaLh:s})=>{let l=e!==null&&n!==null,c=C(s,i??r),b=l?`
  ...
  `},Me=({link:n,daaLl:e,daaLh:r})=>{let t=C(r,e??n.text);return`
  <a href="${n.href}" class="feds-product-card feds-product-card--blue"${t}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var V={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},N=/(\.png|\.jpg|\.jpeg|\.svg)/i,Pe=n=>{let e=n.querySelector("picture img")?.getAttribute("src")??null;if(e!==null&&e!=="")return e;let r=n.textContent?.trim();if(r!==void 0&&r!==""&&N.test(r)){let a=r.split("|")[0]?.trim();if(a!==void 0&&a!=="")return a}let t=n.getAttribute("href");return t!==null&&t!==""&&N.test(t)?t:null},Te=n=>{let e=n.textContent?.trim();if(e?.includes("|")===!0){let t=e.split("|")[1]?.trim();if(t)return t}return n.querySelector("img")?.getAttribute("alt")??""},un=n=>{if(n===null)throw new d(V.elementNull);let e=n.querySelector(".gnav-brand");if(e===null)throw new d(V.elementNull);let r=[...e.querySelectorAll("a")];if(r.length===0)throw new d(V.noLinks);let t=r.find(m=>{let h=m.textContent??"";return!N.test(m.href)&&!N.test(h)});if(!t)throw new d(V.noPrimaryLink);let a=e.matches(".brand-image-only"),o=e.matches(".no-logo"),i=e.matches(".image-only"),s=!o,l=!a&&!i,c=r.filter(m=>{let h=m.textContent??"";return N.test(m.href)||N.test(h)}),[b,x,g]=(()=>{let m=a?S.brand:S.company,[h=null,w=null]=[...e.querySelectorAll('picture img[src$=".svg"]')].map(an=>an?.src).filter(an=>an?.length>0),[I=null,F=null]=c.map(Pe),pe=c[0]instanceof Element?Te(c[0]):t.textContent?.trim()??"";return[I??h??m,F??w,pe]})(),p=t.textContent?.trim()??"",u=t.href;if(!s&&!l)return[{type:"Brand",data:{type:"NoRender"}},[]];let v=(m,h)=>{let w=h!=null&&h!=="";return $n()&&w?h:m},y=b.startsWith("<svg")?{type:"inline-svg",svgContent:v(b,x),alt:g}:{type:"image",src:v(b,x),alt:g};return s&&l?[{type:"Brand",data:{type:"LabelledBrand",href:u,label:p,image:y}},[]]:s&&a?[{type:"Brand",data:{type:"BrandImageOnly",href:u,image:y,alt:g}},[]]:s&&i?[{type:"Brand",data:{type:"ImageOnlyBrand",href:u,image:y,alt:g}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:u,label:p}},[]]};var fn=(n,e)=>{let r=`feds-brand-image${e?" brand-image-only":""}`;if(n.type==="inline-svg")return`<span class="${r}">${n.svgContent}</span>`;let t=n.alt?` alt="${n.alt}"`:"";return`<span class="${r}"><img src="${n.src}"${t} /></span>`},Se=`
<?xml
...
`.trim(),Y=(n,e,r="")=>`<div class="feds-brand-container">
  ...
  </div>`.trim(),mn=n=>{let{data:e}=n;switch(e.type){case"LabelledBrand":return Y(e.href,fn(e.image,!1)+`<span class="feds-brand-label">${e.label}</span>`);case"BrandImageOnly":{let r=e.alt?` aria-label="${e.alt}"`:"";return Y(e.href,fn(e.image,!0),r)}case"ImageOnlyBrand":{let r=e.alt?` aria-label="${e.alt}"`:"";return Y(e.href,fn(e.image,!1),r)}case"BrandLabelOnly":return Y(e.href,`<span class="feds-brand-label">${e.label}</span>`);case"NoRender":return"";default:return""}};var vn=["appswitcher","help"],J={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[O,zn]=(()=>{let n,e,r,t=new Promise(a=>{e=a,r=setTimeout(()=>{n={},a(n)},5e3)});return[a=>{a&&!n&&(n=a,clearTimeout(r),e?.(n))},()=>t]})();function Q(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(c=>c!=="cart"))??[],l=s.length??3;if(e){let c=s.filter(x=>vn.includes(x)).length;return`calc(92px + ${c*32}px + ${c*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var nn=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[t,a]=e.split("_").reverse();return`${t.toLowerCase()}_${a.toUpperCase()}`}if(e==="uk")return"en_GB";let r=Object.keys(J).find(t=>J[t].includes(e));return r?`${r.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},_e={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},en=()=>{let n=navigator.userAgent;for(let[e,r]of Object.entries(_e))if(n.includes(e))return r;return"linux"},rn=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var Un=()=>{try{return k().signInContext||{}}catch{return{}}},$e=()=>{let n=k();return U("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Re=()=>{let e=k()?.unav?.profile?.messageEventListener;return e||(r=>{let{name:t,payload:a,executeDefaultAction:o}=r.detail;if(!(!t||t!=="System"||!a||typeof o!="function"))switch(a.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(i=>{O(i)}).catch(()=>{O({})});break;case"SignOut":o();break;case"ProfileSwitch":Promise.resolve(o()).then(i=>{i&&window.location.reload()});break;default:break}})};function He(){let{unav:n}=k();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var j=()=>{let n=k();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Re()},signInCtaStyle:$e(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn(Un())},onSignUp:()=>{window.adobeIMS?.signIn(Un())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:He()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Nn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},tn=async(n,e)=>{try{let r=n.querySelector(".feds-utilities");if(!(r instanceof HTMLElement))return new f('missing ".feds-utilities" container');let t=new Set,a=document.head.querySelector('meta[name="universal-nav"]'),o=a instanceof HTMLMetaElement?a.content??"":"";a instanceof HTMLMetaElement||t.add(new f('metadata "universal-nav" is missing'));let i=o.trim();a instanceof HTMLMetaElement&&i.length===0&&t.add(new f('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=i.split(",").map(m=>m.trim()).filter(m=>Object.keys(j()).includes(m)||m==="signup");if(s){let m=Q(l,s);r.style.setProperty("min-width",m)}let c;try{c=k()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let b=nn(c.locale),x=c.env.name==="prod"?"prod":"stage",g=await rn(),p=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(p??"")||(p="1.5"),await Promise.all([dn(`https://${x}.adobeccstatic.com/unav/${p}/UniversalNav.js`),ln(`https://${x}.adobeccstatic.com/unav/${p}/UniversalNav.css`,!0)]);let u=()=>{let m=j(),h=[m.profile];return Nn(h,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){Nn(h,!0);return}let I=m[w];I&&h.push(I)}),h},v=()=>({target:r,env:x,locale:b,countryCode:Hn(c?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:en(),os_version:navigator.platform},event:{visitor_guid:g}},children:u(),isSectionDividerRequired:!!c?.unav?.showSectionDivider,showTrayExperience:!A.matches});await window?.UniversalNav?.(v()),s||r?.style.removeProperty("min-width");let y=m=>{window?.UniversalNav?.reload(v())};return A.addEventListener("change",()=>{y()}),{reloadUnav:y,errors:t}}catch(r){let t=r instanceof Error?r.message:"failed to load universal nav";return new f(t)}};function R(n,e){return[...n.querySelectorAll(e)]}function G(n,e,r){R(n,e).forEach(t=>r?t.removeAttribute("tabindex"):t.setAttribute("tabindex","-1"))}var D={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Dn=new Set(["ArrowLeft","ArrowRight"]),Ie=new Set(["ArrowUp","ArrowDown"]),ze='.tabs [role="tab"][aria-selected="true"]';function hn(n,e,r){return(n+e+r)%r}function Ue(n,e,r,t){let a=D[r];if(Dn.has(r)){let p=e+a;return p>=0&&p<n.length?p:null}let o=getComputedStyle(t).gridTemplateColumns.split(" ").length,i=[...t.children],s=p=>{let u=n[p].parentElement;return u?i.indexOf(u):-1},l=s(e)%o,c=Math.floor(s(e)/o)+(r==="ArrowDown"?1:-1),b=Math.floor((i.length-1)/o);if(c<0||c>b)return null;let x=null,g=1/0;for(let p=0;p<n.length;p++){let u=Math.abs(s(p)%o-l);Math.floor(s(p)/o)===c&&u<g&&(g=u,x=p)}return x}function bn(n){G(n,'.tab-content [role="tabpanel"] a',!1);let e=[];R(n,".feds-popup[popover]").forEach(g=>{let p=()=>{g.matches(":popover-open")||G(g,'[role="tabpanel"] a',!1)};g.addEventListener("toggle",p),e.push(()=>g.removeEventListener("toggle",p))});let r=(g,p)=>{g.focus(),p.preventDefault()},t=()=>n.querySelector(".feds-popup:popover-open"),a=g=>g.querySelector(ze),o=g=>g.querySelector('[role="tabpanel"]:not([hidden])');function i(g){let p=t(),u=n.querySelector("#feds-menu-wrapper");if(!u)return!1;let v=p??(u?.matches(":popover-open")?u:null);if(!v)return!1;v.hidePopover?.();let y=p?`[popovertarget="${v.id}"]`:".feds-nav-toggle";return n.querySelector(y)?.focus(),g.preventDefault(),!0}function s(g,p,u){if(!Dn.has(p))return!1;let v=R(n,".feds-gnav-items > li > .feds-link"),y=v.indexOf(g);return y<0?!1:(r(v[hn(y,D[p],v.length)],u),!0)}function l(g,p,u,v){let y=R(p,'.tabs :is([role="tab"], .product-links a)'),m=y.indexOf(g);if(m<0)return!1;if(D[u]){let h=y[hn(m,D[u],y.length)];return h.matches('[role="tab"]')&&h.click(),r(h,v),!0}if(u==="Tab"&&!v.shiftKey&&g.matches('[aria-selected="true"]')){let h=o(p);if(!h)return!1;G(h,"a",!0);let w=h.querySelector("a");return w&&r(w,v),!0}return!1}function c(g,p,u,v){let y=o(p);if(!y)return!1;let m=R(y,"a"),h=m.indexOf(g);if(h<0)return!1;if(D[u]){let w=Ue(m,h,u,y);return w!==null?(r(m[w],v),!0):u==="ArrowUp"?(G(y,"a",!1),r(a(p)??m[0],v),!0):!1}if(u==="Tab"&&!v.shiftKey){if(h+1<m.length)r(m[h+1],v);else{let w=R(p,'.tabs [role="tab"]'),I=a(p),F=w[w.indexOf(I)+1]??p.querySelector(".product-links a");if(F)r(F,v);else return!1}return!0}if(u==="Tab"&&v.shiftKey){if(h>0)r(m[h-1],v);else{G(y,"a",!1);let w=a(p)??R(p,'.tabs :is([role="tab"], .product-links a)')[0];w&&r(w,v)}return!0}return!1}function b(g,p,u,v){if(!Ie.has(u))return!1;let y=R(p,".feds-gnav-cards a"),m=y.indexOf(g);return m<0?!1:(r(y[hn(m,D[u],y.length)],v),!0)}function x(g){let p=document.activeElement??g.target;if(g.key==="Escape"){i(g);return}let u=t();u&&(u.matches(":has(.product-list)")&&(l(p,u,g.key,g)||c(p,u,g.key,g))||u.matches(":has(.feds-gnav-cards)")&&b(p,u,g.key,g))||s(p,g.key,g)}return n.addEventListener("keydown",x),e.push(()=>n.removeEventListener("keydown",x)),()=>e.forEach(g=>g())}var Ne="feds-milo",L=(n,e="default",r="e")=>{let{locale:t}=k(),a=U("gnav-source")??`${t.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${a} | href: ${window.location.href}`,{clientId:Ne,sampleRate:1,tags:e,errorType:r})};var d=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},f=class n extends Error{constructor(e,r="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),r==="Critical"&&L(e)}};var Bn=n=>e=>{if(e===null)throw new Error("");let r=e.querySelector(De(n));if(!r)throw new Error("");let t=r.textContent??"",[a="",o=""]=t.split("|").map(x=>x.trim());if(a==="")throw new Error("");let i=r.getAttribute("href")??"";if(i==="")throw new Error("");let s=r.getAttribute("daa-ll"),l=r.getAttribute("aria-label")?.trim()??"",c=l!==""?l:o!==""?o:void 0,b=[];return[{type:n.type,text:a,href:i,ariaLabel:c,daaLl:typeof s=="string"&&s.trim()!==""?s:a},b]},yn=Bn({type:"PrimaryCTA"}),_=Bn({type:"SecondaryCTA"}),qn=n=>q(yn).or(_).eval(n),De=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var xn=({text:n,href:e,daaLl:r,ariaLabel:t})=>`
<a href="${e}"
...
`,$=({text:n,href:e,daaLl:r,ariaLabel:t})=>`
<a href="${e}" 
...
`,On=n=>n.type==="PrimaryCTA"?xn(n):$(n);var B=({text:n,href:e,daaLl:r})=>`<a class="feds-link" href="${e}"${C(null,r??n)}>${n}</a>`;var jn=n=>{let[e,r]=Be(n);return[{type:"LinksCard",card:e},r]},Be=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new d("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new d("Expected at least one link");let[a,o]=M(t,E),[i,s]=(()=>{try{return _(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var Gn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=M(e,qe),[o,i]=M(r,E);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},qe=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new d("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Pn(e),[o,i]=M(a,pn);return[{type:"ProductCategory",name:r,daaLl:t,links:o},i]};var Fn=n=>{let[e,r]=Oe(n);return[{type:"FeaturedCard",card:e},r]},Oe=n=>{let e=n.querySelector("h5")||null;if(!e)throw new f("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new d("Expected title");if(!t)throw new d("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new d("Expected card link after subtitle");let[o,i]=E(a),[s,l]=_(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var T={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},Wn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new d(T.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new f(T.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new f(T.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new f(T.MissingBackgroundImageSrc)),r===void 0)throw new d(T.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new f(T.MissingIcon));let[l,c]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new f(T.MissingIconSrc)),c===""&&t.add(new f(T.MissingIconAlt));let b=r.querySelector('p > a:not([href$=".svg"])')??null,x=b?.textContent?.trim()??"",g=b?.getAttribute("href")??"",p=g?Mn(g):!1;b===null&&t.add(new f(T.MissingPriceLink));let u=r.querySelector("p > strong")??null;if(u===null)throw new d(T.MissingTitleElement);let v=u?.textContent??"";v===""&&t.add(new f(T.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new f(T.MissingSecondaryCtaAnchor));let[m,h]=(()=>{try{return _(n)}catch{return[null,[]]}})();return h.forEach(w=>t.add(w)),m&&(m.daaLl=`${v} - ${m?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:c,iconSrc:l,title:v,cta:m,priceText:x,priceHref:g,isPriceMerchLink:p}},[...t]]};var Xn=n=>{let e=new Set;if(n===null)throw new d(Zn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new f(Zn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await z(o);if(i instanceof d)throw new Error(i.message);let s=await An(i);if(s instanceof d)throw new Error(s.message);return Sn(o.href,s),n.classList.contains("product-list")?Gn(s):je(s)}catch(a){throw new d(a?.message)}})();if(t instanceof d)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Zn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},je=n=>{let e=[...n.children];if(e.length===0)throw new d("No mega menu items found (did you forget to add them correctly?)");let[r,t]=M(e,a=>Ge(a));if(r.length===0)throw new d("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Ge=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new d("Column contains no cards (did you forget to label them correctly?)");let[r,t]=M(e,a=>Fe(a));if(r.length===0)throw new d("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},Fe=n=>{if(n.classList.contains("featured-card"))return Fn(n);if(n.classList.contains("links-card"))return jn(n);if(n.classList.contains("promo-card"))return Wn(n);throw new d("Unsupported gnav cards section")};var Kn=({card:n})=>We(n),We=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
  <article class="featured-card" ${C(r,"")}>
    <div>
      <div class="featured-eyebrow">${r}</div>
      <h4>${n}</h4>
      <div class="featured-subtitle">${e}</div>
      <span>${B(a)}${S.chevronRight}</span>
    </div>
    <div class="footer-container">
      ${$(t)}
    </div>
  </article>
`.trim();var Vn=({card:n})=>Ze(n),Ze=({title:n,links:e,footerCTA:r})=>`
  <article class="links-card" ${C(n,"")}>
    <div>
      <h4 class="links-card-title">${n}</h4>
      <ul class="links-card-links">
        ${e.map(t=>`<li>${B(t)}</li>`).join("")}
      </ul>
    </div>
    ${r===null?"":`
...
`.trim();var Yn=({card:n})=>Xe(n),Xe=({bgImageAlt:n,bgImageSrc:e,iconAlt:r,iconSrc:t,title:a,cta:o,priceText:i,priceHref:s,isPriceMerchLink:l})=>`
...
`.trim();var Ke=n=>{switch(n.type){case"FeaturedCard":return Kn(n);case"LinksCard":return Vn(n);case"PromoCard":return Yn(n);default:}return""},Jn=({sections:n})=>`
...
`;var Qn=({categories:n,links:e})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Ve).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${e[e.length-1].href}"${C(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${S.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
...
`,ee=(n,e,r)=>{let t=`
  ...
  `,a=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,o=`
    <div class="feds-popup-header">
      ...
      ${a?`<div class="product-links"><a class="feds-link" href="${a.href}"${C(null,a.daaLl??a.text)}>${a.text}${S.chevronRight}</a></div>`:""}
    </div>
  `.trim(),i="";switch(n.type){case"ProductList":i=Qn(n);break;case"GnavCards":i=Jn(n);break;default:}return`${o}${i}`};var re={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},te=n=>{if(n===null)return[{type:"Text",content:""},[new f(re.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new f(re.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var ae=({content:n})=>n;var oe=n=>{if(n===null)throw new d(Ye.elementNull);if(n.querySelector(".gnav-brand")!==null)return un(n);let r=n.querySelector(".large-menu");return r!==null?Xn(r):n.querySelector("strong")!==null?yn(n):n.querySelector("em")!==null?_(n):n.querySelector("a")===null?te(n):E(n.querySelector("a"))},wn=(n,e)=>{switch(n.type){case"Text":return ae(n);case"Link":return B(n);case"SecondaryCTA":return $(n);case"PrimaryCTA":return xn(n);case"Brand":return mn(n);case"MegaMenu":return ne(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Ye={elementNull:"Element is null"};var ie=(n,e)=>{let[r,t]=M([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],E),[a,o]=M([...n.children],oe),i=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return qn(i)}catch{return[null,[]]}})(),c=!1,b=[t,o,l].flat();return{breadcrumbs:r,components:a,productCTA:s,localnav:c,errors:b,unavEnabled:e}};var se=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],r=[...n.querySelectorAll(".tab-content ul")],t=e.map((a,o)=>()=>{let i=r[o].closest(":popover-open"),s=i?.clientHeight??0;if(e.forEach(c=>{c.setAttribute("aria-selected","false")}),r.forEach(c=>{c.setAttribute("hidden","true")}),r[o]?.removeAttribute("hidden"),a.setAttribute("aria-selected","true"),!A.matches)return;let l=i?.clientHeight??0;i?.animate([{height:`${s}px`},{height:`${l}px`}],{duration:350,iterations:1,easing:"cubic-bezier(0.4, 0, 0.2, 1)"})});return e.forEach((a,o)=>{a.addEventListener("click",t[o])}),Je(n),()=>{e.forEach((a,o)=>{a.removeEventListener("click",t[o])})}},Je=n=>{let e=[...n.querySelectorAll(".feds-gnav-items > li > button")],r=n.querySelector(".feds-gnav-items");e.forEach(t=>{t.addEventListener("click",()=>{if(A.matches||!r)return;let a=t.nextElementSibling;a&&(r.classList.remove("subscreen-closing"),r.classList.add("subscreen-opening"),a.querySelector(".feds-popup-back-button")?.addEventListener("click",()=>{r.classList.remove("subscreen-opening"),r.classList.add("subscreen-closing"),setTimeout(()=>a.hidePopover(),240)}))})}),A.addEventListener("change",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")}),n.querySelector(".feds-nav-toggle")?.addEventListener("click",()=>{r?.classList.remove("subscreen-opening"),r?.classList.remove("subscreen-closing")})};var le=async n=>{let e=new Set,r=n.querySelectorAll("a.merch");if(r.length===0)return e;try{let t=k(),{base:a}=t;if(!a)return e.add(new f("base not found in config, cannot initialize merch links")),e;let o=await import(`${a}/blocks/merch/merch.js`),{default:i}=o;if(!i)return e.add(new f("decorateMerchLink not found in merch module")),e;r.forEach(s=>{i(s)})}catch(t){e.add(new f(`Error initializing merch links: ${t}`))}return e};var de=async({gnavSource:n,asideSource:e})=>{let r=await z(n);if(r instanceof d)return r;let t=await z(e);return{mainNav:r,aside:t}};var Qe=`/**
...
`,ce=document.createElement("style");ce.textContent=Qe;document.head.appendChild(ce);var wo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new d("gnavSource needs to be a URL object");try{cn(a)}catch(b){throw L(`Failed to initialize MiloConfig: ${b}`),new d(`Failed to initialize MiloConfig: ${b}`)}Tn(o),Ln(Cn(n));let i=await de(n);if(i instanceof d)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof d)throw L(s.message),s;let c=ie(s,t);if(c instanceof d)throw L(c.message),c;return await nr(c)(r),rr(n)},nr=n=>async e=>{let r=er(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[c,b]=await s,x=a[l].title;return t[l].innerHTML=ee(c,t[l].id,x),b}).flat());return e},er=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
    ${(()=>{let t=n.find(l=>l.type==="Brand")??null,a=n.filter(l=>l.type!=="Brand"),o=`
      ...
      `.trim(),i=t?wn(t):"",s=_n(a,wn);return`
...
`,rr=async n=>{let e=new Set,r=await tn(n.mountpoint);r instanceof f?(e.add(r),L(r.message)):r.errors.forEach(o=>e.add(o)),se(n.mountpoint),bn(n.mountpoint),tr(n.mountpoint),ar(n.mountpoint),or(n.mountpoint),sr(n.mountpoint),lr(n.mountpoint,n.mepMartech??""),(await le(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let a=r instanceof f?()=>{}:r.reloadUnav;return{closeEverything:ir,reloadUnav:a,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},tr=n=>{let e=n.querySelector("#feds-menu-wrapper"),r=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let a=e.matches(":popover-open");r?.setAttribute("aria-expanded",String(a)),r?.setAttribute("daa-ll",a?"hamburgermenu|close":"hamburgermenu|open"),e.setAttribute("aria-hidden",String(!a)),a&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(a=>{a.addEventListener("toggle",()=>{let o=n.querySelector(`[popovertarget="${a.id}"]`),i=a.matches(":popover-open");o?.setAttribute("aria-expanded",String(i)),o?.setAttribute("daa-ll",i?"header|Close":"header|Open")})})},ar=n=>{A.addEventListener("change",()=>{X(n)})},or=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>X(n)),e.addEventListener("keydown",r=>{r.key==="Enter"&&X(n)})})};var ir=()=>{},sr=n=>{let e=n.closest("header");if(!e)return;let r=n.querySelector("#feds-menu-wrapper"),t=()=>r?.matches(":popover-open")??!1,a=()=>window.scrollY>100,o=()=>{if(t()){e.classList.remove("feds-header-scrolled");return}if(a()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};o(),window.addEventListener("scroll",o,{passive:!0}),r?.addEventListener("toggle",o)},lr=(n,e)=>{let r=n.closest("header");r!==null&&r.setAttribute("daa-lh",`gnav|${In()}${e}`)};export{wo as main,rr as postRenderingTasks,nr as renderGnav,er as renderGnavString};
