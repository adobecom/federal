...
`;var Xn=({categories:n,links:e})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Fe).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${e[e.length-1].href}"${M(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${T.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
...
`,Yn=(n,e,r)=>{let t=`
  ...
  `,a=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,o=`
    <div class="feds-popup-header">
      ...
      ${a?`<div class="product-links"><a class="feds-link" href="${a.href}"${M(null,a.daaLl??a.text)}>${a.text}${T.chevronRight}</a></div>`:""}
    </div>
