...
`,Nn=n=>n.type==="PrimaryCTA"?yn(n):A(n);var G=({text:n,href:e,daaLl:r})=>`<a class="feds-link" href="${e}"${M(null,r??n)}>${n}</a>`;var Dn=n=>{let[e,r]=He(n);return[{type:"LinksCard",card:e},r]},He=n=>{let e=n.querySelector("h1, h2, h3")||null;if(!e)throw new l("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(d=>d!==r);if(t.length===0)throw new l("Expected at least one link");let[a,o]=E(t,k),[i,s]=(()=>{try{return P(n)}catch{return[null,[]]}})();return[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var Bn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=E(e,ze),[o,i]=E(r,k);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},ze=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new l("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=En(e),[o,i]=E(a,cn);return[{type:"ProductCategory",name:r,daaLh:t,links:o},i]};var On=n=>{let[e,r]=Ue(n);return[{type:"FeaturedCard",card:e},r]},Ue=n=>{let e=n.querySelector("h3")||null;if(!e)throw new f("Eye brow element not found");let r=n.querySelector("h1")||null,t=r?.nextElementSibling||null;if(!r)throw new l("Expected title");if(!t)throw new l("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new l("Expected card link after subtitle");let[o,i]=k(a),[s,d]=P(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...d,...i]]};var T={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor"},jn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new l(T.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new f(T.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new f(T.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new f(T.MissingBackgroundImageSrc)),r===void 0)throw new l(T.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new f(T.MissingIcon));let[d,c]=(s?.textContent?.split("|")??["",""]).map(v=>v.trim());d===""&&t.add(new f(T.MissingIconSrc)),c===""&&t.add(new f(T.MissingIconAlt));let y=r.querySelector("p > strong")??null;if(y===null)throw new l(T.MissingTitleElement);let x=y?.textContent??"";x===""&&t.add(new f(T.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new f(T.MissingSecondaryCtaAnchor));let[p,u]=(()=>{try{return P(n)}catch{return[null,[]]}})();return u.forEach(v=>t.add(v)),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:c,iconSrc:d,title:x,cta:p}},[...t]]};var Fn=n=>{let e=new Set;if(n===null)throw new l(qn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new f(qn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await H(o);if(i instanceof l)throw new Error(i.message);let s=await _n(i);if(s instanceof l)throw new Error(s.message);return Tn(o.href,s),n.classList.contains("product-list")?Bn(s):Ge(s)}catch(a){throw new l(a?.message)}})();if(t instanceof l)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},qn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ge=n=>{let e=[...n.children];if(e.length===0)throw new l("No mega menu items found (did you forget to add them correctly?)");let[r,t]=E(e,a=>Ne(a));if(r.length===0)throw new l("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},Ne=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new l("Column contains no cards (did you forget to label them correctly?)");let[r,t]=E(e,a=>De(a));if(r.length===0)throw new l("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},De=n=>{if(n.classList.contains("featured-card"))return On(n);if(n.classList.contains("links-card"))return Dn(n);if(n.classList.contains("promo-card"))return jn(n);throw new l("Unsupported gnav cards section")};var Wn=({card:n})=>Be(n),Be=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
...
`;var Xn=({categories:n,links:e})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Fe).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${e[e.length-1].href}"${M(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${S.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
...
`,ie=document.createElement("style");ie.textContent=Ze;document.head.appendChild(ie);var to=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw C(`gnavSource is invalid: ${e}`),new l("gnavSource needs to be a URL object");try{dn(a)}catch(y){throw C(`Failed to initialize MiloConfig: ${y}`),new l(`Failed to initialize MiloConfig: ${y}`)}Mn(o),Cn(wn(n));let i=await oe(n);if(i instanceof l)throw C(i.message),i;let{mainNav:s,aside:d}=i;if(s instanceof l)throw C(s.message),s;let c=te(s,t);if(c instanceof l)throw C(c.message),c;return await Ke(c)(r),Xe(n)},Ke=n=>async e=>{let r=Ve(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,d)=>{let[c,y]=await s,x=a[d].title;return t[d].innerHTML=Yn(c,t[d].id,x),y}).flat());return e},Ve=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
