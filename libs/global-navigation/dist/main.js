var mn=async n=>{let{placeholders:e}=n,{locale:t}=y(),o=`${j()}${t.prefix}/federal/globalnav/placeholders.json`,[i,a]=await Promise.all([e,pe(o)]);return new Map([...a,...i])},pe=async n=>{try{let e=await fetch(n);if(!e.ok)throw new p(`Federal placeholders not found at ${n}`);let t=ue(await e.json());if(t instanceof p)throw t;return new Map(t.data.map(({key:r,value:o})=>[r,o]))}catch(e){if(e instanceof p)console.error(e.message);else{let t=new p(e.message);console.error(t.message)}return v(`Failed to fetch placeholders from ${n}`),new Map([])}},ue=n=>{try{let{data:e}=n;if(!e.every(({key:r,value:o})=>typeof r=="string"&&typeof o=="string"))throw new Error("data is not valid");return n}catch(e){return new p(e.message)}};function hn(n,e){let t=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return t.test(n)?n.replace(t,(o,i,a)=>{let s=i??a??"";return e.get(s)??s}):n}var[vn,bn]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var I=window.matchMedia("(min-width: 900px)"),H={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',arrowBack:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" fill="currentColor"/></svg>'};var yn=n=>{let e=[],t=n.nextElementSibling??null;for(;t!==null;)e.push(t),t=t.nextElementSibling??null;return e},G=n=>({eval:n,or:e=>G(t=>{try{return n(t)}catch{return e(t)}})}),C=(n,e)=>n.reduce(([t,r],o)=>{try{let[i,a]=e(o);return[[...t,i],[...r,...a]]}catch(i){return i instanceof l?[t,[i,...r]]:[t,r]}},[[],[]]),xn=({mobileEventListeners:n,desktopEventListeners:e})=>t=>{let r;I.matches?r=e(t):r=n(t),I.addEventListener("change",()=>{r?.(),r=I.matches?e(t):n(t);let o=t.querySelector("#feds-menu-wrapper");o?.matches(":popover-open")===!0&&o.hidePopover?.()})},[wn,ge]=(()=>{let n,e=!1;return[t=>{e||(n=t,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),R=async n=>{try{if(n===null)return new l("URL is null");let e=en(`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`),t=await fetch(e);if(!t.ok)return v(`Request for ${e} failed`),new l(`Request for ${e} failed`);let r=await t.text(),o=await bn(),i=hn(r,o),{body:a}=new DOMParser().parseFromString(i,"text/html");try{let{handleCommands:s,commands:c}=ge();s(c,a)}catch(s){v(`Personalization not applied: ${s?.message}`)}return a}catch(e){return new l(e?.message)}},$,j=()=>{if($)return $;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if($)return $;let e=window.location.origin;$=n.some(o=>{let i=e.replace(".stage","");return o.startsWith("https://")?i===o:i.endsWith(o)})?e:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${r}.`))&&($=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),$},en=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${j()}${n}`;try{let{pathname:e,search:t,hash:r}=new URL(n);return`${j()}${e}${t}${r}`}catch(e){let t=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${t}`)}return n},Cn=(n,e)=>{let t=(r,o)=>{let i=`${r}[${o}^="./media_"]`;e.querySelectorAll(i).forEach(s=>{let c=s.getAttribute(o);if(c)try{let d=en(new URL(c,new URL(n,window.location.href)).href);s.setAttribute(o,d)}catch(d){console.warn(`[MediaPathError]: Failed to process relative media path (${c}) for ${r}`,d)}})};t("img","src"),t("source","srcset")},kn=async n=>{let e=async(t,r)=>{if(t instanceof l)return t;try{let i=[...t.querySelectorAll('a[href*="#_inline"]')].map(async a=>{try{if(r.has(a.href))return;let s=en(a.href),c=new URL(s),d=await R(c);if(r.add(a.href),d instanceof l)throw d;await e(d,r),a.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(i),t}catch(o){return new l(JSON.stringify(o))}};return e(n,new Set)},Ln=(n,e)=>n.map(t=>`<li>${e(t)}</li>`).join(""),N=n=>n.toLowerCase().trim().replace(/[^a-z0-9]/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").replace(/^(\d)/,"id-$1"),E=(n,e)=>{let t=n!==null&&n!==""?` daa-lh="${n}"`:"",r=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${t}${r}`},En=()=>!0;function fe(n,{id:e,as:t,callback:r,crossorigin:o,rel:i,fetchpriority:a}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return r?.("noop"),s;let c=document.createElement("link");return c.setAttribute("rel",i),e!==void 0&&c.setAttribute("id",e),t!==void 0&&c.setAttribute("as",t),o!==void 0&&c.setAttribute("crossorigin",o),a!==void 0&&c.setAttribute("fetchpriority",a),c.setAttribute("href",n),r&&(c.onload=d=>r(d.type),c.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(c),c}function me(n,e){return fe(n,{rel:"stylesheet",callback:e})}function tn(n,e=!1){e&&me(n)}var rn=(n,e,{mode:t,id:r}={})=>new Promise((o,i)=>{let a=document.querySelector(`head > script[src="${n}"]`);if(!a){let{head:d}=document;a=document.createElement("script"),a.setAttribute("src",n),r!=null&&a.setAttribute("id",r),e!=null&&a.setAttribute("type",e),t&&["async","defer"].includes(t)&&a.setAttribute(t,""),d.append(a)}let s=a.dataset.loaded;if(s!=null){o(a);return}let c=d=>{a.removeEventListener("load",c),a.removeEventListener("error",c),d.type==="error"?i(new Error(`error loading script: ${a.src}`)):d.type==="load"&&(a.dataset.loaded="true",o(a))};a.addEventListener("load",c),a.addEventListener("error",c)});function B(n,e=document){let t=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${t}="${n}"]`)?.content??null}var he=n=>{let e=n,t=i=>i==null||typeof i!="object";if(t(e)||t(e.locale)||typeof e.locale.prefix!="string"||t(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let i=e.unav;if(i.profile!==void 0){if(typeof i.profile!="object"||i.profile===null)return!1;let a=i.profile;if(a.signInCtaStyle!==void 0&&a.signInCtaStyle!=="primary"&&a.signInCtaStyle!=="secondary"||a.messageEventListener!==void 0&&typeof a.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[on,y]=(()=>{let n,e=!1;return[t=>{if(!e){if(!he(t))throw new Error("MiloConfig validation failed: Invalid structure");n=t,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),ve={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},_n={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function be(n){let e=ve[n];return!e&&_n[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var nn="langstore/";function Mn(n){let t=(n?.prefix||"US_en").replace("/","")??"",[r="US",o="en"]=(_n[t]??t).split("_",2);if(t.startsWith(nn)||window.location.pathname.startsWith(`/${nn}`)){let i=t.replace(nn,"").toLowerCase();r=be(i),o=i}return r=r.toUpperCase(),o=o.toLowerCase(),{language:o,country:r,locale:`${o}_${r}`}}var F={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},h=n=>{if(n===null)throw new l(F.elementNull);if(n.tagName!=="A")throw new l(F.notAnchor);let e=n?.textContent??"";if(e==="")throw new l(F.textContentNotFound);let t=n?.getAttribute("href")??"";if(t==="")throw new l(F.hrefNotFound);let r=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:t,daaLl:r},[]]};var an=n=>G(xe).or(ye).or(we).eval(n),_={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class"},ye=n=>{let e=new Set;if(!n)throw new l(_.elementNull);let t=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!t)throw new l(_.noTitleAnchor);let r=t.textContent??"";r===""&&e.add(new p(_.noTitle));let o=t.getAttribute("href")??"";o===""&&e.add(new p(_.noHref));let i=t.getAttribute("daa-ll"),a=t.getAttribute("daa-lh"),s=t?.closest("p")?.nextElementSibling;s||e.add(new p(_.noSubtitleP));let c=s?.textContent??"";c===""&&e.add(new p(_.noSubtitle));let d=[],g=null,f=null;n.classList.contains("new")&&d.push("New"),n.classList.contains("show-offer")&&(d.push("Save 20%"),g="$29.99",f="$19.99");let[k,b=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(x=>x.trim());return[{type:"LinkGroupLink",iconHref:k,iconAlt:b,title:r,href:o,subtitle:c,badges:d,oldPrice:g,newPrice:f,daaLl:i,daaLh:a},[...e]]},xe=n=>{if(!n)throw new l(_.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new l(_.notAHeader);let t=n.querySelector("a")?.textContent??"",r=n.querySelector("a")?.getAttribute("daa-ll")??null,o=n.querySelector("a")?.getAttribute("daa-lh")??null;if(t==="")throw new l(_.noTitle);return[{type:"LinkGroupHeader",title:t,classes:e,daaLl:r,daaLh:o},[]]},we=n=>{if(!n)throw new l(_.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Link Group");let e=n.querySelector("a"),[t,r]=h(e),o=e?.getAttribute("daa-ll")??null,i=e?.getAttribute("daa-lh")??null;return[{type:"LinkGroupBlue",link:t,daaLl:o,daaLh:i},r]};var sn=n=>{switch(n.type){case"LinkGroupHeader":return Ce(n);case"LinkGroupLink":return ke(n);case"LinkGroupBlue":return Le(n);default:return console.error(n),""}},Ce=({title:n,classes:e,daaLl:t,daaLh:r})=>{let o=e.slice(1).map(a=>`feds-link-group--${a}`).join(" "),i=E(r,t??n);return`
  ...
  `},ke=({iconHref:n,iconAlt:e,title:t,href:r,subtitle:o,badges:i=[],oldPrice:a=null,newPrice:s=null,daaLl:c,daaLh:d})=>{let g=e!==null&&n!==null,f=E(d,c??t),k=g?`
    ...
    `,x=o===""?"":`<div class="feds-link-group__subtitle">${o}</div>`,w=a===null&&s===null?"":`
  ...
  `},Le=({link:n,daaLl:e,daaLh:t})=>{let r=E(t,e??n.text);return`
  <a href="${n.href}" class="feds-link-group feds-link-group--blue"${r}>
    <div class="feds-link-group__content">
        <div class="feds-link-group__title">${n.text}</div>
      </div>
  </a>
`};var q={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},U=/(\.png|\.jpg|\.jpeg|\.svg)/i,Ee=n=>{let e=n.querySelector("picture img")?.getAttribute("src")??null;if(e!==null&&e!=="")return e;let t=n.textContent?.trim();if(t!==void 0&&t!==""&&U.test(t)){let o=t.split("|")[0]?.trim();if(o!==void 0&&o!=="")return o}let r=n.getAttribute("href");return r!==null&&r!==""&&U.test(r)?r:null},_e=n=>{let e=n.textContent?.trim();if(e?.includes("|")===!0){let r=e.split("|")[1]?.trim();if(r)return r}return n.querySelector("img")?.getAttribute("alt")??""},ln=n=>{if(n===null)throw new l(q.elementNull);let e=n.querySelector(".gnav-brand");if(e===null)throw new l(q.elementNull);let t=[...e.querySelectorAll("a")];if(t.length===0)throw new l(q.noLinks);let r=t.find(u=>{let m=u.textContent??"";return!U.test(u.href)&&!U.test(m)});if(!r)throw new l(q.noPrimaryLink);let o=e.matches(".brand-image-only"),i=e.matches(".no-logo"),a=e.matches(".image-only"),s=!i,c=!o&&!a,d=t.filter(u=>{let m=u.textContent??"";return U.test(u.href)||U.test(m)}),[g,f,k]=(()=>{let u=o?H.brand:H.company,[m=null,A=null]=[...e.querySelectorAll('picture img[src$=".svg"]')].map(Q=>Q?.src).filter(Q=>Q?.length>0),[O=null,ce=null]=d.map(Ee),de=d[0]instanceof Element?_e(d[0]):r.textContent?.trim()??"";return[O??m??u,ce??A,de]})(),b=r.textContent?.trim()??"",x=r.href;if(!s&&!c)return[{type:"Brand",data:{type:"NoRender"}},[]];let w=(u,m)=>{let A=m!=null&&m!=="";return En()&&A?m:u},S=g.startsWith("<svg")?{type:"inline-svg",svgContent:w(g,f),alt:k}:{type:"image",src:w(g,f),alt:k};return s&&c?[{type:"Brand",data:{type:"LabelledBrand",href:x,label:b,image:S}},[]]:s&&o?[{type:"Brand",data:{type:"BrandImageOnly",href:x,image:S,alt:k}},[]]:s&&a?[{type:"Brand",data:{type:"ImageOnlyBrand",href:x,image:S,alt:k}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:x,label:b}},[]]};var Me=`.feds-brand-container {
    display: flex;
    flex-shrink: 0;
}
...
`,Rn=n=>n.type==="PrimaryCTA"?gn(n):T(n);var P=({text:n,href:e,daaLl:t})=>`<a class="feds-link" href="${e}"${E(null,t??n)}>${n}</a>`;var Un=n=>{let[e,t]=Re(n);return[{type:"LinksCard",card:e},t]},Re=n=>{let e=n.querySelector("h1, h2, h3")||null;if(!e)throw new l("Expected links card title");let t=n.querySelector("em > a"),r=[...n.querySelectorAll("a")].filter(c=>c!==t);if(r.length===0)throw new l("Expected at least one link");let[o,i]=C(r,h),[a,s]=(()=>{try{return M(n)}catch{return[null,[]]}})();return[{type:"LinksCardItem",title:e.textContent??"",links:o,footerCTA:a},[...i,...s]]};var Hn=n=>{let e=[...n.querySelectorAll("li > div")],t=[...n.querySelectorAll("li > a")],[r,o]=C(e,Ue),[i,a]=C(t,h);return[{type:"ProductList",categories:r,links:i},[...o,...a]]},Ue=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new l("Expected H2");let t=e.textContent??"",r=e.textContent??"",o=yn(e),[i,a]=C(o,an);return[{type:"ProductCategory",name:t,daaLh:r,links:i},a]};var Gn=n=>{let[e,t]=He(n);return[{type:"FeaturedCard",card:e},t]},He=n=>{let e=n.querySelector("h3")||null;if(!e)throw new p("Eye brow element not found");let t=n.querySelector("h1")||null,r=t?.nextElementSibling||null;if(!t)throw new l("Expected title");if(!r)throw new l("Expected subtitle");let o=r.nextElementSibling?.firstElementChild||null;if(!o)throw new l("Expected card link after subtitle");let[i,a]=h(o),[s,c]=M(n);return[{type:"Card",title:t.textContent??"",subtitle:r.textContent??"",bodyLink:i,footerCTA:s,eyeBrow:e.textContent??""},[...c,...a]]};var L={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor"},Nn=n=>{let[e,t]=n.querySelectorAll(":scope > div"),r=new Set;if(e===void 0)throw new l(L.MissingBackgroundImageSection);let o=e.querySelector(":scope picture:not(:scope p picture) img")??null;o===null&&r.add(new p(L.MissingBackgroundImage));let i=o?.getAttribute("alt")??"";i===""&&r.add(new p(L.MissingBackgroundImageAlt));let a=o?.getAttribute("src")??"";if(a===""&&r.add(new p(L.MissingBackgroundImageSrc)),t===void 0)throw new l(L.MissingContentSection);let s=t.querySelector('a[href$=".svg"]')??null;s===null&&r.add(new p(L.MissingIcon));let[c,d]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());c===""&&r.add(new p(L.MissingIconSrc)),d===""&&r.add(new p(L.MissingIconAlt));let g=t.querySelector("p > strong")??null;if(g===null)throw new l(L.MissingTitleElement);let f=g?.textContent??"";f===""&&r.add(new p(L.MissingTitleText)),t.querySelector("em > a")===null&&r.add(new p(L.MissingSecondaryCtaAnchor));let[b,x]=(()=>{try{return M(n)}catch{return[null,[]]}})();return x.forEach(w=>r.add(w)),[{type:"PromoCard",card:{bgImageAlt:i,bgImageSrc:a,iconAlt:d,iconSrc:c,title:f,cta:b}},[...r]]};var Ge=`/* Mega Menu specific grid structure styles for links-card and promo-card */
...
`,Bn=document.createElement("style");Bn.textContent=Ge;document.head.appendChild(Bn);var zn=n=>{let e=new Set;if(n===null)throw new l(Dn.elementNull);let t=n.querySelector("h2")?.textContent??"";t===""&&e.add(new p(Dn.noTitle));let r=(async()=>{try{let o=n.querySelector("a"),i=new URL(o?.href??""),a=await R(i);if(a instanceof l)throw new Error(a.message);let s=await kn(a);if(s instanceof l)throw new Error(s.message);return Cn(i.href,s),n.classList.contains("product-list")?Hn(s):Ne(s)}catch(o){throw new l(o?.message)}})();if(r instanceof l)throw r;return[{type:"MegaMenu",title:t,content:r},[...e]]},Dn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ne=n=>{let e=[...n.children];if(e.length===0)throw new l("No mega menu items found (did you forget to add them correctly?)");let[t,r]=C(e,o=>Be(o));if(t.length===0)throw new l("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:t},r]},Be=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new l("Column contains no cards (did you forget to label them correctly?)");let[t,r]=C(e,o=>De(o));if(t.length===0)throw new l("Failed to parse cards in column");return[{type:"GnavColumn",cards:t},r]},De=n=>{if(n.classList.contains("featured-card"))return Gn(n);if(n.classList.contains("links-card"))return Un(n);if(n.classList.contains("promo-card"))return Nn(n);throw new l("Unsupported gnav cards section")};var ze=`.feds-popup .featured-card .featured-eyebrow {
  color: #7a7474;
...
`,On=document.createElement("style");On.textContent=ze;document.head.appendChild(On);var jn=({card:n})=>Oe(n),Oe=({title:n,subtitle:e,eyeBrow:t,footerCTA:r,bodyLink:o})=>`
...
`.trim();var je=`.feds-popup .links-card {
  border-radius: 14px;
  background: white;
  box-sizing: border-box;
  display: flex;
...
`,Fn=document.createElement("style");Fn.textContent=je;document.head.appendChild(Fn);var qn=({card:n})=>Fe(n),Fe=({title:n,links:e,footerCTA:t})=>`
  <article class="links-card">
    <div>
      <h4 class="links-card-title">${n}</h4>
      <ul class="links-card-links">
        ${e.map(r=>`<li>${P(r)}</li>`).join("")}
      </ul>
    </div>
    ${t===null?"":`
...
`.trim();var qe=`.feds-gnav-cards .promo-card {
    position: relative;
    height: 199px;
}
...
`,Wn=document.createElement("style");Wn.textContent=qe;document.head.appendChild(Wn);var Zn=({card:n})=>We(n),We=({bgImageAlt:n,bgImageSrc:e,iconAlt:t,iconSrc:r,title:o,cta:i})=>`
...
`.trim();var Ze=`.feds-popup .feds-gnav-cards {
  list-style: none;
  margin: 0;
...
`,Vn=document.createElement("style");Vn.textContent=Ze;document.head.appendChild(Vn);var Ve=n=>{switch(n.type){case"FeaturedCard":return jn(n);case"LinksCard":return qn(n);case"PromoCard":return Zn(n);default:}return""},Kn=({sections:n})=>`
  <ul class="feds-gnav-cards">
    ${n.map(e=>`<li>${e.cards.map(t=>Ve(t)).join("")}</li>`).join("")}
  </ul>
`;var Ke=`.feds-popup .product-list {
  display: grid;
...
.product-list .product-links .feds-link::after {
  ...
  padding-left: 4px;
  font-size: 16px;
}`,Jn=document.createElement("style");Jn.textContent=Ke;document.head.appendChild(Jn);var Yn=({categories:n,links:e})=>{let t=`
    <ul class="tabs" role="tablist">
      ${n.map(Je).join("")}
       ${e.map(o=>`<li class="product-links">${P(o)}</li>`).join("")}
    </ul>
  `.trim(),r=`
...
`,Qn=(n,e,t)=>{let r=`
  ...
  `.trim(),o="";switch(n.type){case"ProductList":o=Yn(n);break;case"GnavCards":o=Kn(n);break;default:}return`${r}${o}`};var ne={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},ee=n=>{if(n===null)return[{type:"Text",content:""},[new p(ne.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new p(ne.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var te=({content:n})=>n;var re=n=>{if(n===null)throw new l(Ye.elementNull);if(n.querySelector(".gnav-brand")!==null)return ln(n);let t=n.querySelector(".large-menu");return t!==null?zn(t):n.querySelector("strong")!==null?un(n):n.querySelector("em")!==null?M(n):n.querySelector("a")===null?ee(n):h(n.querySelector("a"))},fn=n=>{switch(n.type){case"Text":return te(n);case"Link":return P(n);case"SecondaryCTA":return T(n);case"PrimaryCTA":return gn(n);case"Brand":return dn(n);case"MegaMenu":return Xn(n);default:return console.error(`Failed to recognize component: ${n}`),""}},Ye={elementNull:"Element is null"};var oe=(n,e)=>{let[t,r]=C([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],h),[o,i]=C([...n.children],re),a=n.querySelector(".product-entry-cta"),[s,c]=(()=>{try{return In(a)}catch{return[null,[]]}})(),d=!1,g=[r,i,c].flat();return{breadcrumbs:t,components:o,productCTA:s,localnav:d,errors:g,unavEnabled:e}};var Xe=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],t=[...n.querySelectorAll(".tab-content ul")],r=e.map((o,i)=>()=>{e.forEach(a=>{a.setAttribute("aria-selected","false")}),t.forEach(a=>{a.setAttribute("hidden","true")}),t[i]?.removeAttribute("hidden"),o.setAttribute("aria-selected","true")});return e.forEach((o,i)=>{o.addEventListener("click",r[i])}),()=>{e.forEach((o,i)=>{o.removeEventListener("click",r[i])})}};var ie=Xe;var Qe=n=>()=>console.log(n),nt=n=>()=>console.log(n),ae=xn({mobileEventListeners:nt,desktopEventListeners:Qe});var se=async({gnavSource:n,asideSource:e})=>{let t=await R(n);if(t instanceof l)return t;let r=await R(e);return{mainNav:t,aside:r}};var et=`/**
...
`,le=document.createElement("style");le.textContent=et;document.head.appendChild(le);var bi=async n=>{let{gnavSource:e,mountpoint:t,unavEnabled:r,miloConfig:o,personalization:i}=n;if(!(e instanceof URL))throw v(`gnavSource is invalid: ${e}`),new l("gnavSource needs to be a URL object");try{on(o)}catch(g){throw v(`Failed to initialize MiloConfig: ${g}`),new l(`Failed to initialize MiloConfig: ${g}`)}wn(i),vn(mn(n));let a=await se(n);if(a instanceof l)throw v(a.message),a;let{mainNav:s,aside:c}=a;if(s instanceof l)throw v(s.message),s;let d=oe(s,r);if(d instanceof l)throw v(d.message),d;return await tt(d)(t),ot(n)},tt=n=>async e=>{let t=rt(n);e.innerHTML=t,e.classList.add("site-pivot");let r=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let o=n.components.filter(s=>s.type==="MegaMenu"),i=o.map(s=>s.content),a=await Promise.all(i.map(async(s,c)=>{let[d,g]=await s,f=o[c].title;return r[c].innerHTML=Qn(d,r[c].id,f),g}).flat());return e},rt=({components:n,productCTA:e,unavEnabled:t})=>`
<nav>
  <ul>
    ${(()=>{let r=n.find(c=>c.type==="Brand")??null,o=n.filter(c=>c.type!=="Brand"),i=`
        <button
      ...
      `.trim(),a=r?fn(r):"",s=Ln(o,fn);return`
...
`,ot=async n=>{let e=new Set,t=await X(n.mountpoint);t instanceof p?(e.add(t),v(t.message)):t.errors.forEach(o=>e.add(o)),ie(n.mountpoint),ae(n.mountpoint),at(n.mountpoint);let r=t instanceof p?()=>{}:t.reloadUnav;return{closeEverything:it,reloadUnav:r,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},it=()=>{},at=n=>{let e=n.closest("header");if(!e)return;let t=n.querySelector("#feds-menu-wrapper"),r=()=>t?.matches(":popover-open")??!1,o=()=>window.scrollY>100,i=()=>{if(r()){e.classList.remove("feds-header-scrolled");return}if(o()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};i(),window.addEventListener("scroll",i,{passive:!0}),t?.addEventListener("toggle",i)};export{bi as main,ot as postRenderingTasks,tt as renderGnav,rt as renderGnavString};
