...
@media (max-width: 1023px) {
  ...
  header.global-navigation > nav > ul > li.feds-menu-wrapper > ul.feds-gnav-items {
    ...
    &.subscreen-closing {
      ...
      /* target the popover descendant when it is open */
      & .feds-popup:not(:popover-open) {
        opacity: 1;
        animation: fade-out 0s linear 0.24s forwards; /* zero-duration instant jump after delay */
  
        & .feds-popup-header {
          opacity: 1;
          transform: translateX(18px);
          animation: sub-menu-items-enter 0.2s forwards ease;
        ...
        & .tabs {
          opacity: 0;
          transform: translateX(18px);
          animation: sub-menu-items-enter 0.2s forwards ease 0.04s;
          animation-direction: reverse;
        }
