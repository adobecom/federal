...
`,Oe=document.createElement("style");Oe.textContent=Dn;document.head.appendChild(Oe);var Fe=({layout:e,panels:n})=>`
  ...
  `}">
      ${n.map(r=>`<li style="${qn(r.position)}">${On(r)}</li>`).join("")}
    </ul>
