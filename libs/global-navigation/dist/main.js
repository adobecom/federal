...
`,_e=e=>e.type==="PrimaryCTA"?de(e):E(e);var I=({text:e,href:n})=>`<a class="feds-link" href="${n}">${e}</a>`;var Re=e=>{let[n,t]=Sn(e);return[{type:"LinksCard",card:n},t]},Sn=e=>{let n=e.querySelector("h1, h2, h3")||null;if(!n)throw new l("Expected links card title");let t=e.querySelector("em > a"),r=[...e.querySelectorAll("a")].filter(c=>c!==t);if(r.length===0)throw new l("Expected at least one link");let[o,a]=b(r,y),[i,s]=(()=>{try{return k(e)}catch{return[null,[]]}})();return[{type:"LinksCardItem",title:n.textContent??"",links:o,footerCTA:i},[...a,...s]]};var Ie=e=>{let n=[...e.querySelectorAll("li > div")],[t,r]=b(n,Pn);return[{type:"ProductList",categories:t},r]},Pn=e=>{let n=e.firstElementChild;if(n?.nodeName!=="H2")throw new l("Expected H2");let t=n.textContent??"",r=n.getAttribute("daa-lh"),o=n.getAttribute("daa-ll"),a=ve(n),[i,s]=b(a,re);return[{type:"ProductCategory",name:t,daaLh:r,daaLl:o,links:i},s]};var $e=e=>{let[n,t]=An(e);return[{type:"FeaturedCard",card:n},t]},An=e=>{let n=e.querySelector("h3")||null;if(!n)throw new p("Eye brow element not found");let t=e.querySelector("h1")||null,r=t?.nextElementSibling||null;if(!t)throw new l("Expected title");if(!r)throw new l("Expected subtitle");let o=r.nextElementSibling?.firstElementChild||null;if(!o)throw new l("Expected card link after subtitle");let[a,i]=y(o),[s,c]=k(e);return[{type:"Card",title:t.textContent??"",subtitle:r.textContent??"",bodyLink:a,footerCTA:s,eyeBrow:n.textContent??""},[...c,...i]]};var He=e=>{let n=new Set;if(e===null)throw new l(Ue.elementNull);let t=e.querySelector("h2")?.textContent??"";t===""&&n.add(new p(Ue.noTitle));let r=(async()=>{try{let o=e.querySelector("a"),a=new URL(o?.href??""),i=await A(a);if(i instanceof l)throw new Error(i.message);let s=await xe(i);if(s instanceof l)throw new Error(s.message);return e.classList.contains("product-list")?Ie(s):_n(s)}catch(o){throw new l(o?.message)}})();if(r instanceof l)throw r;return[{type:"MegaMenu",title:t,content:r},[...n]]},Ue={elementNull:"Element is null",noTitle:"Large Menu has no Title"},_n=e=>{let n=[...e.children].filter(a=>a.classList.contains("featured-card")||a.classList.contains("links-card")),t=n.length>0?n:[...e.querySelectorAll(".featured-card, .links-card")];if(t.length===0)throw new l("Unrecognized mega menu item (did you forget to label it correctly?)");let[r,o]=b(t,Rn);if(r.length===0)throw new l("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},o]},Rn=e=>{if(e.classList.contains("featured-card"))return $e(e);if(e.classList.contains("links-card"))return Re(e);throw new l("Unsupported gnav cards section")};var In=`.feds-popup .featured-card .featured-eyebrow {
  color: #7a7474;
...
`,Ge=document.createElement("style");Ge.textContent=In;document.head.appendChild(Ge);var Ne=({card:e})=>$n(e),$n=({title:e,subtitle:n,eyeBrow:t,footerCTA:r,bodyLink:o})=>`
...
`,Fe=document.createElement("style");Fe.textContent=Nn;document.head.appendChild(Fe);var je=({categories:e})=>{let n=`
  ...
  `.trim()},Bn=({name:e,daaLh:n,daaLl:t},r)=>`
      <li>
        <button
          role="tab"
          class="tab"
...
`,nn=document.createElement("style");nn.textContent=jn;document.head.appendChild(nn);var qo=async e=>{let{gnavSource:n,mountpoint:t,unavEnabled:r,miloConfig:o,personalization:a}=e;if(!(n instanceof URL))throw m(`gnavSource is invalid: ${n}`),new l("gnavSource needs to be a URL object");try{te(o)}catch(f){throw m(`Failed to initialize MiloConfig: ${f}`),new l(`Failed to initialize MiloConfig: ${f}`)}ye(a),ge(ue(e));let i=await en(e);if(i instanceof l)throw m(i.message),i;let{mainNav:s,aside:c}=i;if(s instanceof l)throw m(s.message),s;let d=Xe(s,r);if(d instanceof l)throw m(d.message),d;return await qn(d)(t),Zn(e)},qn=e=>async n=>{let t=Wn(e);n.innerHTML=t,n.classList.add("site-pivot");let r=[...n.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(s=>{s.innerHTML=""});let o=e.components.filter(s=>s.type==="MegaMenu"),a=o.map(s=>s.content),i=await Promise.all(a.map(async(s,c)=>{let[d,f]=await s,v=o[c].title;return r[c].innerHTML=We(d,r[c].id,v),f}).flat());return n},Wn=({components:e,productCTA:n,unavEnabled:t})=>`
<nav>
  <ul>
