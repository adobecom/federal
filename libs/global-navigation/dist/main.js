var pe=async e=>{let{placeholders:n}=e,{locale:t}=v(),o=`${z()}${t.prefix}/federal/globalnav/placeholders.json`,[a,i]=await Promise.all([n,rn(o)]);return new Map([...i,...a])},rn=async e=>{try{let n=await fetch(e);if(!n.ok)throw new p(`Federal placeholders not found at ${e}`);let t=on(await n.json());if(t instanceof p)throw t;return new Map(t.data.map(({key:r,value:o})=>[r,o]))}catch(n){if(n instanceof p)console.error(n.message);else{let t=new p(n.message);console.error(t.message)}return g(`Failed to fetch placeholders from ${e}`),new Map([])}},on=e=>{try{let{data:n}=e;if(!n.every(({key:r,value:o})=>typeof r=="string"&&typeof o=="string"))throw new Error("data is not valid");return e}catch(n){return new p(n.message)}};function ue(e,n){let t=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return t.test(e)?e.replace(t,(o,a,i)=>{let l=a??i??"";return n.get(l)??l}):e}var[fe,ge]=(()=>{let e;return[n=>{e||(e=n)},()=>{if(!e)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return e}]})();var S=window.matchMedia("(min-width: 900px)"),$={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',arrowBack:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" fill="currentColor"/></svg>'};var me=e=>{let n=[],t=e.nextElementSibling??null;for(;t!==null;)n.push(t),t=t.nextElementSibling??null;return n},U=e=>({eval:e,or:n=>U(t=>{try{return e(t)}catch{return n(t)}})}),b=(e,n)=>e.reduce(([t,r],o)=>{try{let[a,i]=n(o);return[[...t,a],[...r,...i]]}catch(a){return a instanceof s?[t,[a,...r]]:[t,r]}},[[],[]]),ve=({mobileEventListeners:e,desktopEventListeners:n})=>t=>{let r;S.matches?r=n(t):r=e(t),S.addEventListener("change",()=>{r?.(),r=S.matches?n(t):e(t);let o=t.querySelector("#feds-menu-wrapper");o?.matches(":popover-open")===!0&&o.hidePopover?.()})},[he,an]=(()=>{let e,n=!1;return[t=>{n||(e=t,n=!0)},()=>{if(!e)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return e}]})(),A=async e=>{try{if(e===null)return new s("URL is null");let n=ye(`${e.origin}${e.pathname.replace(/(\.html$|$)/,".plain.html")}${e.hash}`),t=await fetch(n);if(!t.ok)return g(`Request for ${n} failed`),new s(`Request for ${n} failed`);let r=await t.text(),o=await ge(),a=ue(r,o),{body:i}=new DOMParser().parseFromString(a,"text/html");try{let{handleCommands:l,commands:c}=an();l(c,i)}catch(l){g(`Personalization not applied: ${l?.message}`)}return i}catch(n){return new s(n?.message)}},L,z=()=>{if(L)return L;let e=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(L)return L;let n=window.location.origin;L=e.some(o=>{let a=n.replace(".stage","");return o.startsWith("https://")?a===o:a.endsWith(o)})?n:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(n.includes("localhost")||n.includes(`.${r}.`))&&(L=`https://main--federal--adobecom.aem.${n.endsWith(".live")?"live":"page"}`),L},ye=(e="")=>{if(e.includes("c2-poc--milo--adobecom"))return e.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(e.includes("c2-poc-feds-gnav--milo--adobecom"))return e.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(e.includes("localhost:3000"))return e.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof e!="string"||!e.includes("/federal/"))return e;if(e.startsWith("/"))return`${z()}${e}`;try{let{pathname:n,search:t,hash:r}=new URL(e);return`${z()}${n}${t}${r}`}catch(n){let t=n instanceof Error?n.message:String(n);console.warn(`getFederatedUrl errored parsing the URL: ${e}: ${t}`)}return e},be=async e=>{let n=async(t,r)=>{if(t instanceof s)return t;try{let a=[...t.querySelectorAll('a[href*="#_inline"]')].map(async i=>{try{if(r.has(i.href))return;let l=ye(i.href),c=new URL(l),d=await A(c);if(r.add(i.href),d instanceof s)throw d;await n(d,r),i.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(a),t}catch(o){return new s(JSON.stringify(o))}};return n(e,new Set)},xe=(e,n)=>e.map(t=>`<li>${n(t)}</li>`).join(""),H=e=>e.toLowerCase().trim().replace(/[^a-z0-9]/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").replace(/^(\d)/,"id-$1"),we=()=>!0;function sn(e,{id:n,as:t,callback:r,crossorigin:o,rel:a,fetchpriority:i}={rel:"stylesheet"}){let l=document.head.querySelector(`link[href="${e}"]`);if(l)return r?.("noop"),l;let c=document.createElement("link");return c.setAttribute("rel",a),n!==void 0&&c.setAttribute("id",n),t!==void 0&&c.setAttribute("as",t),o!==void 0&&c.setAttribute("crossorigin",o),i!==void 0&&c.setAttribute("fetchpriority",i),c.setAttribute("href",e),r&&(c.onload=d=>r(d.type),c.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(c),c}function ln(e,n){return sn(e,{rel:"stylesheet",callback:n})}function Q(e,n=!1){n&&ln(e)}var ee=(e,n,{mode:t,id:r}={})=>new Promise((o,a)=>{let i=document.querySelector(`head > script[src="${e}"]`);if(!i){let{head:d}=document;i=document.createElement("script"),i.setAttribute("src",e),r!=null&&i.setAttribute("id",r),n!=null&&i.setAttribute("type",n),t&&["async","defer"].includes(t)&&i.setAttribute(t,""),d.append(i)}let l=i.dataset.loaded;if(l!=null){o(i);return}let c=d=>{i.removeEventListener("load",c),i.removeEventListener("error",c),d.type==="error"?a(new Error(`error loading script: ${i.src}`)):d.type==="load"&&(i.dataset.loaded="true",o(i))};i.addEventListener("load",c),i.addEventListener("error",c)});function G(e,n=document){let t=e&&e.includes(":")?"property":"name";return n.head.querySelector(`meta[${t}="${e}"]`)?.content??null}var cn=e=>{let n=e,t=a=>a==null||typeof a!="object";if(t(n)||t(n.locale)||typeof n.locale.prefix!="string"||t(n.env)||typeof n.env.name!="string")return!1;if(n.unav!==void 0){if(typeof n.unav!="object"||n.unav===null)return!1;let a=n.unav;if(a.profile!==void 0){if(typeof a.profile!="object"||a.profile===null)return!1;let i=a.profile;if(i.signInCtaStyle!==void 0&&i.signInCtaStyle!=="primary"&&i.signInCtaStyle!=="secondary"||i.messageEventListener!==void 0&&typeof i.messageEventListener!="function")return!1}}return!(n.jarvis!==void 0&&(typeof n.jarvis!="object"||n.jarvis===null||typeof n.jarvis.id!="string"))},[ne,v]=(()=>{let e,n=!1;return[t=>{if(!n){if(!cn(t))throw new Error("MiloConfig validation failed: Invalid structure");e=t,n=!0}},()=>{if(!e)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return e}]})(),dn={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},Ce={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function pn(e){let n=dn[e];return!n&&Ce[e]&&(n=e),!n&&e.includes("-")&&([n]=e.split("-")),n||"US"}var Y="langstore/";function Le(e){let t=(e?.prefix||"US_en").replace("/","")??"",[r="US",o="en"]=(Ce[t]??t).split("_",2);if(t.startsWith(Y)||window.location.pathname.startsWith(`/${Y}`)){let a=t.replace(Y,"").toLowerCase();r=pn(a),o=a}return r=r.toUpperCase(),o=o.toLowerCase(),{language:o,country:r,locale:`${o}_${r}`}}var O={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},h=e=>{if(e===null)throw new s(O.elementNull);if(e.tagName!=="A")throw new s(O.notAnchor);let n=e?.textContent??"";if(n==="")throw new s(O.textContentNotFound);let t=e?.getAttribute("href")??"";if(t==="")throw new s(O.hrefNotFound);return[{type:"Link",text:n,href:t},[]]};var te=e=>U(fn).or(un).or(gn).eval(e),x={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class"},un=e=>{let n=new Set;if(!e)throw new s(x.elementNull);let t=e.querySelector("p a")??e.querySelector("div ~ div > a");if(!t)throw new s(x.noTitleAnchor);let r=t.textContent??"";r===""&&n.add(new p(x.noTitle));let o=t.getAttribute("href")??"";o===""&&n.add(new p(x.noHref));let a=t?.closest("p")?.nextElementSibling;a||n.add(new p(x.noSubtitleP));let i=a?.textContent??"";i===""&&n.add(new p(x.noSubtitle));let[l,c=null]=(e.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(d=>d.trim());return[{type:"LinkGroupLink",iconHref:l,iconAlt:c,title:r,href:o,subtitle:i},[...n]]},fn=e=>{if(!e)throw new s(x.elementNull);let n=[...e.classList];if(!n.includes("header"))throw new s(x.notAHeader);let t=e.querySelector("a")?.textContent??"";if(t==="")throw new s(x.noTitle);return[{type:"LinkGroupHeader",title:t,classes:n},[]]},gn=e=>{if(!e)throw new s(x.elementNull);if(!e.classList.contains("blue"))throw new Error("Not a Blue Link Group");let n=e.querySelector("a"),[t,r]=h(n);return[{type:"LinkGroupBlue",link:t},r]};var re=e=>{switch(e.type){case"LinkGroupHeader":return mn(e);case"LinkGroupLink":return vn(e);case"LinkGroupBlue":return hn(e);default:return console.error(e),""}},mn=({title:e,classes:n})=>`
  ...
  `,vn=({iconHref:e,iconAlt:n,title:t,href:r,subtitle:o})=>{let i=n!==null&&e!==null?`
...
`;var F={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},_=/(\.png|\.jpg|\.jpeg|\.svg)/i,yn=e=>{let n=e.querySelector("picture img")?.getAttribute("src")??null;if(n!==null&&n!=="")return n;let t=e.textContent?.trim();if(t!==void 0&&t!==""&&_.test(t)){let o=t.split("|")[0]?.trim();if(o!==void 0&&o!=="")return o}let r=e.getAttribute("href");return r!==null&&r!==""&&_.test(r)?r:null},bn=e=>{let n=e.textContent?.trim();if(n?.includes("|")===!0){let r=n.split("|")[1]?.trim();if(r)return r}return e.querySelector("img")?.getAttribute("alt")??""},oe=e=>{if(e===null)throw new s(F.elementNull);let n=e.querySelector(".gnav-brand");if(n===null)throw new s(F.elementNull);let t=[...n.querySelectorAll("a")];if(t.length===0)throw new s(F.noLinks);let r=t.find(u=>{let f=u.textContent??"";return!_.test(u.href)&&!_.test(f)});if(!r)throw new s(F.noPrimaryLink);let o=n.matches(".brand-image-only"),a=n.matches(".no-logo"),i=n.matches(".image-only"),l=!a,c=!o&&!i,d=t.filter(u=>{let f=u.textContent??"";return _.test(u.href)||_.test(f)}),[m,y,T]=(()=>{let u=o?$.brand:$.company,[f=null,C=null]=[...n.querySelectorAll('picture img[src$=".svg"]')].map(X=>X?.src).filter(X=>X?.length>0),[D=null,nn=null]=d.map(yn),tn=d[0]instanceof Element?bn(d[0]):r.textContent?.trim()??"";return[D??f??u,nn??C,tn]})(),w=r.textContent?.trim()??"",M=r.href;if(!l&&!c)return[{type:"Brand",data:{type:"NoRender"}},[]];let R=(u,f)=>{let C=f!=null&&f!=="";return we()&&C?f:u},P=m.startsWith("<svg")?{type:"inline-svg",svgContent:R(m,y),alt:T}:{type:"image",src:R(m,y),alt:T};return l&&c?[{type:"Brand",data:{type:"LabelledBrand",href:M,label:w,image:P}},[]]:l&&o?[{type:"Brand",data:{type:"BrandImageOnly",href:M,image:P,alt:T}},[]]:l&&i?[{type:"Brand",data:{type:"ImageOnlyBrand",href:M,image:P,alt:T}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:M,label:w}},[]]};var xn=`.feds-brand-container {
    display: flex;
    flex-shrink: 0;
}
...
`,Ae=e=>e.type==="PrimaryCTA"?ce(e):E(e);var I=({text:e,href:n})=>`<a class="feds-link" href="${n}">${e}</a>`;var _e=e=>{let[n,t]=Mn(e);return[{type:"LinksCard",card:n},t]},Mn=e=>{let n=e.querySelector("h1, h2, h3")||null;if(!n)throw new s("Expected links card title");let t=e.querySelector("em > a"),r=[...e.querySelectorAll("a")].filter(c=>c!==t);if(r.length===0)throw new s("Expected at least one link");let[o,a]=b(r,h),[i,l]=(()=>{try{return k(e)}catch{return[null,[]]}})();return[{type:"LinksCardItem",title:n.textContent??"",links:o,footerCTA:i},[...a,...l]]};var Ie=e=>{let n=[...e.querySelectorAll("li > div")],[t,r]=b(n,Pn);return console.log(t),[{type:"ProductList",categories:t},r]},Pn=e=>{let n=e.firstElementChild;if(n?.nodeName!=="H2")throw new s("Expected H2");let t=n.textContent??"",r=me(n),[o,a]=b(r,te);return[{type:"ProductCategory",name:t,links:o},a]};var Re=e=>{let[n,t]=Sn(e);return[{type:"FeaturedCard",card:n},t]},Sn=e=>{let n=e.querySelector("h3")||null;if(!n)throw new p("Eye brow element not found");let t=e.querySelector("h1")||null,r=t?.nextElementSibling||null;if(!t)throw new s("Expected title");if(!r)throw new s("Expected subtitle");let o=r.nextElementSibling?.firstElementChild||null;if(!o)throw new s("Expected card link after subtitle");let[a,i]=h(o),[l,c]=k(e);return[{type:"Card",title:t.textContent??"",subtitle:r.textContent??"",bodyLink:a,footerCTA:l,eyeBrow:n.textContent??""},[...c,...i]]};var Ue=e=>{let n=new Set;if(e===null)throw new s($e.elementNull);let t=e.querySelector("h2")?.textContent??"";t===""&&n.add(new p($e.noTitle));let r=(async()=>{try{let o=e.querySelector("a"),a=new URL(o?.href??""),i=await A(a);if(i instanceof s)throw new Error(i.message);let l=await be(i);if(l instanceof s)throw new Error(l.message);return e.classList.contains("product-list")?Ie(l):An(l)}catch(o){throw new s(o?.message)}})();if(r instanceof s)throw r;return[{type:"MegaMenu",title:t,content:r},[...n]]},$e={elementNull:"Element is null",noTitle:"Large Menu has no Title"},An=e=>{let n=[...e.children].filter(a=>a.classList.contains("featured-card")||a.classList.contains("links-card")),t=n.length>0?n:[...e.querySelectorAll(".featured-card, .links-card")];if(t.length===0)throw new s("Unrecognized mega menu item (did you forget to label it correctly?)");let[r,o]=b(t,_n);if(r.length===0)throw new s("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},o]},_n=e=>{if(e.classList.contains("featured-card"))return Re(e);if(e.classList.contains("links-card"))return _e(e);throw new s("Unsupported gnav cards section")};var In=`.feds-popup .featured-card .featured-eyebrow {
  color: #7a7474;
...
`,He=document.createElement("style");He.textContent=In;document.head.appendChild(He);var Ge=({card:e})=>Rn(e),Rn=({title:e,subtitle:n,eyeBrow:t,footerCTA:r,bodyLink:o})=>`
...
`.trim();var $n=`.feds-popup .links-card {
  border-radius: 14px;
  background: #f6f6f6;
  box-sizing: border-box;
  display: flex;
...
`,Ne=document.createElement("style");Ne.textContent=$n;document.head.appendChild(Ne);var Be=({card:e})=>Un(e),Un=({title:e,links:n,footerCTA:t})=>`
...
`,De=document.createElement("style");De.textContent=Hn;document.head.appendChild(De);var ze=({sections:e})=>`
  <ul class="feds-gnav-cards">
    ${e.map(n=>{switch(n.type){case"FeaturedCard":return`<li>${Ge(n)}</li>`;case"LinksCard":return`<li>${Be(n)}</li>`;default:}return""}).join("")}
  </ul>
`;var Gn=`.feds-popup .product-list {
  display: grid;
...
`,Oe=document.createElement("style");Oe.textContent=Gn;document.head.appendChild(Oe);var Fe=({categories:e})=>{let n=`
...
`,qe=(e,n,t)=>{let r=`
  ...
  `.trim(),o="";switch(e.type){case"ProductList":o=Fe(e);break;case"GnavCards":o=ze(e);break;default:}return`${r}${o}`};var We={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},Ze=e=>{if(e===null)return[{type:"Text",content:""},[new p(We.elementNull,"Minor")]];let n=e.textContent;return n===null?[{type:"Text",content:""},[new p(We.textContentNull,"Minor")]]:[{type:"Text",content:n},[]]};var Ve=({content:e})=>e;var Ke=e=>{if(e===null)throw new s(Nn.elementNull);if(e.querySelector(".gnav-brand")!==null)return oe(e);let t=e.querySelector(".large-menu");return t!==null?Ue(t):e.querySelector("strong")!==null?le(e):e.querySelector("em")!==null?k(e):e.querySelector("a")===null?Ze(e):h(e.querySelector("a"))},de=e=>{switch(e.type){case"Text":return Ve(e);case"Link":return I(e);case"SecondaryCTA":return E(e);case"PrimaryCTA":return ce(e);case"Brand":return ae(e);case"MegaMenu":return je(e);default:return console.error(`Failed to recognize component: ${e}`),""}},Nn={elementNull:"Element is null"};var Je=(e,n)=>{let[t,r]=b([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],h),[o,a]=b([...e.children],Ke),i=e.querySelector(".product-entry-cta"),[l,c]=(()=>{try{return Se(i)}catch{return[null,[]]}})(),d=!1,m=[r,a,c].flat();return{breadcrumbs:t,components:o,productCTA:l,localnav:d,errors:m,unavEnabled:n}};var Bn=e=>{let n=[...e.querySelectorAll('.tabs button[role="tab"]')],t=[...e.querySelectorAll(".tab-content ul")],r=n.map((o,a)=>()=>{n.forEach(i=>{i.setAttribute("aria-selected","false")}),t.forEach(i=>{i.setAttribute("hidden","true")}),t[a]?.removeAttribute("hidden"),o.setAttribute("aria-selected","true")});return n.forEach((o,a)=>{o.addEventListener("click",r[a])}),()=>{n.forEach((o,a)=>{o.removeEventListener("click",r[a])})}};var Xe=Bn;var Dn=e=>()=>console.log(e),zn=e=>()=>console.log(e),Ye=ve({mobileEventListeners:zn,desktopEventListeners:Dn});var Qe=async({gnavSource:e,asideSource:n})=>{let t=await A(e);if(t instanceof s)return t;let r=await A(n);return{mainNav:t,aside:r}};var On=`/**
...
`,en=document.createElement("style");en.textContent=On;document.head.appendChild(en);var zo=async e=>{let{gnavSource:n,mountpoint:t,unavEnabled:r,miloConfig:o,personalization:a}=e;if(!(n instanceof URL))throw g(`gnavSource is invalid: ${n}`),new s("gnavSource needs to be a URL object");try{ne(o)}catch(m){throw g(`Failed to initialize MiloConfig: ${m}`),new s(`Failed to initialize MiloConfig: ${m}`)}he(a),fe(pe(e));let i=await Qe(e);if(i instanceof s)throw g(i.message),i;let{mainNav:l,aside:c}=i;if(l instanceof s)throw g(l.message),l;let d=Je(l,r);if(d instanceof s)throw g(d.message),d;return await Fn(d)(t),qn(e)},Fn=e=>async n=>{let t=jn(e);n.innerHTML=t,n.classList.add("site-pivot");let r=[...n.querySelectorAll(".mega-menu ~ .feds-popup")];r.forEach(l=>{l.innerHTML=""});let o=e.components.filter(l=>l.type==="MegaMenu"),a=o.map(l=>l.content),i=await Promise.all(a.map(async(l,c)=>{let[d,m]=await l,y=o[c].title;return r[c].innerHTML=qe(d,r[c].id,y),m}).flat());return n},jn=({components:e,productCTA:n,unavEnabled:t})=>`
<nav>
  <ul>
...
`,qn=async e=>{let n=new Set,t=await J(e.mountpoint);t instanceof p?(n.add(t),g(t.message)):t.errors.forEach(o=>n.add(o)),Xe(e.mountpoint),Ye(e.mountpoint);let r=t instanceof p?()=>{}:t.reloadUnav;return{closeEverything:Wn,reloadUnav:r,errors:n,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},Wn=()=>{};export{zo as main,qn as postRenderingTasks,Fn as renderGnav,jn as renderGnavString};
