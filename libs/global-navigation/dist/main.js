var ue=async e=>{let{placeholders:n}=e,{locale:t}=y(),o=`${O()}${t.prefix}/federal/globalnav/placeholders.json`,[a,i]=await Promise.all([n,on(o)]);return new Map([...i,...a])},on=async e=>{try{let n=await fetch(e);if(!n.ok)throw new p(`Federal placeholders not found at ${e}`);let t=an(await n.json());if(t instanceof p)throw t;return new Map(t.data.map(({key:r,value:o})=>[r,o]))}catch(n){if(n instanceof p)console.error(n.message);else{let t=new p(n.message);console.error(t.message)}return v(`Failed to fetch placeholders from ${e}`),new Map([])}},an=e=>{try{let{data:n}=e;if(!n.every(({key:r,value:o})=>typeof r=="string"&&typeof o=="string"))throw new Error("data is not valid");return e}catch(n){return new p(n.message)}};function fe(e,n){let t=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return t.test(e)?e.replace(t,(o,a,i)=>{let s=a??i??"";return n.get(s)??s}):e}var[ge,me]=(()=>{let e;return[n=>{e||(e=n)},()=>{if(!e)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return e}]})();var $=window.matchMedia("(min-width: 900px)"),U={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',arrowBack:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" fill="currentColor"/></svg>'};var he=e=>{let n=[],t=e.nextElementSibling??null;for(;t!==null;)n.push(t),t=t.nextElementSibling??null;return n},H=e=>({eval:e,or:n=>H(t=>{try{return e(t)}catch{return n(t)}})}),x=(e,n)=>e.reduce(([t,r],o)=>{try{let[a,i]=n(o);return[[...t,a],[...r,...i]]}catch(a){return a instanceof l?[t,[a,...r]]:[t,r]}},[[],[]]),ve=({mobileEventListeners:e,desktopEventListeners:n})=>t=>{let r;$.matches?r=n(t):r=e(t),$.addEventListener("change",()=>{r?.(),r=$.matches?n(t):e(t);let o=t.querySelector("#feds-menu-wrapper");o?.matches(":popover-open")===!0&&o.hidePopover?.()})},[ye,sn]=(()=>{let e,n=!1;return[t=>{n||(e=t,n=!0)},()=>{if(!e)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return e}]})(),R=async e=>{try{if(e===null)return new l("URL is null");let n=be(`${e.origin}${e.pathname.replace(/(\.html$|$)/,".plain.html")}${e.hash}`),t=await fetch(n);if(!t.ok)return v(`Request for ${n} failed`),new l(`Request for ${n} failed`);let r=await t.text(),o=await me(),a=fe(r,o),{body:i}=new DOMParser().parseFromString(a,"text/html");try{let{handleCommands:s,commands:c}=sn();s(c,i)}catch(s){v(`Personalization not applied: ${s?.message}`)}return i}catch(n){return new l(n?.message)}},P,O=()=>{if(P)return P;let e=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(P)return P;let n=window.location.origin;P=e.some(o=>{let a=n.replace(".stage","");return o.startsWith("https://")?a===o:a.endsWith(o)})?n:"https://www.adobe.com";let r=window.location.hostname.includes(".aem.")?"aem":"hlx";return(n.includes("localhost")||n.includes(`.${r}.`))&&(P=`https://main--federal--adobecom.aem.${n.endsWith(".live")?"live":"page"}`),P},be=(e="")=>{if(e.includes("c2-poc--milo--adobecom"))return e.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(e.includes("c2-poc-feds-gnav--milo--adobecom"))return e.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(e.includes("localhost:3000"))return e.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof e!="string"||!e.includes("/federal/"))return e;if(e.startsWith("/"))return`${O()}${e}`;try{let{pathname:n,search:t,hash:r}=new URL(e);return`${O()}${n}${t}${r}`}catch(n){let t=n instanceof Error?n.message:String(n);console.warn(`getFederatedUrl errored parsing the URL: ${e}: ${t}`)}return e},xe=async e=>{let n=async(t,r)=>{if(t instanceof l)return t;try{let a=[...t.querySelectorAll('a[href*="#_inline"]')].map(async i=>{try{if(r.has(i.href))return;let s=be(i.href),c=new URL(s),d=await R(c);if(r.add(i.href),d instanceof l)throw d;await n(d,r),i.replaceWith(...d.children);return}catch{return}},[]);return await Promise.all(a),t}catch(o){return new l(JSON.stringify(o))}};return n(e,new Set)},we=(e,n)=>e.map(t=>`<li>${n(t)}</li>`).join(""),G=e=>e.toLowerCase().trim().replace(/[^a-z0-9]/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").replace(/^(\d)/,"id-$1"),E=(e,n)=>{let t=e!==null&&e!==""?` daa-lh="${e}"`:"",r=n!==null&&n!==""?` daa-ll="${n}"`:"";return`${t}${r}`},ke=()=>!0;function ln(e,{id:n,as:t,callback:r,crossorigin:o,rel:a,fetchpriority:i}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${e}"]`);if(s)return r?.("noop"),s;let c=document.createElement("link");return c.setAttribute("rel",a),n!==void 0&&c.setAttribute("id",n),t!==void 0&&c.setAttribute("as",t),o!==void 0&&c.setAttribute("crossorigin",o),i!==void 0&&c.setAttribute("fetchpriority",i),c.setAttribute("href",e),r&&(c.onload=d=>r(d.type),c.onerror=d=>r(typeof d=="string"?"error":d.type)),document.head.appendChild(c),c}function cn(e,n){return ln(e,{rel:"stylesheet",callback:n})}function ee(e,n=!1){n&&cn(e)}var ne=(e,n,{mode:t,id:r}={})=>new Promise((o,a)=>{let i=document.querySelector(`head > script[src="${e}"]`);if(!i){let{head:d}=document;i=document.createElement("script"),i.setAttribute("src",e),r!=null&&i.setAttribute("id",r),n!=null&&i.setAttribute("type",n),t&&["async","defer"].includes(t)&&i.setAttribute(t,""),d.append(i)}let s=i.dataset.loaded;if(s!=null){o(i);return}let c=d=>{i.removeEventListener("load",c),i.removeEventListener("error",c),d.type==="error"?a(new Error(`error loading script: ${i.src}`)):d.type==="load"&&(i.dataset.loaded="true",o(i))};i.addEventListener("load",c),i.addEventListener("error",c)});function N(e,n=document){let t=e&&e.includes(":")?"property":"name";return n.head.querySelector(`meta[${t}="${e}"]`)?.content??null}var dn=e=>{let n=e,t=a=>a==null||typeof a!="object";if(t(n)||t(n.locale)||typeof n.locale.prefix!="string"||t(n.env)||typeof n.env.name!="string")return!1;if(n.unav!==void 0){if(typeof n.unav!="object"||n.unav===null)return!1;let a=n.unav;if(a.profile!==void 0){if(typeof a.profile!="object"||a.profile===null)return!1;let i=a.profile;if(i.signInCtaStyle!==void 0&&i.signInCtaStyle!=="primary"&&i.signInCtaStyle!=="secondary"||i.messageEventListener!==void 0&&typeof i.messageEventListener!="function")return!1}}return!(n.jarvis!==void 0&&(typeof n.jarvis!="object"||n.jarvis===null||typeof n.jarvis.id!="string"))},[te,y]=(()=>{let e,n=!1;return[t=>{if(!n){if(!dn(t))throw new Error("MiloConfig validation failed: Invalid structure");e=t,n=!0}},()=>{if(!e)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return e}]})(),pn={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},Ce={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function un(e){let n=pn[e];return!n&&Ce[e]&&(n=e),!n&&e.includes("-")&&([n]=e.split("-")),n||"US"}var Q="langstore/";function Le(e){let t=(e?.prefix||"US_en").replace("/","")??"",[r="US",o="en"]=(Ce[t]??t).split("_",2);if(t.startsWith(Q)||window.location.pathname.startsWith(`/${Q}`)){let a=t.replace(Q,"").toLowerCase();r=un(a),o=a}return r=r.toUpperCase(),o=o.toLowerCase(),{language:o,country:r,locale:`${o}_${r}`}}var j={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},h=e=>{if(e===null)throw new l(j.elementNull);if(e.tagName!=="A")throw new l(j.notAnchor);let n=e?.textContent??"";if(n==="")throw new l(j.textContentNotFound);let t=e?.getAttribute("href")??"";if(t==="")throw new l(j.hrefNotFound);let r=e.getAttribute("daa-ll");return[{type:"Link",text:n,href:t,daaLl:r},[]]};var re=e=>H(gn).or(fn).or(mn).eval(e),C={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class"},fn=e=>{let n=new Set;if(!e)throw new l(C.elementNull);let t=e.querySelector("p a")??e.querySelector("div ~ div > a");if(!t)throw new l(C.noTitleAnchor);let r=t.textContent??"";r===""&&n.add(new p(C.noTitle));let o=t.getAttribute("href")??"";o===""&&n.add(new p(C.noHref));let a=t.getAttribute("daa-ll"),i=t.getAttribute("daa-lh"),s=t?.closest("p")?.nextElementSibling;s||n.add(new p(C.noSubtitleP));let c=s?.textContent??"";c===""&&n.add(new p(C.noSubtitle));let d=[],f=null,g=null;e.classList.contains("new")&&d.push("New"),e.classList.contains("show-offer")&&(d.push("Save 20%"),f="$29.99",g="$19.99");let[w,b=null]=(e.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(k=>k.trim());return[{type:"LinkGroupLink",iconHref:w,iconAlt:b,title:r,href:o,subtitle:c,badges:d,oldPrice:f,newPrice:g,daaLl:a,daaLh:i},[...n]]},gn=e=>{if(!e)throw new l(C.elementNull);let n=[...e.classList];if(!n.includes("header"))throw new l(C.notAHeader);let t=e.querySelector("a")?.textContent??"",r=e.querySelector("a")?.getAttribute("daa-ll")??null,o=e.querySelector("a")?.getAttribute("daa-lh")??null;if(t==="")throw new l(C.noTitle);return[{type:"LinkGroupHeader",title:t,classes:n,daaLl:r,daaLh:o},[]]},mn=e=>{if(!e)throw new l(C.elementNull);if(!e.classList.contains("blue"))throw new Error("Not a Blue Link Group");let n=e.querySelector("a"),[t,r]=h(n),o=n?.getAttribute("daa-ll")??null,a=n?.getAttribute("daa-lh")??null;return[{type:"LinkGroupBlue",link:t,daaLl:o,daaLh:a},r]};var oe=e=>{switch(e.type){case"LinkGroupHeader":return hn(e);case"LinkGroupLink":return vn(e);case"LinkGroupBlue":return yn(e);default:return console.error(e),""}},hn=({title:e,classes:n,daaLl:t,daaLh:r})=>{let o=n.slice(1).map(i=>`feds-link-group--${i}`).join(" "),a=E(r,t??e);return`
  ...
  `},vn=({iconHref:e,iconAlt:n,title:t,href:r,subtitle:o,badges:a=[],oldPrice:i=null,newPrice:s=null,daaLl:c,daaLh:d})=>{let f=n!==null&&e!==null,g=E(d,c??t),w=f?`
    ...
    `,k=o===""?"":`<div class="feds-link-group__subtitle">${o}</div>`,M=i===null&&s===null?"":`
  ...
  `},yn=({link:e,daaLl:n,daaLh:t})=>{let r=E(t,n??e.text);return`
  <a href="${e.href}" class="feds-link-group feds-link-group--blue"${r}>
    <div class="feds-link-group__content">
        <div class="feds-link-group__title">${e.text}</div>
      </div>
  </a>
`};var F={elementNull:"Error when parsing Brand. Element is null",noLinks:"Error when parsing Brand. No links found",noPrimaryLink:"Error when parsing Brand. No primary link found"},I=/(\.png|\.jpg|\.jpeg|\.svg)/i,bn=e=>{let n=e.querySelector("picture img")?.getAttribute("src")??null;if(n!==null&&n!=="")return n;let t=e.textContent?.trim();if(t!==void 0&&t!==""&&I.test(t)){let o=t.split("|")[0]?.trim();if(o!==void 0&&o!=="")return o}let r=e.getAttribute("href");return r!==null&&r!==""&&I.test(r)?r:null},xn=e=>{let n=e.textContent?.trim();if(n?.includes("|")===!0){let r=n.split("|")[1]?.trim();if(r)return r}return e.querySelector("img")?.getAttribute("alt")??""},ie=e=>{if(e===null)throw new l(F.elementNull);let n=e.querySelector(".gnav-brand");if(n===null)throw new l(F.elementNull);let t=[...n.querySelectorAll("a")];if(t.length===0)throw new l(F.noLinks);let r=t.find(u=>{let m=u.textContent??"";return!I.test(u.href)&&!I.test(m)});if(!r)throw new l(F.noPrimaryLink);let o=n.matches(".brand-image-only"),a=n.matches(".no-logo"),i=n.matches(".image-only"),s=!a,c=!o&&!i,d=t.filter(u=>{let m=u.textContent??"";return I.test(u.href)||I.test(m)}),[f,g,w]=(()=>{let u=o?U.brand:U.company,[m=null,S=null]=[...n.querySelectorAll('picture img[src$=".svg"]')].map(Y=>Y?.src).filter(Y=>Y?.length>0),[z=null,tn=null]=d.map(bn),rn=d[0]instanceof Element?xn(d[0]):r.textContent?.trim()??"";return[z??m??u,tn??S,rn]})(),b=r.textContent?.trim()??"",k=r.href;if(!s&&!c)return[{type:"Brand",data:{type:"NoRender"}},[]];let M=(u,m)=>{let S=m!=null&&m!=="";return ke()&&S?m:u},L=f.startsWith("<svg")?{type:"inline-svg",svgContent:M(f,g),alt:w}:{type:"image",src:M(f,g),alt:w};return s&&c?[{type:"Brand",data:{type:"LabelledBrand",href:k,label:b,image:L}},[]]:s&&o?[{type:"Brand",data:{type:"BrandImageOnly",href:k,image:L,alt:w}},[]]:s&&i?[{type:"Brand",data:{type:"ImageOnlyBrand",href:k,image:L,alt:w}},[]]:[{type:"Brand",data:{type:"BrandLabelOnly",href:k,label:b}},[]]};var wn=`.feds-brand-container {
    display: flex;
    flex-shrink: 0;
}
...
`,Ae=e=>e.type==="PrimaryCTA"?de(e):A(e);var T=({text:e,href:n,daaLl:t})=>`<a class="feds-link" href="${n}"${E(null,t??e)}>${e}</a>`;var $e=e=>{let[n,t]=Sn(e);return[{type:"LinksCard",card:n},t]},Sn=e=>{let n=e.querySelector("h1, h2, h3")||null;if(!n)throw new l("Expected links card title");let t=e.querySelector("em > a"),r=[...e.querySelectorAll("a")].filter(c=>c!==t);if(r.length===0)throw new l("Expected at least one link");let[o,a]=x(r,h),[i,s]=(()=>{try{return _(e)}catch{return[null,[]]}})();return[{type:"LinksCardItem",title:n.textContent??"",links:o,footerCTA:i},[...a,...s]]};var Re=e=>{let n=[...e.querySelectorAll("li > div")],t=[...e.querySelectorAll("li > a")],[r,o]=x(n,Pn),[a,i]=x(t,h);return[{type:"ProductList",categories:r,links:a},[...o,...i]]},Pn=e=>{let n=e.firstElementChild;if(n?.nodeName!=="H2")throw new l("Expected H2");let t=n.textContent??"",r=n.textContent??"",o=he(n),[a,i]=x(o,re);return[{type:"ProductCategory",name:t,daaLh:r,links:a},i]};var Ie=e=>{let[n,t]=_n(e);return[{type:"FeaturedCard",card:n},t]},_n=e=>{let n=e.querySelector("h3")||null;if(!n)throw new p("Eye brow element not found");let t=e.querySelector("h1")||null,r=t?.nextElementSibling||null;if(!t)throw new l("Expected title");if(!r)throw new l("Expected subtitle");let o=r.nextElementSibling?.firstElementChild||null;if(!o)throw new l("Expected card link after subtitle");let[a,i]=h(o),[s,c]=_(e);return[{type:"Card",title:t.textContent??"",subtitle:r.textContent??"",bodyLink:a,footerCTA:s,eyeBrow:n.textContent??""},[...c,...i]]};var He=e=>{let n=new Set;if(e===null)throw new l(Ue.elementNull);let t=e.querySelector("h2")?.textContent??"";t===""&&n.add(new p(Ue.noTitle));let r=(async()=>{try{let o=e.querySelector("a"),a=new URL(o?.href??""),i=await R(a);if(i instanceof l)throw new Error(i.message);let s=await xe(i);if(s instanceof l)throw new Error(s.message);return e.classList.contains("product-list")?Re(s):An(s)}catch(o){throw new l(o?.message)}})();if(r instanceof l)throw r;return[{type:"MegaMenu",title:t,content:r},[...n]]},Ue={elementNull:"Element is null",noTitle:"Large Menu has no Title"},An=e=>{let n=[...e.children].filter(a=>a.classList.contains("featured-card")||a.classList.contains("links-card")),t=n.length>0?n:[...e.querySelectorAll(".featured-card, .links-card")];if(t.length===0)throw new l("Unrecognized mega menu item (did you forget to label it correctly?)");let[r,o]=x(t,$n);if(r.length===0)throw new l("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},o]},$n=e=>{if(e.classList.contains("featured-card"))return Ie(e);if(e.classList.contains("links-card"))return $e(e);throw new l("Unsupported gnav cards section")};var Rn=`.feds-popup .featured-card .featured-eyebrow {
  color: #7a7474;
