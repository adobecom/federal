var yn=async n=>{let{placeholders:e}=n,{locale:r}=k(),a=`${Z()}${r.prefix}/federal/globalnav/placeholders.json`,[o,i]=await Promise.all([e,se(a)]);return new Map([...i,...o])},se=async n=>{try{let e=await fetch(n);if(!e.ok)throw new u(`Federal placeholders not found at ${n}`);let r=le(await e.json());if(r instanceof u)throw r;return new Map(r.data.map(({key:t,value:a})=>[t,a]))}catch(e){if(e instanceof u)console.error(e.message);else{let r=new u(e.message);console.error(r.message)}return L(`Failed to fetch placeholders from ${n}`),new Map([])}},le=n=>{try{let{data:e}=n;if(!e.every(({key:t,value:a})=>typeof t=="string"&&typeof a=="string"))throw new Error("data is not valid");return n}catch(e){return new u(e.message)}};function xn(n,e){let r=/{{(.*?)}}|%7B%7B(.*?)%7D%7D/g;return r.test(n)?n.replace(r,(a,o,i)=>{let s=o??i??"";return e.get(s)??s}):n}var[wn,Cn]=(()=>{let n;return[e=>{n||(n=e)},()=>{if(!n)throw new Error("Placeholders not initialized. Call setPlaceholders() first.");return n}]})();var H=window.matchMedia("(min-width: 1024px)"),_={brand:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 64.57 35"><defs><style>.cls-1{fill: #eb1000;}</style></defs><path class="cls-1" d="M6.27,10.22h4.39l6.2,14.94h-4.64l-3.92-9.92-2.59,6.51h3.08l1.23,3.41H0l6.27-14.94ZM22.03,13.32c.45,0,.94.04,1.43.16v-3.7h3.88v14.72c-.89.4-2.81.89-4.73.89-3.48,0-6.47-1.98-6.47-5.93s2.88-6.13,5.89-6.13ZM22.52,22.19c.36,0,.65-.07.94-.16v-5.42c-.29-.11-.58-.16-.96-.16-1.27,0-2.45.94-2.45,2.92s1.2,2.81,2.47,2.81ZM34.25,13.32c3.23,0,5.98,2.18,5.98,6.02s-2.74,6.02-5.98,6.02-6-2.18-6-6.02,2.72-6.02,6-6.02ZM34.25,22.13c1.11,0,2.14-.89,2.14-2.79s-1.03-2.79-2.14-2.79-2.12.89-2.12,2.79.96,2.79,2.12,2.79ZM41.16,9.78h3.9v3.7c.47-.09.96-.16,1.45-.16,3.03,0,5.84,1.98,5.84,5.86,0,4.1-2.99,6.18-6.53,6.18-1.52,0-3.46-.31-4.66-.87v-14.72ZM45.91,22.17c1.34,0,2.56-.96,2.56-2.94,0-1.85-1.2-2.72-2.5-2.72-.36,0-.65.04-.91.16v5.35c.22.09.51.16.85.16ZM58.97,13.32c2.92,0,5.6,1.87,5.6,5.64,0,.51-.02,1-.09,1.49h-7.27c.4,1.32,1.56,1.94,3.01,1.94,1.18,0,2.27-.29,3.5-.82v2.97c-1.14.58-2.5.82-3.9.82-3.7,0-6.58-2.23-6.58-6.02s2.61-6.02,5.73-6.02ZM60.93,18.02c-.2-1.27-1.05-1.78-1.92-1.78s-1.58.54-1.87,1.78h3.79Z"/></svg>',company:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none"><path d="M14.2353 21.6209L12.4925 16.7699H8.11657L11.7945 7.51237L17.3741 21.6209H24L15.1548 0.379395H8.90929L0 21.6209H14.2353Z" fill="#EB1000"/></svg>',search:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"><path d="M14 2A8 8 0 0 0 7.4 14.5L2.4 19.4a1.5 1.5 0 0 0 2.1 2.1L9.5 16.6A8 8 0 1 0 14 2Zm0 14.1A6.1 6.1 0 1 1 20.1 10 6.1 6.1 0 0 1 14 16.1Z"></path></svg>',home:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 0 18 18" width="25"><path fill="#6E6E6E" d="M17.666,10.125,9.375,1.834a.53151.53151,0,0,0-.75,0L.334,10.125a.53051.53051,0,0,0,0,.75l.979.9785A.5.5,0,0,0,1.6665,12H2v4.5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5v-5a.5.5,0,0,1,.5-.5h3a.5.5,0,0,1,.5.5v5a.5.5,0,0,0,.5.5h4a.5.5,0,0,0,.5-.5V12h.3335a.5.5,0,0,0,.3535-.1465l.979-.9785A.53051.53051,0,0,0,17.666,10.125Z"/></svg>',chevronLeft:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" focusable="false"><path d="M12.5 4l-5 6 5 6" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',chevronRight:'<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="3" height="6" viewBox="0 0 3 6" focusable="false"><path d="M.5.5 2.5 3 .5 5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>',chevronDown:'<svg class="chevron-down" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="6" height="3.375" viewBox="0 0 6 3.375" focusable="false"><path d="M.5.5 3 2.875 5.5.5" stroke="currentColor" stroke-width="1" fill="none"/></svg>'},de=["/tools/ost?","/miniplans"],kn=n=>de.some(e=>n.includes(e));var Ln=n=>{let e=[],r=n.nextElementSibling??null;for(;r!==null;)e.push(r),r=r.nextElementSibling??null;return e},j=n=>({eval:n,or:e=>j(r=>{try{return n(r)}catch{return e(r)}})}),T=(n,e)=>n.reduce(([r,t],a)=>{try{let[o,i]=e(a);return[[...r,o],[...t,...i]]}catch(o){return o instanceof d?[r,[o,...t]]:[r,t]}},[[],[]]),[En,ce]=(()=>{let n,e=!1;return[r=>{e||(n=r,e=!0)},()=>{if(!n)throw new Error("PersonalizationConfig not initialized. Call setPersonalizationConfig() first.");return n}]})(),U=async n=>{try{if(n===null)return new d("URL is null");let e=I(`${n.origin}${n.pathname.replace(/(\.html$|$)/,".plain.html")}${n.hash}`),r=await fetch(e);if(!r.ok)return L(`Request for ${e} failed`),new d(`Request for ${e} failed`);let t=await r.text(),a=await Cn(),o=xn(t,a),{body:i}=new DOMParser().parseFromString(o,"text/html");try{let{handleCommands:s,commands:l}=ce();s(l,i)}catch(s){L(`Personalization not applied: ${s?.message}`)}return i}catch(e){return new d(e?.message)}},R,Z=()=>{if(R)return R;let n=["https://www.adobe.com","https://business.adobe.com","https://blog.adobe.com","https://milo.adobe.com","https://news.adobe.com","graybox.adobe.com"];if(R)return R;let e=window.location.origin;R=n.some(a=>{let o=e.replace(".stage","");return a.startsWith("https://")?o===a:o.endsWith(a)})?e:"https://www.adobe.com";let t=window.location.hostname.includes(".aem.")?"aem":"hlx";return(e.includes("localhost")||e.includes(`.${t}.`))&&(R=`https://main--federal--adobecom.aem.${e.endsWith(".live")?"live":"page"}`),R},I=(n="")=>{if(n.includes("c2-poc--milo--adobecom"))return n.replace("c2-poc--milo--adobecom","main--federal--adobecom");if(n.includes("c2-poc-feds-gnav--milo--adobecom"))return n.replace("c2-poc-feds-gnav--milo--adobecom","main--federal--adobecom");if(n.includes("localhost:3000"))return n.replace("localhost:3000","main--federal--adobecom.aem.page");if(typeof n!="string"||!n.includes("/federal/"))return n;if(n.startsWith("/"))return`${Z()}${n}`;try{let{pathname:e,search:r,hash:t}=new URL(n);return`${Z()}${e}${r}${t}`}catch(e){let r=e instanceof Error?e.message:String(e);console.warn(`getFederatedUrl errored parsing the URL: ${n}: ${r}`)}return n},Tn=(n,e)=>{let r=(t,a)=>{let o=`${t}[${a}^="./media_"]`;e.querySelectorAll(o).forEach(s=>{let l=s.getAttribute(a);if(!(l===null||l===""))try{let c=I(new URL(l,new URL(n,window.location.href)).href);s.setAttribute(a,c)}catch(c){console.warn(`[MediaPathError]: Failed to process relative media path (${l}) for ${t}`,c)}})};r("img","src"),r("source","srcset")},Mn=async n=>{let e=async(r,t)=>{if(r instanceof d)return r;try{let o=[...r.querySelectorAll('a[href*="#_inline"]')].map(async i=>{try{if(t.has(i.href))return;let s=I(i.href),l=new URL(s),c=await U(l);if(t.add(i.href),c instanceof d)throw c;await e(c,t),i.replaceWith(...c.children);return}catch{return}},[]);return await Promise.all(o),r}catch(a){return new d(JSON.stringify(a))}};return e(n,new Set)},Sn=(n,e)=>n.map((r,t)=>`<li>${e(r,t)}</li>`).join(""),G=n=>n.toLowerCase().trim().replace(/[^a-z0-9]/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").replace(/^(\d)/,"id-$1"),C=(n,e)=>{let r=n!==null&&n!==""?` daa-lh="${n}"`:"",t=e!==null&&e!==""?` daa-ll="${e}"`:"";return`${r}${t}`};function pe(n,{id:e,as:r,callback:t,crossorigin:a,rel:o,fetchpriority:i}={rel:"stylesheet"}){let s=document.head.querySelector(`link[href="${n}"]`);if(s)return t?.("noop"),s;let l=document.createElement("link");return l.setAttribute("rel",o),e!==void 0&&l.setAttribute("id",e),r!==void 0&&l.setAttribute("as",r),a!==void 0&&l.setAttribute("crossorigin",a),i!==void 0&&l.setAttribute("fetchpriority",i),l.setAttribute("href",n),t&&(l.onload=c=>t(c.type),l.onerror=c=>t(typeof c=="string"?"error":c.type)),document.head.appendChild(l),l}function ge(n,e){return pe(n,{rel:"stylesheet",callback:e})}function on(n,e=!1){e&&ge(n)}var sn=(n,e,{mode:r,id:t}={})=>new Promise((a,o)=>{let i=document.querySelector(`head > script[src="${n}"]`);if(!i){let{head:c}=document;i=document.createElement("script"),i.setAttribute("src",n),t!=null&&i.setAttribute("id",t),e!=null&&i.setAttribute("type",e),r&&["async","defer"].includes(r)&&i.setAttribute(r,""),c.append(i)}let s=i.dataset.loaded;if(s!=null){a(i);return}let l=c=>{i.removeEventListener("load",l),i.removeEventListener("error",l),c.type==="error"?o(new Error(`error loading script: ${i.src}`)):c.type==="load"&&(i.dataset.loaded="true",a(i))};i.addEventListener("load",l),i.addEventListener("error",l)});function D(n,e=document){let r=n&&n.includes(":")?"property":"name";return e.head.querySelector(`meta[${r}="${n}"]`)?.content??null}var ue=n=>{let e=n,r=o=>o==null||typeof o!="object";if(r(e)||r(e.locale)||typeof e.locale.prefix!="string"||r(e.env)||typeof e.env.name!="string")return!1;if(e.unav!==void 0){if(typeof e.unav!="object"||e.unav===null)return!1;let o=e.unav;if(o.profile!==void 0){if(typeof o.profile!="object"||o.profile===null)return!1;let i=o.profile;if(i.signInCtaStyle!==void 0&&i.signInCtaStyle!=="primary"&&i.signInCtaStyle!=="secondary"||i.messageEventListener!==void 0&&typeof i.messageEventListener!="function")return!1}}return!(e.jarvis!==void 0&&(typeof e.jarvis!="object"||e.jarvis===null||typeof e.jarvis.id!="string"))},[ln,k]=(()=>{let n,e=!1;return[r=>{if(!e){if(!ue(r))throw new Error("MiloConfig validation failed: Invalid structure");n=r,e=!0}},()=>{if(!n)throw new Error("MiloConfig not initialized. Call setMiloConfig() first.");return n}]})(),fe={en:"US","en-gb":"GB","es-mx":"MX","fr-ca":"CA",da:"DK",et:"EE",ar:"DZ",el:"GR",iw:"IL",he:"IL",id:"ID",ms:"MY",nb:"NO",sl:"SI",sv:"SE",cs:"CZ",uk:"UA",hi:"IN","zh-hans":"CN","zh-hant":"TW",ja:"JP",ko:"KR",fil:"PH",th:"TH",vi:"VN"},Pn={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_id",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"TM_en",cis_ru:"TM_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"};function me(n){let e=fe[n];return!e&&Pn[n]&&(e=n),!e&&n.includes("-")&&([e]=n.split("-")),e||"US"}var an="langstore/";function An(n){let r=(n?.prefix||"US_en").replace("/","")??"",[t="US",a="en"]=(Pn[r]??r).split("_",2);if(r.startsWith(an)||window.location.pathname.startsWith(`/${an}`)){let o=r.replace(an,"").toLowerCase();t=me(o),a=o}return t=t.toUpperCase(),a=a.toLowerCase(),{language:a,country:t,locale:`${a}_${t}`}}var K=n=>{let e=n.querySelector("#feds-menu-wrapper");e?.classList.remove("feds-menu-active"),e?.hidePopover?.(),n.querySelector(".feds-popup:popover-open")?.hidePopover?.()},V=(n,e)=>{for(let r=0;r<n.length;r+=1)n[r].style.animationDelay=`${(r+1)*e}s`};function _n(){let n=D("gnav-source")?.split("#")[0]?.split("/").pop()?.trim();if(n!==void 0&&n!==""&&n!=="gnav")return n;let e=window.adobeid?.client_id;return typeof e=="string"&&e!==""?e:""}var Y={elementNull:"Error when parsing Link. Element is null",notAnchor:"Cannot parse non-anchor as Link",textContentNotFound:"Error when parsing Link. Element has no textContent",hrefNotFound:"Element has no href"},E=n=>{if(n===null)throw new d(Y.elementNull);if(n.tagName!=="A")throw new d(Y.notAnchor);let[e,r]=n?.textContent?.split("|").map(o=>o.trim())??["",""];if(e==="")throw new d(Y.textContentNotFound);let t=n?.getAttribute("href")??"";if(t==="")throw new d(Y.hrefNotFound);let a=n.getAttribute("daa-ll");return[{type:"Link",text:e,href:t,daaLl:a,ariaLabel:r},[]]};var dn=n=>{if(!n)throw new d(M.elementNull);if(!n.classList.contains("product-card"))throw new d(M.notAProductCard);return j(he).or(ve).or(be).eval(n)},M={elementNull:"Element not found",noTitleAnchor:"Title anchor not found",noHref:"Title Anchor has no href",noTitle:"Title text not found",noSubtitleP:"Subtitle <p> not found",noSubtitle:"Subtitle text not found",notAHeader:"Expected a Header class",notAProductCard:"Expected a product-card class"},ve=n=>{let e=new Set;if(!n)throw new d(M.elementNull);let r=n.querySelector("p a")??n.querySelector("div ~ div > a");if(!r)throw new d(M.noTitleAnchor);let t=r.textContent??"";t===""&&e.add(new u(M.noTitle));let a=r.getAttribute("href")??"";a===""&&e.add(new u(M.noHref));let o=r.getAttribute("daa-ll"),i=r.getAttribute("daa-lh"),s=r?.closest("p")?.nextElementSibling;s||e.add(new u(M.noSubtitleP));let l=s?.textContent??"";l===""&&e.add(new u(M.noSubtitle));let c=n.querySelectorAll(":scope > div:nth-child(2) > :first-child p")??[],h=Array.from(c).map(p=>{let f=p.querySelector("strong")!==null;return{text:p?.textContent?.trim()??"",isFilled:f}}),[b,g=null]=(n.firstElementChild?.firstElementChild?.textContent?.split("|")??[]).map(p=>p.trim());return[{type:"ProductCardLink",iconHref:b,iconAlt:g,title:t,href:a,subtitle:l,badges:h,daaLl:o,daaLh:i},[...e]]},he=n=>{if(!n)throw new d(M.elementNull);let e=[...n.classList];if(!e.includes("header"))throw new d(M.notAHeader);let r=n.querySelector("a")?.textContent??"",t=n.querySelector("a")?.getAttribute("daa-ll")??null,a=n.querySelector("a")?.getAttribute("daa-lh")??null;if(r==="")throw new d(M.noTitle);return[{type:"ProductCardHeader",title:r,classes:e,daaLl:t,daaLh:a},[]]},be=n=>{if(!n)throw new d(M.elementNull);if(!n.classList.contains("blue"))throw new Error("Not a Blue Product Card");let e=n.querySelector("a"),[r,t]=E(e),a=e?.getAttribute("daa-ll")??null,o=e?.getAttribute("daa-lh")??null;return[{type:"ProductCardBlue",link:r,daaLl:a,daaLh:o},t]};var cn=n=>{switch(n.type){case"ProductCardHeader":return ye(n);case"ProductCardLink":return xe(n);case"ProductCardBlue":return we(n);default:return console.error(n),""}},ye=({title:n,classes:e,daaLl:r,daaLh:t})=>{let a=e.slice(1).map(i=>`feds-product-card--${i}`).join(" "),o=C(t,r??n);return`
    <div role="heading" class="feds-product-card ${a}"${o}>
      <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n}</div>
      </div>
    </div>
  `},xe=({iconHref:n,iconAlt:e,title:r,href:t,subtitle:a,badges:o=[],daaLl:i,daaLh:s})=>{let l=e!==null&&n!==null,c=C(s,i??r),h=l?`
  ...
  `},we=({link:n,daaLl:e,daaLh:r})=>{let t=C(r,e??n.text);return`
  <a href="${n.href}" class="feds-product-card feds-product-card--blue"${t}>
    <div class="feds-product-card__content">
        <div class="feds-product-card__title">${n.text}</div>
      </div>
  </a>
`};var N={elementNull:"Error when parsing Brand. Element is null",noLinkSection:"Error when parsing Brand. No link section found",noLink:"Error when parsing Brand. No link found",noImageSection:"Error when parsing Brand. No image section found",missingImageSections:"Error when parsing Brand. Missing mobile or desktop image section",missingThemeImages:"Error when parsing Brand. Missing mobile or desktop image section"},pn=n=>{let e=new Set;if(n===null)throw new d(N.elementNull);let r=!!n.classList.contains("dark-bg"),[t,a]=n.querySelectorAll(":scope > div");if(t===void 0)throw new d(N.noLinkSection);let o=t.querySelector("a");if(o===null)throw new d(N.noLink);let i=o.getAttribute("href")??"",s=o.textContent?.trim()??"";a===void 0&&e.add(new u(N.noImageSection));let[l,c]=a?.querySelectorAll(":scope > div")??[];(l===void 0||c===void 0)&&e.add(new u(N.missingImageSections));let h=l?.querySelectorAll('a[href$=".svg"]'),b=c?.querySelectorAll('a[href$=".svg"]'),g=h?.[0]?.getAttribute("href")??"",p=h?.[0]?.textContent?.split("|")[1]?.trim()??"",f=h?.[1]?.getAttribute("href")??"",m=h?.[1]?.textContent?.split("|")[1]?.trim()??"",y=b?.[0]?.getAttribute("href")??"",v=b?.[0]?.textContent?.split("|")[1]?.trim()??"",x=b?.[1]?.getAttribute("href")??"",w=b?.[1]?.textContent?.split("|")[1]?.trim()??"";return(!g||!y||!f||!x)&&e.add(new u(N.missingThemeImages)),[{type:"Brand",data:{href:i,label:s,isDarkBg:r,imageData:{type:"svg",lightThemeImageSrc:y,lightThemeImageAlt:v,darkThemeImageSrc:x,darkThemeImageAlt:w,mobileLightThemeImageSrc:g,mobileLightThemeImageAlt:p,mobileDarkThemeImageSrc:f,mobileDarkThemeImageAlt:m}}},[...e]]};var Ce=`
<?xml
...
`.trim(),Le=n=>{let{href:e,label:r,isDarkBg:t,imageData:a}=n,o=a.lightThemeImageSrc?.trim()||a.darkThemeImageSrc?.trim()||"",i=a.darkThemeImageSrc?.trim()||a.lightThemeImageSrc?.trim()||"",s=a.mobileLightThemeImageSrc?.trim()||a.mobileDarkThemeImageSrc?.trim()||"",l=a.mobileDarkThemeImageSrc?.trim()||a.mobileLightThemeImageSrc?.trim()||"",c=a.lightThemeImageAlt||a.darkThemeImageAlt||"",h=a.darkThemeImageAlt||a.lightThemeImageAlt||"",b=a.mobileLightThemeImageAlt||a.mobileDarkThemeImageAlt||"",g=a.mobileDarkThemeImageAlt||a.mobileLightThemeImageAlt||"",p=!!o,f=!!i,m=!!s,y=!!l,v=p?`<img src="${I(o)}" alt="${c}" />`:"",x=f?`<img src="${I(i)}" alt="${h}" />`:"",w=m?`<img src="${I(s)}" alt="${b}" />`:"",z=y?`<img src="${I(l)}" alt="${g}" />`:"";return`<div class="feds-brand-container${t?" feds-dark-bg":""}">
  ...
  </div>`.trim()},gn=n=>{let{data:e}=n;return Le(e)};var un=["appswitcher","help"],X={cs:["cz"],da:["dk"],de:["at"],en:["africa","au","ca","ie","in","mt","ng","nz","sg","za"],es:["ar","cl","co","cr","ec","gt","la","mx","pe","pr"],et:["ee"],ja:["jp"],ko:["kr"],nb:["no"],pt:["br"],sl:["si"],sv:["se"],uk:["ua"],zh:["cn","tw"]},[O,In]=(()=>{let n,e,r,t=new Promise(a=>{e=a,r=setTimeout(()=>{n={},a(n)},5e3)});return[a=>{a&&!n&&(n=a,clearTimeout(r),e?.(n))},()=>t]})();function J(n,e=!1){let s=(/uc_carts=/.test(document.cookie)?n:n?.filter(c=>c!=="cart"))??[],l=s.length??3;if(e){let c=s.filter(b=>un.includes(b)).length;return`calc(92px + ${c*32}px + ${c*.25}rem)`}return`calc(${l*32}px + ${(l-1)*.25}rem)`}var Q=n=>{if(!n.prefix||n.prefix==="/")return"en_US";let e=n.prefix.replace("/","");if(e.includes("_")){let[t,a]=e.split("_").reverse();return`${t.toLowerCase()}_${a.toUpperCase()}`}if(e==="uk")return"en_GB";let r=Object.keys(X).find(t=>X[t].includes(e));return r?`${r.toLowerCase()}_${e.toUpperCase()}`:`${e.toLowerCase()}_${e.toUpperCase()}`},Ee={Mac:"macOS",Win:"windows",Linux:"linux",CrOS:"chromeOS",Android:"android",iPad:"iPadOS",iPhone:"iOS"},nn=()=>{let n=navigator.userAgent;for(let[e,r]of Object.entries(Ee))if(n.includes(e))return r;return"linux"},en=async()=>{let n=window;return n.alloy?await n.alloy("getIdentity").then(e=>e?.identity?.ECID).catch(()=>{}):void 0};var $n=()=>{try{return k().signInContext||{}}catch{return{}}},Te=()=>{let n=k();return D("signin-cta-style")==="primary"||n?.unav?.profile?.signInCtaStyle==="primary"?"primary":"secondary"},Me=()=>{let e=k()?.unav?.profile?.messageEventListener;return e||(r=>{let{name:t,payload:a,executeDefaultAction:o}=r.detail;if(!(!t||t!=="System"||!a||typeof o!="function"))switch(a.subType){case"AppInitiated":window.adobeProfile?.getUserProfile().then(i=>{O(i)}).catch(()=>{O({})});break;case"SignOut":o();break;case"ProfileSwitch":Promise.resolve(o()).then(i=>{i&&window.location.reload()});break;default:break}})};function Se(){let{unav:n}=k();return n?.unavHelpChildren||[{type:"Support"},{type:"Community"}]}var F=()=>{let n=k();return{profile:{name:"profile",attributes:{accountMenuContext:{sharedContextConfig:{enableLocalSection:!0,enableProfileSwitcher:!0,miniAppContext:{logger:{trace:()=>{},debug:()=>{},info:()=>{},warn:()=>{},error:()=>{}}},complexConfig:n?.unav?.profile?.complexConfig||null,...n?.unav?.profile?.config},messageEventListener:Me()},signInCtaStyle:Te(),isSignUpRequired:!1,callbacks:{onSignIn:()=>{window.adobeIMS?.signIn($n())},onSignUp:()=>{window.adobeIMS?.signIn($n())}}}},appswitcher:{name:"app-switcher"},notifications:{name:"notifications",attributes:{notificationsConfig:{applicationContext:{appID:n?.unav?.uncAppId||"adobecom",...n?.unav?.uncConfig}}}},help:{name:"help",attributes:{children:Se()}},jarvis:{name:"jarvis",attributes:{appid:n?.jarvis?.id,callbacks:n?.jarvis?.callbacks}},cart:{name:"cart"}}};var Rn=(n,e)=>{n[0]&&"attributes"in n[0]&&n[0].attributes&&typeof n[0].attributes=="object"&&"isSignUpRequired"in n[0].attributes&&(n[0].attributes.isSignUpRequired=e)},rn=async(n,e)=>{try{let r=n.querySelector(".feds-utilities");if(!(r instanceof HTMLElement))return new u('missing ".feds-utilities" container');let t=new Set,a=document.head.querySelector('meta[name="universal-nav"]'),o=a instanceof HTMLMetaElement?a.content??"":"";a instanceof HTMLMetaElement||t.add(new u('metadata "universal-nav" is missing'));let i=o.trim();a instanceof HTMLMetaElement&&i.length===0&&t.add(new u('metadata "universal-nav" has no value'));let s=!window.adobeIMS?.isSignedInUser(),l=i.split(",").map(v=>v.trim()).filter(v=>Object.keys(F()).includes(v)||v==="signup");if(s){let v=J(l,s);r.style.setProperty("min-width",v)}let c;try{c=k()}catch{throw new Error("MiloConfig not available for UNAV initialization")}let h=Q(c.locale),b=c.env.name==="prod"?"prod":"stage",g=await en(),p=new URLSearchParams(window.location.search).get("unavVersion");/^\d+(\.\d+)?$/.test(p??"")||(p="1.5"),await Promise.all([sn(`https://${b}.adobeccstatic.com/unav/${p}/UniversalNav.js`),on(`https://${b}.adobeccstatic.com/unav/${p}/UniversalNav.css`,!0)]);let f=()=>{let v=F(),x=[v.profile];return Rn(x,!1),l?.forEach(w=>{if(w==="profile")return;if(w==="signup"){Rn(x,!0);return}let z=v[w];z&&x.push(z)}),x},m=()=>({target:r,env:b,locale:h,countryCode:An(c?.locale)?.country||"US",imsClientId:window?.adobeid?.client_id,theme:"light",analyticsContext:{consumer:{name:"adobecom",version:"1.0",platform:"Web",device:nn(),os_version:navigator.platform},event:{visitor_guid:g}},children:f(),isSectionDividerRequired:!!c?.unav?.showSectionDivider,showTrayExperience:!H.matches});await window?.UniversalNav?.(m()),s||r?.style.removeProperty("min-width");let y=v=>{window?.UniversalNav?.reload(m())};return H.addEventListener("change",()=>{y()}),{reloadUnav:y,errors:t}}catch(r){let t=r instanceof Error?r.message:"failed to load universal nav";return new u(t)}};function $(n,e){return[...n.querySelectorAll(e)]}function W(n,e,r){$(n,e).forEach(t=>r?t.removeAttribute("tabindex"):t.setAttribute("tabindex","-1"))}var B={ArrowLeft:-1,ArrowRight:1,ArrowUp:-1,ArrowDown:1},Hn=new Set(["ArrowLeft","ArrowRight"]),Pe=new Set(["ArrowUp","ArrowDown"]),Ae='.tabs [role="tab"][aria-selected="true"]';function fn(n,e,r){return(n+e+r)%r}function _e(n,e,r,t){let a=B[r];if(Hn.has(r)){let p=e+a;return p>=0&&p<n.length?p:null}let o=getComputedStyle(t).gridTemplateColumns.split(" ").length,i=[...t.children],s=p=>{let f=n[p].parentElement;return f?i.indexOf(f):-1},l=s(e)%o,c=Math.floor(s(e)/o)+(r==="ArrowDown"?1:-1),h=Math.floor((i.length-1)/o);if(c<0||c>h)return null;let b=null,g=1/0;for(let p=0;p<n.length;p++){let f=Math.abs(s(p)%o-l);Math.floor(s(p)/o)===c&&f<g&&(g=f,b=p)}return b}function mn(n){W(n,'.tab-content [role="tabpanel"] a',!1);let e=[];$(n,".feds-popup[popover]").forEach(g=>{let p=()=>{g.matches(":popover-open")||W(g,'[role="tabpanel"] a',!1)};g.addEventListener("toggle",p),e.push(()=>g.removeEventListener("toggle",p))});let r=(g,p)=>{g.focus(),p.preventDefault()},t=()=>n.querySelector(".feds-popup:popover-open"),a=g=>g.querySelector(Ae),o=g=>g.querySelector('[role="tabpanel"]:not([hidden])');function i(g){let p=t(),f=n.querySelector("#feds-menu-wrapper");if(!f)return!1;let m=p??(f?.matches(":popover-open")?f:null);if(!m)return!1;m.hidePopover?.();let y=p?`[popovertarget="${m.id}"]`:".feds-nav-toggle";return n.querySelector(y)?.focus(),g.preventDefault(),!0}function s(g,p,f){if(!Hn.has(p))return!1;let m=$(n,".feds-gnav-items > li > .feds-link"),y=m.indexOf(g);return y<0?!1:(r(m[fn(y,B[p],m.length)],f),!0)}function l(g,p,f,m){let y=$(p,'.tabs :is([role="tab"], .product-links a)'),v=y.indexOf(g);if(v<0)return!1;if(B[f]){let x=y[fn(v,B[f],y.length)];return x.matches('[role="tab"]')&&x.click(),r(x,m),!0}if(f==="Tab"&&!m.shiftKey&&g.matches('[aria-selected="true"]')){let x=o(p);if(!x)return!1;W(x,"a",!0);let w=x.querySelector("a");return w&&r(w,m),!0}return!1}function c(g,p,f,m){let y=o(p);if(!y)return!1;let v=$(y,"a"),x=v.indexOf(g);if(x<0)return!1;if(B[f]){let w=_e(v,x,f,y);return w!==null?(r(v[w],m),!0):f==="ArrowUp"?(W(y,"a",!1),r(a(p)??v[0],m),!0):!1}if(f==="Tab"&&!m.shiftKey){if(x+1<v.length)r(v[x+1],m);else{let w=$(p,'.tabs [role="tab"]'),z=a(p),tn=w[w.indexOf(z)+1]??p.querySelector(".product-links a");if(tn)r(tn,m);else return!1}return!0}if(f==="Tab"&&m.shiftKey){if(x>0)r(v[x-1],m);else{W(y,"a",!1);let w=a(p)??$(p,'.tabs :is([role="tab"], .product-links a)')[0];w&&r(w,m)}return!0}return!1}function h(g,p,f,m){if(!Pe.has(f))return!1;let y=$(p,".feds-gnav-cards a"),v=y.indexOf(g);return v<0?!1:(r(y[fn(v,B[f],y.length)],m),!0)}function b(g){let p=document.activeElement??g.target;if(g.key==="Escape"){i(g);return}let f=t();f&&(f.matches(":has(.product-list)")&&(l(p,f,g.key,g)||c(p,f,g.key,g))||f.matches(":has(.feds-gnav-cards)")&&h(p,f,g.key,g))||s(p,g.key,g)}return n.addEventListener("keydown",b),e.push(()=>n.removeEventListener("keydown",b)),()=>e.forEach(g=>g())}var Ie="feds-milo",L=(n,e="default",r="e")=>{let{locale:t}=k(),a=D("gnav-source")??`${t.contentRoot??""}/gnav`;window.lana||console.warn("lana logging unavailable in the gnav"),window?.lana?.log(`${n} | gnav-source: ${a} | href: ${window.location.href}`,{clientId:Ie,sampleRate:1,tags:e,errorType:r})};var d=class n extends Error{constructor(e){super(e),Object.setPrototypeOf(this,n.prototype)}},u=class n extends Error{constructor(e,r="Minor"){super(e),Object.setPrototypeOf(this,n.prototype),r==="Critical"&&L(e)}};var zn=n=>e=>{if(e===null)throw new Error("");let r=e.querySelector($e(n));if(!r)throw new Error("");let t=r.textContent??"",[a="",o=""]=t.split("|").map(b=>b.trim());if(a==="")throw new Error("");let i=r.getAttribute("href")??"";if(i==="")throw new Error("");let s=r.getAttribute("daa-ll"),l=r.getAttribute("aria-label")?.trim()??"",c=l!==""?l:o!==""?o:void 0,h=[];return[{type:n.type,text:a,href:i,ariaLabel:c,daaLl:typeof s=="string"&&s.trim()!==""?s:a},h]},vn=zn({type:"PrimaryCTA"}),P=zn({type:"SecondaryCTA"}),Un=n=>j(vn).or(P).eval(n),$e=({type:n})=>{switch(n){case"PrimaryCTA":return"strong > a";case"SecondaryCTA":return"em > a";default:throw new Error("")}};var hn=({text:n,href:e,daaLl:r,ariaLabel:t})=>`
<a href="${e}"
...
`,Dn=n=>n.type==="PrimaryCTA"?hn(n):A(n);var q=({text:n,href:e,daaLl:r})=>`<a class="feds-link" href="${e}"${C(null,r??n)}>${n}</a>`;var Nn=n=>{let[e,r]=Re(n);return[{type:"LinksCard",card:e},r]},Re=n=>{let e=n.querySelector("h2, h3, h4")||null;if(!e)throw new d("Expected links card title");let r=n.querySelector("em > a"),t=[...n.querySelectorAll("a")].filter(l=>l!==r);if(t.length===0)throw new d("Expected at least one link");let[a,o]=T(t,E),[i,s]=(()=>{try{return P(n)}catch{return[null,[]]}})();return i&&(i.daaLl=`${e.textContent??""} - ${i?.daaLl}`),[{type:"LinksCardItem",title:e.textContent??"",links:a,footerCTA:i},[...o,...s]]};var Bn=n=>{let e=[...n.querySelectorAll("li > div")],r=[...n.querySelectorAll("li > a")],[t,a]=T(e,He),[o,i]=T(r,E);return[{type:"ProductList",categories:t,links:o},[...a,...i]]},He=n=>{let e=n.firstElementChild;if(e?.nodeName!=="H2")throw new d("Expected H2");let r=e.textContent??"",t=e.textContent??"",a=Ln(e),[o,i]=T(a,dn);return[{type:"ProductCategory",name:r,daaLl:t,links:o},i]};var qn=n=>{let[e,r]=ze(n);return[{type:"FeaturedCard",card:e},r]},ze=n=>{let e=n.querySelector("h5")||null;if(!e)throw new u("Eye brow element not found");let r=n.querySelector("h4")||null,t=r?.nextElementSibling||null;if(!r)throw new d("Expected title");if(!t)throw new d("Expected subtitle");let a=t.nextElementSibling?.firstElementChild||null;if(!a)throw new d("Expected card link after subtitle");let[o,i]=E(a),[s,l]=P(n);return[{type:"Card",title:r.textContent??"",subtitle:t.textContent??"",bodyLink:o,footerCTA:s,eyeBrow:e.textContent??""},[...l,...i]]};var S={MissingBackgroundImageSection:"Promo card is missing background image section",MissingBackgroundImage:"Promo card is missing background image",MissingBackgroundImageAlt:"Promo card background image is missing alt text",MissingBackgroundImageSrc:"Promo card background image is missing src",MissingContentSection:"Promo card is missing card details section",MissingIcon:"Promo card is missing icon",MissingIconSrc:"Promo card icon is missing src",MissingIconAlt:"Promo card icon is missing alt text",MissingTitleElement:"Promo card is missing title element",MissingTitleText:"Promo card is missing title text",MissingSecondaryCtaAnchor:"Promo card is missing secondary CTA anchor",MissingPriceLink:"Promo card is missing price link"},jn=n=>{let[e,r]=n.querySelectorAll(":scope > div"),t=new Set;if(e===void 0)throw new d(S.MissingBackgroundImageSection);let a=e.querySelector(":scope picture:not(:scope p picture) img")??null;a===null&&t.add(new u(S.MissingBackgroundImage));let o=a?.getAttribute("alt")??"";o===""&&t.add(new u(S.MissingBackgroundImageAlt));let i=a?.getAttribute("src")??"";if(i===""&&t.add(new u(S.MissingBackgroundImageSrc)),r===void 0)throw new d(S.MissingContentSection);let s=r.querySelector('a[href$=".svg"]')??null;s===null&&t.add(new u(S.MissingIcon));let[l,c]=(s?.textContent?.split("|")??["",""]).map(w=>w.trim());l===""&&t.add(new u(S.MissingIconSrc)),c===""&&t.add(new u(S.MissingIconAlt));let h=r.querySelector('p > a:not([href$=".svg"])')??null,b=h?.textContent?.trim()??"",g=h?.getAttribute("href")??"",p=g?kn(g):!1;h===null&&t.add(new u(S.MissingPriceLink));let f=r.querySelector("p > strong")??null;if(f===null)throw new d(S.MissingTitleElement);let m=f?.textContent??"";m===""&&t.add(new u(S.MissingTitleText)),r.querySelector("em > a")===null&&t.add(new u(S.MissingSecondaryCtaAnchor));let[v,x]=(()=>{try{return P(n)}catch{return[null,[]]}})();return x.forEach(w=>t.add(w)),v&&(v.daaLl=`${m} - ${v?.daaLl}`),[{type:"PromoCard",card:{bgImageAlt:o,bgImageSrc:i,iconAlt:c,iconSrc:l,title:m,cta:v,priceText:b,priceHref:g,isPriceMerchLink:p}},[...t]]};var On=n=>{let e=new Set;if(n===null)throw new d(Gn.elementNull);let r=n.querySelector("h2")?.textContent??"";r===""&&e.add(new u(Gn.noTitle));let t=(async()=>{try{let a=n.querySelector("a"),o=new URL(a?.href??""),i=await U(o);if(i instanceof d)throw new Error(i.message);let s=await Mn(i);if(s instanceof d)throw new Error(s.message);return Tn(o.href,s),n.classList.contains("product-list")?Bn(s):Ue(s)}catch(a){throw new d(a?.message)}})();if(t instanceof d)throw t;return[{type:"MegaMenu",title:r,content:t},[...e]]},Gn={elementNull:"Element is null",noTitle:"Large Menu has no Title"},Ue=n=>{let e=[...n.children];if(e.length===0)throw new d("No mega menu items found (did you forget to add them correctly?)");let[r,t]=T(e,a=>De(a));if(r.length===0)throw new d("Failed to parse gnav cards sections");return[{type:"GnavCards",sections:r},t]},De=n=>{let e=[...n.querySelectorAll(".featured-card, .links-card, .promo-card")];if(e.length===0)throw new d("Column contains no cards (did you forget to label them correctly?)");let[r,t]=T(e,a=>Ne(a));if(r.length===0)throw new d("Failed to parse cards in column");return[{type:"GnavColumn",cards:r},t]},Ne=n=>{if(n.classList.contains("featured-card"))return qn(n);if(n.classList.contains("links-card"))return Nn(n);if(n.classList.contains("promo-card"))return jn(n);throw new d("Unsupported gnav cards section")};var Fn=({card:n})=>Be(n),Be=({title:n,subtitle:e,eyeBrow:r,footerCTA:t,bodyLink:a})=>`
  <article class="featured-card" ${C(r,"")}>
    <div>
      <div class="featured-eyebrow">${r}</div>
      <h4>${n}</h4>
      <div class="featured-subtitle">${e}</div>
      <span>${q(a)}${_.chevronRight}</span>
    </div>
    <div class="footer-container">
      ${A(t)}
    </div>
  </article>
`.trim();var Wn=({card:n})=>qe(n),qe=({title:n,links:e,footerCTA:r})=>`
...
`.trim();var Zn=({card:n})=>je(n),je=({bgImageAlt:n,bgImageSrc:e,iconAlt:r,iconSrc:t,title:a,cta:o,priceText:i,priceHref:s,isPriceMerchLink:l})=>`
...
`.trim();var Ge=n=>{switch(n.type){case"FeaturedCard":return Fn(n);case"LinksCard":return Wn(n);case"PromoCard":return Zn(n);default:}return""},Kn=({sections:n})=>`
  <ul class="feds-gnav-cards">
    ${n.map(e=>`<li>${e.cards.map(r=>Ge(r)).join("")}</li>`).join("")}
  </ul>
`;var Vn=({categories:n,links:e})=>{let r=`
    <ul class="tabs" role="tablist">
      ${n.map(Oe).join("")}
      ${e.length?`<li class="product-links"><a class="feds-link" href="${e[e.length-1].href}"${C(null,e[e.length-1].daaLl??e[e.length-1].text)}>${e[e.length-1].text}${_.chevronRight}</a></li>`:""}
    </ul>
  `.trim(),t=`
...
`,Xn=(n,e,r)=>{let t=`
  ...
  `,a=n.type==="ProductList"&&n.links.length>0?n.links[n.links.length-1]:null,o=`
    <div class="feds-popup-header">
      ...
      ${a?`<div class="product-links"><a class="feds-link" href="${a.href}"${C(null,a.daaLl??a.text)}>${a.text}${_.chevronRight}</a></div>`:""}
    </div>
  `.trim(),i="";switch(n.type){case"ProductList":i=Vn(n);break;case"GnavCards":i=Kn(n);break;default:}return`${o}${i}`};var Jn={elementNull:"Error when parsing text. Element is null",textContentNull:"Error when parsing text. Element has no textContent"},Qn=n=>{if(n===null)return[{type:"Text",content:""},[new u(Jn.elementNull,"Minor")]];let e=n.textContent;return e===null?[{type:"Text",content:""},[new u(Jn.textContentNull,"Minor")]]:[{type:"Text",content:e},[]]};var ne=({content:n})=>n;var ee=n=>{if(n===null)throw new d(Fe.elementNull);let e=n.querySelector(".gnav-brand");if(e!==null)return pn(e);let r=n.querySelector(".large-menu");return r!==null?On(r):n.querySelector("strong")!==null?vn(n):n.querySelector("em")!==null?P(n):n.querySelector("a")===null?Qn(n):E(n.querySelector("a"))},bn=(n,e)=>{switch(n.type){case"Text":return ne(n);case"Link":return q(n);case"SecondaryCTA":return A(n);case"PrimaryCTA":return hn(n);case"Brand":return gn(n);case"MegaMenu":return Yn(n,e);default:return console.error(`Failed to recognize component: ${n}`),""}},Fe={elementNull:"Element is null"};var re=(n,e)=>{let[r,t]=T([...document.querySelectorAll(".breadcrumbs ul > li > a")??[]],E),[a,o]=T([...n.children],ee),i=n.querySelector(".product-entry-cta"),[s,l]=(()=>{try{return Un(i)}catch{return[null,[]]}})(),c=!1,h=[t,o,l].flat();return{breadcrumbs:r,components:a,productCTA:s,localnav:c,errors:h,unavEnabled:e}};var te=n=>{let e=[...n.querySelectorAll('.tabs button[role="tab"]')],r=[...n.querySelectorAll(".tab-content ul")],t=e.map((a,o)=>()=>{let i=r[o].closest(":popover-open"),s=i?.clientHeight??0;if(e.forEach(c=>{c.setAttribute("aria-selected","false")}),r.forEach(c=>{c.setAttribute("hidden","true")}),r[o]?.removeAttribute("hidden"),a.setAttribute("aria-selected","true"),!H.matches)return;let l=i?.clientHeight??0;i?.animate([{height:`${s}px`},{height:`${l}px`}],{duration:350,iterations:1,easing:"cubic-bezier(0.4, 0, 0.2, 1)"})});return e.forEach((a,o)=>{a.addEventListener("click",t[o])}),()=>{e.forEach((a,o)=>{a.removeEventListener("click",t[o])})}};var ae=async n=>{let e=new Set,r=n.querySelectorAll("a.merch");if(r.length===0)return e;try{let t=k(),{base:a}=t;if(!a)return e.add(new u("base not found in config, cannot initialize merch links")),e;let o=await import(`${a}/blocks/merch/merch.js`),{default:i}=o;if(!i)return e.add(new u("decorateMerchLink not found in merch module")),e;r.forEach(s=>{i(s)})}catch(t){e.add(new u(`Error initializing merch links: ${t}`))}return e};var oe=async({gnavSource:n,asideSource:e})=>{let r=await U(n);if(r instanceof d)return r;let t=await U(e);return{mainNav:r,aside:t}};var We=`/**
...
`,ie=document.createElement("style");ie.textContent=We;document.head.appendChild(ie);var fo=async n=>{let{gnavSource:e,mountpoint:r,unavEnabled:t,miloConfig:a,personalization:o}=n;if(!(e instanceof URL))throw L(`gnavSource is invalid: ${e}`),new d("gnavSource needs to be a URL object");try{ln(a)}catch(h){throw L(`Failed to initialize MiloConfig: ${h}`),new d(`Failed to initialize MiloConfig: ${h}`)}En(o),wn(yn(n));let i=await oe(n);if(i instanceof d)throw L(i.message),i;let{mainNav:s,aside:l}=i;if(s instanceof d)throw L(s.message),s;let c=re(s,t);if(c instanceof d)throw L(c.message),c;return await Ze(c)(r),Ve(n)},Ze=n=>async e=>{let r=Ke(n);e.innerHTML=r,e.classList.add("site-pivot");let t=[...e.querySelectorAll(".mega-menu ~ .feds-popup")];t.forEach(s=>{s.innerHTML=""});let a=n.components.filter(s=>s.type==="MegaMenu"),o=a.map(s=>s.content),i=await Promise.all(o.map(async(s,l)=>{let[c,h]=await s,b=a[l].title;return t[l].innerHTML=Xn(c,t[l].id,b),h}).flat());return e},Ke=({components:n,productCTA:e,unavEnabled:r})=>`
<nav>
  <ul>
    ${(()=>{let t=n.find(l=>l.type==="Brand")??null,a=n.filter(l=>l.type!=="Brand"),o=`
      ...
      `.trim(),i=t?bn(t):"",s=Sn(a,bn);return`
...
`,Ve=async n=>{let e=new Set,r=await rn(n.mountpoint);r instanceof u?(e.add(r),L(r.message)):r.errors.forEach(o=>e.add(o)),te(n.mountpoint),mn(n.mountpoint),Ye(n.mountpoint),Xe(n.mountpoint),Je(n.mountpoint),er(n.mountpoint),Qe(n.mountpoint),rr(n.mountpoint,n.mepMartech??""),(await ae(n.mountpoint)).forEach(o=>{e.add(o),L(o.message)});let a=r instanceof u?()=>{}:r.reloadUnav;return{closeEverything:nr,reloadUnav:a,errors:e,setGnavTopPosition:o=>{},getGnavTopPosition:()=>0}},Ye=n=>{let e=n.querySelector("#feds-menu-wrapper"),r=n.querySelector(".feds-nav-toggle");e?.addEventListener("toggle",()=>{let a=e.matches(":popover-open");r?.setAttribute("aria-expanded",String(a)),r?.setAttribute("daa-ll",a?"hamburgermenu|close":"hamburgermenu|open"),e.setAttribute("aria-hidden",String(!a)),a&&e.classList.add("feds-menu-active")}),e?.addEventListener("transitionend",()=>{e.matches(":popover-open")||e.classList.remove("feds-menu-active")}),n.querySelectorAll(".feds-popup[popover]").forEach(a=>{a.addEventListener("toggle",()=>{let o=n.querySelector(`[popovertarget="${a.id}"]`),i=a.matches(":popover-open");o?.setAttribute("aria-expanded",String(i)),o?.setAttribute("daa-ll",i?"header|Close":"header|Open")})})},Xe=n=>{H.addEventListener("change",()=>{K(n)})},Je=n=>{[...n.querySelector(".feds-utilities #universal-nav")?.children??[]].forEach(e=>{e.addEventListener("click",()=>K(n)),e.addEventListener("keydown",r=>{r.key==="Enter"&&K(n)})})},Qe=n=>{let e=[...n.querySelectorAll(".product-list ul.tabs > li")];V(e,.025),[...n.querySelectorAll(".feds-popup[popover]")].forEach(t=>{t.querySelector(".product-list")?[...t.querySelectorAll('ul[role="tabpanel"]')].forEach(a=>{V([...a.querySelectorAll("li")],.025)}):V([...t.querySelectorAll(".feds-gnav-cards > li")],.025)})},nr=()=>{},er=n=>{let e=n.closest("header");if(!e)return;let r=n.querySelector("#feds-menu-wrapper"),t=()=>r?.matches(":popover-open")??!1,a=()=>window.scrollY>100,o=()=>{if(t()){e.classList.remove("feds-header-scrolled");return}if(a()){e.classList.add("feds-header-scrolled");return}e.classList.remove("feds-header-scrolled")};o(),window.addEventListener("scroll",o,{passive:!0}),r?.addEventListener("toggle",o)},rr=(n,e)=>{let r=n.closest("header");r!==null&&r.setAttribute("daa-lh",`gnav|${_n()}${e}`)};export{fo as main,Ve as postRenderingTasks,Ze as renderGnav,Ke as renderGnavString};
